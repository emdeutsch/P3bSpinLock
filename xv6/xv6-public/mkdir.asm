...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	push   (%ebx)
  35:	e8 b8 03 00 00       	call   3f2 <mkdir>
  ...
  exit();
  4b:	e8 3a 03 00 00       	call   38a <exit>
      printf(2, "mkdir: %s failed to create\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	push   (%ebx)
  ...
  6d:	e8 7e 04 00 00       	call   4f0 <printf>
    exit();
  72:	e8 13 03 00 00       	call   38a <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	57                   	push   %edi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 e5 01 00 00       	call   3a2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 21d:	e8 a8 01 00 00       	call   3ca <open>
  if(fd < 0)
 ...
 231:	50                   	push   %eax
 232:	e8 ab 01 00 00       	call   3e2 <fstat>
  close(fd);
 237:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 23a:	89 c6                	mov    %eax,%esi
  close(fd);
 23c:	e8 71 01 00 00       	call   3b2 <close>
  return r;
...
int TestAndSet(int *oldpointer, int new){
 ...
 2d6:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  int old = *oldpointer;
 2d9:	8b 10                	mov    (%eax),%edx
  *oldpointer = new;
 2db:	89 08                	mov    %ecx,(%eax)
  return old;
}
 2dd:	5d                   	pop    %ebp
...
thread_join(){
 367:	83 ec 20             	sub    $0x20,%esp
  int waitedForPID = join(&stack);
 36a:	50                   	push   %eax
 36b:	e8 c2 00 00 00       	call   432 <join>
 370:	89 c3                	mov    %eax,%ebx
  free(stack);
 372:	58                   	pop    %eax
 373:	ff 75 f4             	push   -0xc(%ebp)
 376:	e8 15 03 00 00       	call   690 <free>
  return waitedForPID;
 ...
 44c:	89 d1                	mov    %edx,%ecx
{
 ...
 4be:	56                   	push   %esi
 4bf:	57                   	push   %edi
 4c0:	e8 e5 fe ff ff       	call   3aa <write>
  while(--i >= 0)
 ...
 4f9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 535:	57                   	push   %edi
 536:	56                   	push   %esi
 537:	e8 6e fe ff ff       	call   3aa <write>
 ...
 58e:	e8 17 fe ff ff       	call   3aa <write>
        putc(fd, c);
 ...
 60b:	57                   	push   %edi
 60c:	56                   	push   %esi
 60d:	e8 98 fd ff ff       	call   3aa <write>
        while(*s != 0){
 ...
 64c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 64f:	e8 56 fd ff ff       	call   3aa <write>
        ap++;
...
free(void *ap)
{
 ...
 691:	a1 28 0c 00 00       	mov    0xc28,%eax
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	89 15 28 0c 00 00    	mov    %edx,0xc28
}
 6d8:	5e                   	pop    %esi
 6d9:	5f                   	pop    %edi
 6da:	5d                   	pop    %ebp
 ...
 709:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 70c:	89 15 28 0c 00 00    	mov    %edx,0xc28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 729:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 72c:	8b 3d 28 0c 00 00    	mov    0xc28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 76f:	73 4f                	jae    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 771:	8b 3d 28 0c 00 00    	mov    0xc28,%edi
 ...
 783:	e8 8a fc ff ff       	call   412 <sbrk>
  if(p == (char*)-1)
 ...
 79a:	e8 f1 fe ff ff       	call   690 <free>
  return freep;
 79f:	8b 15 28 0c 00 00    	mov    0xc28,%edx
 ...
 7cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7cf:	89 15 28 0c 00 00    	mov    %edx,0xc28
}
 ...
 7df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 28 0c 00 00 2c 	movl   $0xc2c,0xc28
 7e7:	0c 00 00 
    base.s.size = 0;
 7ea:	bf 2c 0c 00 00       	mov    $0xc2c,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 2c 0c 00 00 2c 	movl   $0xc2c,0xc2c
 7f6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7fb:	c7 05 30 0c 00 00 00 	movl   $0x0,0xc30
 802:	00 00 00 
    if(p->s.size >= nunits){
