...
main(int argc, char *argv[])
{
  ...
  4c:	ff 36                	push   (%esi)
  4e:	e8 d5 02 00 00       	call   328 <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c6:	0f b6 92 58 07 00 00 	movzbl 0x758(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 493:	ff 24 85 00 07 00 00 	jmp    *0x700(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 4f8:	75 15                	jne    50f <printf+0xfa>
          s = "(null)";
 4fa:	be f7 06 00 00       	mov    $0x6f7,%esi
...
free(void *ap)
{
 ...
 587:	a1 cc 0a 00 00       	mov    0xacc,%eax
 ...
 5c3:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5c5:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 5ca:	5b                   	pop    %ebx
 5cb:	5e                   	pop    %esi
 5cc:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 622:	e8 54 ff ff ff       	call   57b <free>
  return freep;
 627:	a1 cc 0a 00 00       	mov    0xacc,%eax
...
malloc(uint nbytes)
{
 ...
 64b:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 64e:	8b 0d cc 0a 00 00    	mov    0xacc,%ecx
 ...
 65a:	eb 4a                	jmp    6a6 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 65c:	c7 05 cc 0a 00 00 d0 	movl   $0xad0,0xacc
 663:	0a 00 00 
 666:	c7 05 d0 0a 00 00 d0 	movl   $0xad0,0xad0
 66d:	0a 00 00 
    base.s.size = 0;
 670:	c7 05 d4 0a 00 00 00 	movl   $0x0,0xad4
 677:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 67a:	b9 d0 0a 00 00       	mov    $0xad0,%ecx
 ...
 68b:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 68e:	89 0d cc 0a 00 00    	mov    %ecx,0xacc
      return (void*)(p + 1);
 ...
 6ab:	73 d4                	jae    681 <malloc+0x46>
    if(p == freep)
 6ad:	39 05 cc 0a 00 00    	cmp    %eax,0xacc
