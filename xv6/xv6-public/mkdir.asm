...
main(int argc, char *argv[])
{
  ...
  4c:	ff 36                	push   (%esi)
  4e:	e8 d4 02 00 00       	call   327 <mkdir>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c5:	0f b6 92 58 07 00 00 	movzbl 0x758(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 492:	ff 24 85 00 07 00 00 	jmp    *0x700(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 4f7:	75 15                	jne    50e <printf+0xfa>
          s = "(null)";
 4f9:	be f7 06 00 00       	mov    $0x6f7,%esi
...
free(void *ap)
{
 ...
 586:	a1 cc 0a 00 00       	mov    0xacc,%eax
 ...
 5c2:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5c4:	a3 cc 0a 00 00       	mov    %eax,0xacc
}
 5c9:	5b                   	pop    %ebx
 5ca:	5e                   	pop    %esi
 5cb:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 621:	e8 54 ff ff ff       	call   57a <free>
  return freep;
 626:	a1 cc 0a 00 00       	mov    0xacc,%eax
...
malloc(uint nbytes)
{
 ...
 64a:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 64d:	8b 0d cc 0a 00 00    	mov    0xacc,%ecx
 ...
 659:	eb 4a                	jmp    6a5 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 65b:	c7 05 cc 0a 00 00 d0 	movl   $0xad0,0xacc
 662:	0a 00 00 
 665:	c7 05 d0 0a 00 00 d0 	movl   $0xad0,0xad0
 66c:	0a 00 00 
    base.s.size = 0;
 66f:	c7 05 d4 0a 00 00 00 	movl   $0x0,0xad4
 676:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 679:	b9 d0 0a 00 00       	mov    $0xad0,%ecx
 ...
 68a:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 68d:	89 0d cc 0a 00 00    	mov    %ecx,0xacc
      return (void*)(p + 1);
 ...
 6aa:	73 d4                	jae    680 <malloc+0x46>
    if(p == freep)
 6ac:	39 05 cc 0a 00 00    	cmp    %eax,0xacc
