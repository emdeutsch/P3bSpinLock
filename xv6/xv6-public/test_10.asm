...
worker(void *arg1, void *arg2) {
  ...
  36:	6a 01                	push   $0x1
  38:	e8 c7 05 00 00       	call   604 <printf>
  3d:	83 c4 0c             	add    $0xc,%esp
  40:	68 05 09 00 00       	push   $0x905
  45:	68 d5 08 00 00       	push   $0x8d5
  4a:	6a 01                	push   $0x1
  4c:	e8 b3 05 00 00       	call   604 <printf>
  51:	83 c4 08             	add    $0x8,%esp
  54:	68 e9 08 00 00       	push   $0x8e9
  59:	6a 01                	push   $0x1
  5b:	e8 a4 05 00 00       	call   604 <printf>
  60:	83 c4 04             	add    $0x4,%esp
  63:	ff 35 3c 0d 00 00    	push   0xd3c
  69:	e8 71 04 00 00       	call   4df <kill>
  6e:	e8 3c 04 00 00       	call   4af <exit>
   assert(arg1_int == 35);
  73:	6a 2d                	push   $0x2d
...
00000112 <main>:
{
 ...
 121:	83 ec 10             	sub    $0x10,%esp
   ppid = getpid();
 124:	e8 06 04 00 00       	call   52f <getpid>
 ...
 15a:	e8 21 03 00 00       	call   480 <thread_join>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5b5:	0f b6 92 b0 09 00 00 	movzbl 0x9b0(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 682:	ff 24 85 58 09 00 00 	jmp    *0x958(,%eax,4)
        printint(fd, *ap, 10, 1);
 ...
 6e7:	75 15                	jne    6fe <printf+0xfa>
          s = "(null)";
 6e9:	be 50 09 00 00       	mov    $0x950,%esi
...
free(void *ap)
{
 ...
 776:	a1 40 0d 00 00       	mov    0xd40,%eax
 ...
 7b2:	89 08                	mov    %ecx,(%eax)
  freep = p;
 7b4:	a3 40 0d 00 00       	mov    %eax,0xd40
}
 7b9:	5b                   	pop    %ebx
 7ba:	5e                   	pop    %esi
 7bb:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 811:	e8 54 ff ff ff       	call   76a <free>
  return freep;
 816:	a1 40 0d 00 00       	mov    0xd40,%eax
...
malloc(uint nbytes)
{
 ...
 83a:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 83d:	8b 0d 40 0d 00 00    	mov    0xd40,%ecx
 ...
 849:	eb 4a                	jmp    895 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 84b:	c7 05 40 0d 00 00 44 	movl   $0xd44,0xd40
 852:	0d 00 00 
 855:	c7 05 44 0d 00 00 44 	movl   $0xd44,0xd44
 85c:	0d 00 00 
    base.s.size = 0;
 85f:	c7 05 48 0d 00 00 00 	movl   $0x0,0xd48
 866:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 869:	b9 44 0d 00 00       	mov    $0xd44,%ecx
 ...
 87a:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 87d:	89 0d 40 0d 00 00    	mov    %ecx,0xd40
      return (void*)(p + 1);
 ...
 89a:	73 d4                	jae    870 <malloc+0x46>
    if(p == freep)
 89c:	39 05 40 0d 00 00    	cmp    %eax,0xd40
