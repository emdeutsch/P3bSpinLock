...
main(int argc, char **argv)
{
  ...
  39:	e8 5c 03 00 00       	call   39a <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 20 03 00 00       	call   36a <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 78 04 00 00       	call   4d0 <printf>
    exit();
  58:	e8 0d 03 00 00       	call   36a <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	57                   	push   %edi
 196:	6a 00                	push   $0x0
 198:	e8 e5 01 00 00       	call   382 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 a8 01 00 00       	call   3aa <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 ab 01 00 00       	call   3c2 <fstat>
  close(fd);
 217:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 21a:	89 c6                	mov    %eax,%esi
  close(fd);
 21c:	e8 71 01 00 00       	call   392 <close>
  return r;
...
lock_acquire(lock_t *lock){
 ...
 2e6:	83 38 01             	cmpl   $0x1,(%eax)
 2e9:	75 05                	jne    2f0 <lock_acquire+0x10>
 2eb:	eb fe                	jmp    2eb <lock_acquire+0xb>
 2ed:	8d 76 00             	lea    0x0(%esi),%esi
 2f0:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
 2f6:	5d                   	pop    %ebp
 2f7:	c3                   	ret    
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 320:	50                   	push   %eax
 321:	ff 75 10             	push   0x10(%ebp)
 324:	ff 75 0c             	push   0xc(%ebp)
 327:	ff 75 08             	push   0x8(%ebp)
 32a:	e8 db 00 00 00       	call   40a <clone>
}
 32f:	c9                   	leave  
 330:	c3                   	ret    
...
thread_join(){
 347:	83 ec 20             	sub    $0x20,%esp
  int waitedForPID = join(&stack);
 34a:	50                   	push   %eax
 34b:	e8 c2 00 00 00       	call   412 <join>
...
free(void *ap)
{
 ...
 671:	a1 e8 0b 00 00       	mov    0xbe8,%eax
{
 ...
 6b1:	5b                   	pop    %ebx
  freep = p;
 6b2:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
}
 6b8:	5e                   	pop    %esi
 6b9:	5f                   	pop    %edi
 6ba:	5d                   	pop    %ebp
 ...
 6e9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ec:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 74f:	73 4f                	jae    7a0 <malloc+0xa0>
    ...
    if(p == freep)
 751:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
 ...
 77a:	e8 f1 fe ff ff       	call   670 <free>
  return freep;
 77f:	8b 15 e8 0b 00 00    	mov    0xbe8,%edx
 ...
 7ac:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7af:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
}
 ...
 7bf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7c0:	c7 05 e8 0b 00 00 ec 	movl   $0xbec,0xbe8
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	bf ec 0b 00 00       	mov    $0xbec,%edi
    base.s.ptr = freep = prevp = &base;
 7cf:	c7 05 ec 0b 00 00 ec 	movl   $0xbec,0xbec
 7d6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7d9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7db:	c7 05 f0 0b 00 00 00 	movl   $0x0,0xbf0
 7e2:	00 00 00 
    if(p->s.size >= nunits){
