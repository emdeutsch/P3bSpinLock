...
main(int argc, char *argv[])
{
  ...
  exit();
  65:	e8 10 03 00 00       	call   37a <exit>
  6a:	66 90                	xchg   %ax,%ax
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	57                   	push   %edi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 e5 01 00 00       	call   392 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 a8 01 00 00       	call   3ba <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 ab 01 00 00       	call   3d2 <fstat>
  close(fd);
 227:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 22a:	89 c6                	mov    %eax,%esi
  close(fd);
 22c:	e8 71 01 00 00       	call   3a2 <close>
  return r;
...
lock_acquire(lock_t *lock){
 ...
 2f6:	83 38 01             	cmpl   $0x1,(%eax)
 2f9:	75 05                	jne    300 <lock_acquire+0x10>
 2fb:	eb fe                	jmp    2fb <lock_acquire+0xb>
 2fd:	8d 76 00             	lea    0x0(%esi),%esi
 300:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
 306:	5d                   	pop    %ebp
 307:	c3                   	ret    
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 32b:	e8 e0 03 00 00       	call   710 <malloc>
    return clone(start_routine, arg1, arg2, stack);
 330:	50                   	push   %eax
 331:	ff 75 10             	push   0x10(%ebp)
 334:	ff 75 0c             	push   0xc(%ebp)
 337:	ff 75 08             	push   0x8(%ebp)
 33a:	e8 db 00 00 00       	call   41a <clone>
}
 33f:	c9                   	leave  
 340:	c3                   	ret    
...
thread_join(){
 357:	83 ec 20             	sub    $0x20,%esp
  int waitedForPID = join(&stack);
 35a:	50                   	push   %eax
 35b:	e8 c2 00 00 00       	call   422 <join>
 360:	89 c3                	mov    %eax,%ebx
  free(stack);
 362:	58                   	pop    %eax
 363:	ff 75 f4             	push   -0xc(%ebp)
 366:	e8 15 03 00 00       	call   680 <free>
  return waitedForPID;
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 4ae:	56                   	push   %esi
 4af:	57                   	push   %edi
 4b0:	e8 e5 fe ff ff       	call   39a <write>
  while(--i >= 0)
 ...
 4e9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 525:	57                   	push   %edi
 526:	56                   	push   %esi
 527:	e8 6e fe ff ff       	call   39a <write>
 ...
 57e:	e8 17 fe ff ff       	call   39a <write>
        putc(fd, c);
 ...
 5fb:	57                   	push   %edi
 5fc:	56                   	push   %esi
 5fd:	e8 98 fd ff ff       	call   39a <write>
        while(*s != 0){
 ...
 63c:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 63f:	e8 56 fd ff ff       	call   39a <write>
        ap++;
...
free(void *ap)
{
 ...
 681:	a1 e8 0b 00 00       	mov    0xbe8,%eax
{
 ...
 6c1:	5b                   	pop    %ebx
  freep = p;
 6c2:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
}
 6c8:	5e                   	pop    %esi
 6c9:	5f                   	pop    %edi
 6ca:	5d                   	pop    %ebp
 ...
 6f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6fc:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 719:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 71c:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 75f:	73 4f                	jae    7b0 <malloc+0xa0>
    ...
    if(p == freep)
 761:	8b 3d e8 0b 00 00    	mov    0xbe8,%edi
 ...
 773:	e8 8a fc ff ff       	call   402 <sbrk>
  if(p == (char*)-1)
 ...
 78a:	e8 f1 fe ff ff       	call   680 <free>
  return freep;
 78f:	8b 15 e8 0b 00 00    	mov    0xbe8,%edx
 ...
 7bc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 7bf:	89 15 e8 0b 00 00    	mov    %edx,0xbe8
}
 ...
 7cf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7d0:	c7 05 e8 0b 00 00 ec 	movl   $0xbec,0xbe8
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	bf ec 0b 00 00       	mov    $0xbec,%edi
    base.s.ptr = freep = prevp = &base;
 7df:	c7 05 ec 0b 00 00 ec 	movl   $0xbec,0xbec
 7e6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7eb:	c7 05 f0 0b 00 00 00 	movl   $0x0,0xbf0
 7f2:	00 00 00 
    if(p->s.size >= nunits){
