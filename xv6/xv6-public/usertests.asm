...
main(int argc, char *argv[])
{
  ...
  if(open("usertests.ran", 0) >= 0){
      ...
      26:	e8 9f 39 00 00       	call   39ca <open>
    ...
    exit();
      40:	e8 45 39 00 00       	call   398a <exit>
  }
  close(open("usertests.ran", O_CREATE));
      ...
      51:	e8 74 39 00 00       	call   39ca <open>
  ...
  exit();
     10d:	e8 78 38 00 00       	call   398a <exit>
...
00000120 <iputtest>:
{
  ...
  if(chdir("iputdir") < 0){
     ...
     151:	e8 a4 38 00 00       	call   39fa <chdir>
  ...
  if(unlink("../iputdir") < 0){
     ...
     169:	e8 6c 38 00 00       	call   39da <unlink>
  ...
  if(chdir("/") < 0){
     ...
     17d:	e8 78 38 00 00       	call   39fa <chdir>
  ...
  printf(stdout, "iput test ok\n");
     ...
     191:	ff 35 cc 5f 00 00    	push   0x5fcc
    ...
    printf(stdout, "mkdir failed\n");
     ...
     1a8:	ff 35 cc 5f 00 00    	push   0x5fcc
     1ae:	e8 3d 39 00 00       	call   3af0 <printf>
    exit();
     1b3:	e8 d2 37 00 00       	call   398a <exit>
    printf(stdout, "chdir / failed\n");
     1b8:	50                   	push   %eax
     1b9:	50                   	push   %eax
     1ba:	68 63 3e 00 00       	push   $0x3e63
     1bf:	ff 35 cc 5f 00 00    	push   0x5fcc
     1c5:	e8 26 39 00 00       	call   3af0 <printf>
    exit();
     1ca:	e8 bb 37 00 00       	call   398a <exit>
    printf(stdout, "unlink ../iputdir failed\n");
     1cf:	52                   	push   %edx
     1d0:	52                   	push   %edx
     1d1:	68 47 3e 00 00       	push   $0x3e47
     1d6:	ff 35 cc 5f 00 00    	push   0x5fcc
     1dc:	e8 0f 39 00 00       	call   3af0 <printf>
    exit();
     1e1:	e8 a4 37 00 00       	call   398a <exit>
    printf(stdout, "chdir iputdir failed\n");
     1e6:	51                   	push   %ecx
     1e7:	51                   	push   %ecx
     1e8:	68 26 3e 00 00       	push   $0x3e26
     1ed:	ff 35 cc 5f 00 00    	push   0x5fcc
     1f3:	e8 f8 38 00 00       	call   3af0 <printf>
    exit();
     1f8:	e8 8d 37 00 00       	call   398a <exit>
...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     20b:	ff 35 cc 5f 00 00    	push   0x5fcc
     211:	e8 da 38 00 00       	call   3af0 <printf>
  pid = fork();
     216:	e8 67 37 00 00       	call   3982 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     230:	e8 bd 37 00 00       	call   39f2 <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     248:	e8 ad 37 00 00       	call   39fa <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     260:	e8 75 37 00 00       	call   39da <unlink>
     265:	83 c4 10             	add    $0x10,%esp
     268:	85 c0                	test   %eax,%eax
     26a:	78 2c                	js     298 <exitiputtest+0x98>
    exit();
     26c:	e8 19 37 00 00       	call   398a <exit>
     271:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  wait();
     278:	e8 15 37 00 00       	call   3992 <wait>
  printf(stdout, "exitiput test ok\n");
     27d:	83 ec 08             	sub    $0x8,%esp
     280:	68 96 3e 00 00       	push   $0x3e96
     285:	ff 35 cc 5f 00 00    	push   0x5fcc
     ...
     2a0:	ff 35 cc 5f 00 00    	push   0x5fcc
     2a6:	e8 45 38 00 00       	call   3af0 <printf>
      exit();
     2ab:	e8 da 36 00 00       	call   398a <exit>
    printf(stdout, "fork failed\n");
     2b0:	51                   	push   %ecx
     2b1:	51                   	push   %ecx
     2b2:	68 59 4d 00 00       	push   $0x4d59
     2b7:	ff 35 cc 5f 00 00    	push   0x5fcc
     2bd:	e8 2e 38 00 00       	call   3af0 <printf>
    exit();
     2c2:	e8 c3 36 00 00       	call   398a <exit>
      printf(stdout, "mkdir failed\n");
     2c7:	52                   	push   %edx
     2c8:	52                   	push   %edx
     2c9:	68 18 3e 00 00       	push   $0x3e18
     2ce:	ff 35 cc 5f 00 00    	push   0x5fcc
     2d4:	e8 17 38 00 00       	call   3af0 <printf>
      exit();
     2d9:	e8 ac 36 00 00       	call   398a <exit>
      printf(stdout, "child chdir failed\n");
     2de:	50                   	push   %eax
     2df:	50                   	push   %eax
     2e0:	68 82 3e 00 00       	push   $0x3e82
     2e5:	ff 35 cc 5f 00 00    	push   0x5fcc
     2eb:	e8 00 38 00 00       	call   3af0 <printf>
      exit();
     2f0:	e8 95 36 00 00       	call   398a <exit>
...
00000300 <openiputtest>:
{
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     342:	e8 83 36 00 00       	call   39ca <open>
    if(fd >= 0){
  ...
  printf(stdout, "openiput test ok\n");
    ...
    exit();
     3b0:	e8 d5 35 00 00       	call   398a <exit>
    printf(stdout, "fork failed\n");
     3b5:	52                   	push   %edx
     3b6:	52                   	push   %edx
     3b7:	68 59 4d 00 00       	push   $0x4d59
     3bc:	ff 35 cc 5f 00 00    	push   0x5fcc
     3c2:	e8 29 37 00 00       	call   3af0 <printf>
    exit();
     3c7:	e8 be 35 00 00       	call   398a <exit>
    printf(stdout, "mkdir oidir failed\n");
     3cc:	51                   	push   %ecx
     3cd:	51                   	push   %ecx
     3ce:	68 bd 3e 00 00       	push   $0x3ebd
     3d3:	ff 35 cc 5f 00 00    	push   0x5fcc
     3d9:	e8 12 37 00 00       	call   3af0 <printf>
    exit();
     3de:	e8 a7 35 00 00       	call   398a <exit>
    printf(stdout, "unlink failed\n");
     3e3:	50                   	push   %eax
     3e4:	50                   	push   %eax
     3e5:	68 d1 3e 00 00       	push   $0x3ed1
     3ea:	ff 35 cc 5f 00 00    	push   0x5fcc
     3f0:	e8 fb 36 00 00       	call   3af0 <printf>
    exit();
     3f5:	e8 90 35 00 00       	call   398a <exit>
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 cc 5f 00 00    	push   0x5fcc
  ...
  fd = open("echo", 0);
     ...
     41f:	e8 a6 35 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  fd = open("doesnotexist", 0);
     ...
     43d:	e8 88 35 00 00       	call   39ca <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 cc 5f 00 00    	push   0x5fcc
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 cc 5f 00 00    	push   0x5fcc
     46e:	e8 7d 36 00 00       	call   3af0 <printf>
    exit();
     473:	e8 12 35 00 00       	call   398a <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     478:	50                   	push   %eax
     479:	50                   	push   %eax
     47a:	68 22 3f 00 00       	push   $0x3f22
     47f:	ff 35 cc 5f 00 00    	push   0x5fcc
     485:	e8 66 36 00 00       	call   3af0 <printf>
    exit();
     48a:	e8 fb 34 00 00       	call   398a <exit>
     48f:	90                   	nop
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 cc 5f 00 00    	push   0x5fcc
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     4b4:	e8 11 35 00 00       	call   39ca <open>
  if(fd >= 0){
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 cc 5f 00 00    	push   0x5fcc
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     4ea:	56                   	push   %esi
     4eb:	e8 ba 34 00 00       	call   39aa <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     506:	56                   	push   %esi
     507:	e8 9e 34 00 00       	call   39aa <write>
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 cc 5f 00 00    	push   0x5fcc
  ...
  fd = open("small", O_RDONLY);
     ...
     544:	e8 81 34 00 00       	call   39ca <open>
  if(fd >= 0){
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 cc 5f 00 00    	push   0x5fcc
  ...
  i = read(fd, buf, 2000);
     ...
     576:	53                   	push   %ebx
     577:	e8 26 34 00 00       	call   39a2 <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 cc 5f 00 00    	push   0x5fcc
     598:	e8 53 35 00 00       	call   3af0 <printf>
  close(fd);
     59d:	89 1c 24             	mov    %ebx,(%esp)
     5a0:	e8 0d 34 00 00       	call   39b2 <close>
  if(unlink("small") < 0){
     5a5:	c7 04 24 5f 3f 00 00 	movl   $0x3f5f,(%esp)
     5ac:	e8 29 34 00 00       	call   39da <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 cc 5f 00 00    	push   0x5fcc
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 cc 5f 00 00    	push   0x5fcc
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     694:	e8 31 33 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     6c3:	56                   	push   %esi
     6c4:	e8 e1 32 00 00       	call   39aa <write>
  ...
  close(fd);
     ...
     6e5:	56                   	push   %esi
     6e6:	e8 c7 32 00 00       	call   39b2 <close>
  fd = open("big", O_RDONLY);
     6eb:	5b                   	pop    %ebx
     6ec:	5e                   	pop    %esi
     6ed:	6a 00                	push   $0x0
     6ef:	68 a7 40 00 00       	push   $0x40a7
     6f4:	e8 d1 32 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  n = 0;
    ...
    i = read(fd, buf, 512);
     ...
     734:	53                   	push   %ebx
     735:	e8 68 32 00 00       	call   39a2 <read>
    if(i == 0){
  ...
  close(fd);
     ...
     750:	53                   	push   %ebx
     751:	e8 5c 32 00 00       	call   39b2 <close>
  if(unlink("big") < 0){
     756:	c7 04 24 a7 40 00 00 	movl   $0x40a7,(%esp)
     75d:	e8 78 32 00 00       	call   39da <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 cc 5f 00 00    	push   0x5fcc
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 cc 5f 00 00    	push   0x5fcc
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     886:	e8 3f 31 00 00       	call   39ca <open>
    close(fd);
     88b:	89 04 24             	mov    %eax,(%esp)
     88e:	e8 1f 31 00 00       	call   39b2 <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     8c1:	e8 14 31 00 00       	call   39da <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 cc 5f 00 00    	push   0x5fcc
...
000008f0 <dirtest>:
{
  ...
  if(chdir("dir0") < 0){
     ...
     921:	e8 d4 30 00 00       	call   39fa <chdir>
  ...
  if(chdir("..") < 0){
     ...
     939:	e8 bc 30 00 00       	call   39fa <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     94d:	e8 88 30 00 00       	call   39da <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 cc 5f 00 00    	push   0x5fcc
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 cc 5f 00 00    	push   0x5fcc
     97e:	e8 6d 31 00 00       	call   3af0 <printf>
    exit();
     983:	e8 02 30 00 00       	call   398a <exit>
    printf(stdout, "unlink dir0 failed\n");
     988:	50                   	push   %eax
     989:	50                   	push   %eax
     98a:	68 11 41 00 00       	push   $0x4111
     98f:	ff 35 cc 5f 00 00    	push   0x5fcc
     995:	e8 56 31 00 00       	call   3af0 <printf>
    exit();
     99a:	e8 eb 2f 00 00       	call   398a <exit>
    printf(stdout, "chdir .. failed\n");
     99f:	52                   	push   %edx
     9a0:	52                   	push   %edx
     9a1:	68 00 41 00 00       	push   $0x4100
     9a6:	ff 35 cc 5f 00 00    	push   0x5fcc
     9ac:	e8 3f 31 00 00       	call   3af0 <printf>
    exit();
     9b1:	e8 d4 2f 00 00       	call   398a <exit>
    printf(stdout, "chdir dir0 failed\n");
     9b6:	51                   	push   %ecx
     9b7:	51                   	push   %ecx
     9b8:	68 ed 40 00 00       	push   $0x40ed
     9bd:	ff 35 cc 5f 00 00    	push   0x5fcc
     9c3:	e8 28 31 00 00       	call   3af0 <printf>
    exit();
     9c8:	e8 bd 2f 00 00       	call   398a <exit>
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 cc 5f 00 00    	push   0x5fcc
  ...
  if(exec("echo", echoargv) < 0){
     ...
     9f2:	e8 cb 2f 00 00       	call   39c2 <exec>
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 cc 5f 00 00    	push   0x5fcc
     a0d:	e8 de 30 00 00       	call   3af0 <printf>
    exit();
     a12:	e8 73 2f 00 00       	call   398a <exit>
     ...
     a25:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  seq = 0;
    ...
    close(fds[1]);
     a5d:	e8 50 2f 00 00       	call   39b2 <close>
    total = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     a78:	e8 25 2f 00 00       	call   39a2 <read>
  ...
  seq = 0;
    ...
    close(fds[0]);
     ad7:	e8 d6 2e 00 00       	call   39b2 <close>
     ...
     b11:	e8 94 2e 00 00       	call   39aa <write>
    ...
    exit();
     b28:	e8 5d 2e 00 00       	call   398a <exit>
    if(total != 5 * 1033){
    ...
    close(fds[0]);
     ...
     b3c:	e8 71 2e 00 00       	call   39b2 <close>
    wait();
     b41:	e8 4c 2e 00 00       	call   3992 <wait>
  printf(1, "pipe1 ok\n");
     b46:	5a                   	pop    %edx
     b47:	59                   	pop    %ecx
     ...
     b67:	e8 84 2f 00 00       	call   3af0 <printf>
      exit();
     b6c:	e8 19 2e 00 00       	call   398a <exit>
    ...
    exit();
     b7f:	e8 06 2e 00 00       	call   398a <exit>
    ...
    exit();
     b92:	e8 f3 2d 00 00       	call   398a <exit>
     ...
     ba0:	e8 4b 2f 00 00       	call   3af0 <printf>
        exit();
     ba5:	e8 e0 2d 00 00       	call   398a <exit>
...
00000bb0 <preempt>:
{
  ...
  pid1 = fork();
     bc5:	e8 b8 2d 00 00       	call   3982 <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     bda:	e8 a3 2d 00 00       	call   3982 <fork>
  ...
  pipe(pfds);
     ...
     bf6:	50                   	push   %eax
     bf7:	e8 9e 2d 00 00       	call   399a <pipe>
  pid3 = fork();
     bfc:	e8 81 2d 00 00       	call   3982 <fork>
  if(pid3 == 0){
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c22:	e8 83 2d 00 00       	call   39aa <write>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
     ...
     c63:	e8 3a 2d 00 00       	call   39a2 <read>
  ...
  kill(pid1);
     ...
     c8c:	e8 29 2d 00 00       	call   39ba <kill>
  kill(pid2);
     c91:	89 34 24             	mov    %esi,(%esp)
     c94:	e8 21 2d 00 00       	call   39ba <kill>
  kill(pid3);
     c99:	89 3c 24             	mov    %edi,(%esp)
     c9c:	e8 19 2d 00 00       	call   39ba <kill>
  printf(1, "wait... ");
     ca1:	59                   	pop    %ecx
     ca2:	5b                   	pop    %ebx
  ...
  wait();
     caf:	e8 de 2c 00 00       	call   3992 <wait>
  wait();
     cb4:	e8 d9 2c 00 00       	call   3992 <wait>
  wait();
     cb9:	e8 d4 2c 00 00       	call   3992 <wait>
  printf(1, "preempt ok\n");
     cbe:	5e                   	pop    %esi
     cbf:	5f                   	pop    %edi
...
00000d10 <exitwait>:
{
    ...
    if(pid){
     d20:	74 68                	je     d8a <exitwait+0x7a>
      if(wait() != pid){
     d22:	e8 6b 2c 00 00       	call   3992 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     d30:	e8 4d 2c 00 00       	call   3982 <fork>
  ...
  printf(1, "exitwait ok\n");
     ...
     d89:	c3                   	ret    
      exit();
     d8a:	e8 fb 2b 00 00       	call   398a <exit>
     d8f:	90                   	nop
...
00000d90 <mem>:
{
  ...
  ppid = getpid();
     da6:	e8 5f 2c 00 00       	call   3a0a <getpid>
     dab:	89 c3                	mov    %eax,%ebx
  if((pid = fork()) == 0){
     dad:	e8 d0 2b 00 00       	call   3982 <fork>
    ...
    exit();
     e1f:	e8 66 2b 00 00       	call   398a <exit>
     ...
     e3a:	e8 7b 2b 00 00       	call   39ba <kill>
      exit();
     e3f:	e8 46 2b 00 00       	call   398a <exit>
     ...
     e4d:	5d                   	pop    %ebp
    wait();
     e4e:	e9 3f 2b 00 00       	jmp    3992 <wait>
...
00000e60 <sharedfd>:
{
  ...
  unlink("sharedfd");
     ...
     e7c:	e8 59 2b 00 00       	call   39da <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
     e81:	5b                   	pop    %ebx
     e82:	5e                   	pop    %esi
     e83:	68 02 02 00 00       	push   $0x202
     e88:	68 53 42 00 00       	push   $0x4253
     e8d:	e8 38 2b 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  pid = fork();
     ea7:	e8 d6 2a 00 00       	call   3982 <fork>
  memset(buf, pid==0?'c':'p', sizeof(buf));
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     eda:	56                   	push   %esi
     edb:	57                   	push   %edi
     edc:	e8 c9 2a 00 00       	call   39aa <write>
  ...
  if(pid == 0)
    ...
    wait();
     f06:	e8 87 2a 00 00       	call   3992 <wait>
  close(fd);
  ...
  fd = open("sharedfd", 0);
     ...
     f22:	e8 a3 2a 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	e8 51 2a 00 00       	call   39a2 <read>
  ...
  unlink("sharedfd");
     ...
     f92:	e8 43 2a 00 00       	call   39da <unlink>
  if(nc == 10000 && np == 10000){
    ...
    return;
     ...
     ffa:	c3                   	ret    
    exit();
     ffb:	e8 8a 29 00 00       	call   398a <exit>
    ...
    exit();
    100e:	e8 77 29 00 00       	call   398a <exit>
    ...
    102b:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "fourfiles test\n");
    ...
    105e:	56                   	push   %esi
    105f:	e8 76 29 00 00       	call   39da <unlink>
    pid = fork();
    1064:	e8 19 29 00 00       	call   3982 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1088:	e8 05 29 00 00       	call   3992 <wait>
  for(i = 0; i < 2; i++){
    108d:	31 f6                	xor    %esi,%esi
    wait();
    108f:	e8 fe 28 00 00       	call   3992 <wait>
    1094:	e8 f9 28 00 00       	call   3992 <wait>
    1099:	e8 f4 28 00 00       	call   3992 <wait>
    fname = names[i];
    ...
    fd = open(fname, 0);
    10ad:	e8 18 29 00 00       	call   39ca <open>
    while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    10d0:	e8 cd 28 00 00       	call   39a2 <read>
    ...
    1104:	e8 a9 28 00 00       	call   39b2 <close>
    if(total != 12*500){
    ...
    111e:	e8 b7 28 00 00       	call   39da <unlink>
  for(i = 0; i < 2; i++){
  ...
  printf(1, "fourfiles ok\n");
    ...
    1159:	e8 92 29 00 00       	call   3af0 <printf>
          exit();
    115e:	e8 27 28 00 00       	call   398a <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    1163:	83 ec 08             	sub    $0x8,%esp
    1166:	68 02 02 00 00       	push   $0x202
    116b:	56                   	push   %esi
    116c:	e8 59 28 00 00       	call   39ca <open>
      if(fd < 0){
    ...
    11a5:	56                   	push   %esi
    11a6:	e8 ff 27 00 00       	call   39aa <write>
    ...
    11b8:	75 de                	jne    1198 <fourfiles+0x178>
      exit();
    11ba:	e8 cb 27 00 00       	call   398a <exit>
    ...
    11c8:	e8 23 29 00 00       	call   3af0 <printf>
        exit();
    11cd:	e8 b8 27 00 00       	call   398a <exit>
    ...
    11e2:	e8 09 29 00 00       	call   3af0 <printf>
      exit();
    11e7:	e8 9e 27 00 00       	call   398a <exit>
    ...
    11f5:	e8 f6 28 00 00       	call   3af0 <printf>
      exit();
    11fa:	e8 8b 27 00 00       	call   398a <exit>
    ...
    1208:	e8 e3 28 00 00       	call   3af0 <printf>
          exit();
    120d:	e8 78 27 00 00       	call   398a <exit>
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete test\n");
    ...
    pid = fork();
    123a:	e8 43 27 00 00       	call   3982 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    1255:	e8 38 27 00 00       	call   3992 <wait>
  for(i = 0; i < N; i++){
    125a:	31 f6                	xor    %esi,%esi
    125c:	8d 7d c8             	lea    -0x38(%ebp),%edi
    wait();
    125f:	e8 2e 27 00 00       	call   3992 <wait>
    1264:	e8 29 27 00 00       	call   3992 <wait>
    1269:	e8 24 27 00 00       	call   3992 <wait>
  ...
  for(i = 0; i < N; i++){
    ...
    12a6:	88 45 c9             	mov    %al,-0x37(%ebp)
      fd = open(name, 0);
    12a9:	e8 1c 27 00 00       	call   39ca <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    12cc:	50                   	push   %eax
    12cd:	e8 e0 26 00 00       	call   39b2 <close>
  ...
  for(i = 0; i < N; i++){
    ...
    1308:	88 45 c9             	mov    %al,-0x37(%ebp)
      unlink(name);
    130b:	e8 ca 26 00 00       	call   39da <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    134d:	e8 9e 27 00 00       	call   3af0 <printf>
        exit();
    1352:	e8 33 26 00 00       	call   398a <exit>
    ...
    1397:	88 45 c9             	mov    %al,-0x37(%ebp)
        fd = open(name, O_CREATE | O_RDWR);
    139a:	e8 2b 26 00 00       	call   39ca <open>
        if(fd < 0){
    ...
    13a9:	50                   	push   %eax
    13aa:	e8 03 26 00 00       	call   39b2 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    13c6:	88 45 c9             	mov    %al,-0x37(%ebp)
          if(unlink(name) < 0){
    13c9:	e8 0c 26 00 00       	call   39da <unlink>
    ...
    13de:	e8 0d 27 00 00       	call   3af0 <printf>
            exit();
    13e3:	e8 a2 25 00 00       	call   398a <exit>
    13e8:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    13ef:	90                   	nop
      exit();
    13f0:	e8 95 25 00 00       	call   398a <exit>
    ...
    1400:	e8 eb 26 00 00       	call   3af0 <printf>
        exit();
    1405:	e8 80 25 00 00       	call   398a <exit>
      printf(1, "fork failed\n");
    ...
    1414:	e8 d7 26 00 00       	call   3af0 <printf>
      exit();
    1419:	e8 6c 25 00 00       	call   398a <exit>
          printf(1, "create failed\n");
    ...
    1428:	e8 c3 26 00 00       	call   3af0 <printf>
          exit();
    142d:	e8 58 25 00 00       	call   398a <exit>
...
00001440 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1460:	e8 65 25 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  write(fd, "hello", 5);
    ...
    147c:	50                   	push   %eax
    147d:	e8 28 25 00 00       	call   39aa <write>
  close(fd);
    1482:	89 1c 24             	mov    %ebx,(%esp)
    1485:	e8 28 25 00 00       	call   39b2 <close>
  fd = open("unlinkread", O_RDWR);
    148a:	58                   	pop    %eax
    148b:	5a                   	pop    %edx
    148c:	6a 02                	push   $0x2
    148e:	68 05 43 00 00       	push   $0x4305
    1493:	e8 32 25 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
    ...
    14ad:	e8 28 25 00 00       	call   39da <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    14ca:	e8 fb 24 00 00       	call   39ca <open>
  write(fd1, "yyy", 3);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    151b:	53                   	push   %ebx
    151c:	e8 89 24 00 00       	call   39aa <write>
  ...
  close(fd);
    ...
    152c:	53                   	push   %ebx
    152d:	e8 80 24 00 00       	call   39b2 <close>
  unlink("unlinkread");
    1532:	c7 04 24 05 43 00 00 	movl   $0x4305,(%esp)
    1539:	e8 9c 24 00 00       	call   39da <unlink>
  printf(1, "unlinkread ok\n");
    ...
    exit();
    1564:	e8 21 24 00 00       	call   398a <exit>
    ...
    exit();
    1577:	e8 0e 24 00 00       	call   398a <exit>
    ...
    exit();
    158a:	e8 fb 23 00 00       	call   398a <exit>
    ...
    exit();
    159d:	e8 e8 23 00 00       	call   398a <exit>
    ...
    exit();
    15b0:	e8 d5 23 00 00       	call   398a <exit>
    ...
    exit();
    15c3:	e8 c2 23 00 00       	call   398a <exit>
...
000015d0 <linktest>:
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1623:	50                   	push   %eax
    1624:	e8 81 23 00 00       	call   39aa <write>
  ...
  close(fd);
    ...
    1638:	53                   	push   %ebx
    1639:	e8 74 23 00 00       	call   39b2 <close>
  if(link("lf1", "lf2") < 0){
    163e:	5b                   	pop    %ebx
    163f:	58                   	pop    %eax
    1640:	68 ca 43 00 00       	push   $0x43ca
    1645:	68 c6 43 00 00       	push   $0x43c6
    164a:	e8 9b 23 00 00       	call   39ea <link>
  ...
  unlink("lf1");
    ...
    1662:	e8 73 23 00 00       	call   39da <unlink>
  if(open("lf1", 0) >= 0){
    1667:	58                   	pop    %eax
    1668:	5a                   	pop    %edx
    1669:	6a 00                	push   $0x0
    166b:	68 c6 43 00 00       	push   $0x43c6
    1670:	e8 55 23 00 00       	call   39ca <open>
  ...
  fd = open("lf2", 0);
    ...
    168a:	e8 3b 23 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16a9:	50                   	push   %eax
    16aa:	e8 f3 22 00 00       	call   39a2 <read>
  ...
  close(fd);
    ...
    16be:	53                   	push   %ebx
    16bf:	e8 ee 22 00 00       	call   39b2 <close>
  if(link("lf2", "lf2") >= 0){
    16c4:	58                   	pop    %eax
    16c5:	5a                   	pop    %edx
    16c6:	68 ca 43 00 00       	push   $0x43ca
    16cb:	68 ca 43 00 00       	push   $0x43ca
    16d0:	e8 15 23 00 00       	call   39ea <link>
  ...
  unlink("lf2");
    ...
    16e8:	e8 ed 22 00 00       	call   39da <unlink>
  if(link("lf2", "lf1") >= 0){
    16ed:	59                   	pop    %ecx
    16ee:	5b                   	pop    %ebx
    16ef:	68 c6 43 00 00       	push   $0x43c6
    16f4:	68 ca 43 00 00       	push   $0x43ca
    16f9:	e8 ec 22 00 00       	call   39ea <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1712:	e8 d3 22 00 00       	call   39ea <link>
  ...
  printf(1, "linktest ok\n");
    ...
    exit();
    1743:	e8 42 22 00 00       	call   398a <exit>
    ...
    exit();
    1756:	e8 2f 22 00 00       	call   398a <exit>
    ...
    exit();
    1769:	e8 1c 22 00 00       	call   398a <exit>
    ...
    exit();
    177c:	e8 09 22 00 00       	call   398a <exit>
    ...
    exit();
    178f:	e8 f6 21 00 00       	call   398a <exit>
    ...
    exit();
    17a2:	e8 e3 21 00 00       	call   398a <exit>
    ...
    exit();
    17b5:	e8 d0 21 00 00       	call   398a <exit>
    ...
    exit();
    17c8:	e8 bd 21 00 00       	call   398a <exit>
    ...
    exit();
    17db:	e8 aa 21 00 00       	call   398a <exit>
    ...
    17e5:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 40; i++){
    ...
    1829:	53                   	push   %ebx
    182a:	e8 9b 21 00 00       	call   39ca <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    1839:	83 c6 01             	add    $0x1,%esi
      close(fd);
    183c:	50                   	push   %eax
    183d:	e8 70 21 00 00       	call   39b2 <close>
    1842:	83 c4 10             	add    $0x10,%esp
      wait();
    1845:	e8 48 21 00 00       	call   3992 <wait>
  for(i = 0; i < 40; i++){
    ...
    unlink(file);
    185d:	e8 78 21 00 00       	call   39da <unlink>
    pid = fork();
    1862:	e8 1b 21 00 00       	call   3982 <fork>
    if(pid && (i % 3) == 1){
    ...
    1884:	53                   	push   %ebx
    1885:	e8 40 21 00 00       	call   39ca <open>
      if(fd < 0){
  ...
  for(i = 0; i < 40; i++){
    ...
    18dc:	e8 09 21 00 00       	call   39ea <link>
    18e1:	83 c4 10             	add    $0x10,%esp
      wait();
    18e4:	e8 a9 20 00 00       	call   3992 <wait>
  for(i = 0; i < 40; i++){
  ...
  fd = open(".", 0);
    ...
    190e:	e8 b7 20 00 00       	call   39ca <open>
  n = 0;
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1925:	57                   	push   %edi
    1926:	56                   	push   %esi
    1927:	e8 76 20 00 00       	call   39a2 <read>
  ...
  close(fd);
    ...
    1973:	56                   	push   %esi
    1974:	e8 39 20 00 00       	call   39b2 <close>
  if(n != 40){
  ...
  for(i = 0; i < 40; i++){
    ...
    199c:	53                   	push   %ebx
    199d:	e8 38 20 00 00       	call   39da <unlink>
      unlink(file);
    19a2:	89 1c 24             	mov    %ebx,(%esp)
    19a5:	e8 30 20 00 00       	call   39da <unlink>
      unlink(file);
    19aa:	89 1c 24             	mov    %ebx,(%esp)
    19ad:	e8 28 20 00 00       	call   39da <unlink>
      unlink(file);
    19b2:	89 1c 24             	mov    %ebx,(%esp)
    19b5:	e8 20 20 00 00       	call   39da <unlink>
    19ba:	83 c4 10             	add    $0x10,%esp
    if(pid == 0)
    19bd:	85 ff                	test   %edi,%edi
    19bf:	0f 84 fc fe ff ff    	je     18c1 <concreate+0xe1>
      wait();
    19c5:	e8 c8 1f 00 00       	call   3992 <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    19dc:	e8 a1 1f 00 00       	call   3982 <fork>
    ...
    1a08:	6a 00                	push   $0x0
    1a0a:	53                   	push   %ebx
    1a0b:	e8 ba 1f 00 00       	call   39ca <open>
    ...
    1a1a:	6a 00                	push   $0x0
    1a1c:	53                   	push   %ebx
    1a1d:	e8 a8 1f 00 00       	call   39ca <open>
    ...
    1a2c:	6a 00                	push   $0x0
    1a2e:	53                   	push   %ebx
    1a2f:	e8 96 1f 00 00       	call   39ca <open>
    1a34:	89 04 24             	mov    %eax,(%esp)
    1a37:	e8 76 1f 00 00       	call   39b2 <close>
      close(open(file, 0));
    1a3c:	58                   	pop    %eax
    1a3d:	5a                   	pop    %edx
    1a3e:	6a 00                	push   $0x0
    1a40:	53                   	push   %ebx
    1a41:	e8 84 1f 00 00       	call   39ca <open>
    1a46:	89 04 24             	mov    %eax,(%esp)
    1a49:	e8 64 1f 00 00       	call   39b2 <close>
  ...
  printf(1, "concreate ok\n");
    ...
    1a81:	e8 6a 20 00 00       	call   3af0 <printf>
      exit();
    1a86:	e8 ff 1e 00 00       	call   398a <exit>
    ...
    exit();
    1a99:	e8 ec 1e 00 00       	call   398a <exit>
    ...
    1aac:	e8 3f 20 00 00       	call   3af0 <printf>
        exit();
    1ab1:	e8 d4 1e 00 00       	call   398a <exit>
    ...
    1ac4:	e8 27 20 00 00       	call   3af0 <printf>
        exit();
    1ac9:	e8 bc 1e 00 00       	call   398a <exit>
      close(fd);
    1ace:	83 ec 0c             	sub    $0xc,%esp
    1ad1:	50                   	push   %eax
    1ad2:	e8 db 1e 00 00       	call   39b2 <close>
...
00001ae0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1afc:	e8 d9 1e 00 00       	call   39da <unlink>
  pid = fork();
    1b01:	e8 7c 1e 00 00       	call   3982 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1b3d:	e8 98 1e 00 00       	call   39da <unlink>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b76:	e8 4f 1e 00 00       	call   39ca <open>
    1b7b:	89 04 24             	mov    %eax,(%esp)
    1b7e:	e8 2f 1e 00 00       	call   39b2 <close>
  ...
  if(pid)
    ...
    wait();
    1b92:	e8 fb 1d 00 00       	call   3992 <wait>
  printf(1, "linkunlink ok\n");
    ...
    1bbd:	e8 28 1e 00 00       	call   39ea <link>
    ...
    exit();
    1bd8:	e8 ad 1d 00 00       	call   398a <exit>
    exit();
    1bdd:	e8 a8 1d 00 00       	call   398a <exit>
...
00001bf0 <bigdir>:
{
  ...
  unlink("bd");
    ...
    1c0c:	e8 c9 1d 00 00       	call   39da <unlink>
  fd = open("bd", O_CREATE);
    1c11:	5a                   	pop    %edx
    1c12:	59                   	pop    %ecx
    1c13:	68 00 02 00 00       	push   $0x200
    1c18:	68 15 45 00 00       	push   $0x4515
    1c1d:	e8 a8 1d 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  close(fd);
    1c35:	50                   	push   %eax
    1c36:	e8 77 1d 00 00       	call   39b2 <close>
    ...
    if(link("bd", name) != 0){
    1c67:	e8 7e 1d 00 00       	call   39ea <link>
  ...
  unlink("bd");
    ...
    1c88:	e8 4d 1d 00 00       	call   39da <unlink>
    ...
    if(unlink(name) != 0){
    1cb2:	e8 23 1d 00 00       	call   39da <unlink>
  ...
  printf(1, "bigdir ok\n");
    ...
    1ced:	e8 fe 1d 00 00       	call   3af0 <printf>
      exit();
    1cf2:	e8 93 1c 00 00       	call   398a <exit>
    ...
    1d01:	e8 ea 1d 00 00       	call   3af0 <printf>
      exit();
    1d06:	e8 7f 1c 00 00       	call   398a <exit>
    ...
    exit();
    1d19:	e8 6c 1c 00 00       	call   398a <exit>
...
00001d20 <subdir>:
{
  ...
  unlink("ff");
    ...
    1d3a:	e8 9b 1c 00 00       	call   39da <unlink>
  if(mkdir("dd") != 0){
    1d3f:	c7 04 24 88 46 00 00 	movl   $0x4688,(%esp)
    1d46:	e8 a7 1c 00 00       	call   39f2 <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1d63:	e8 62 1c 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  write(fd, "ff", 2);
    ...
    1d7f:	50                   	push   %eax
    1d80:	e8 25 1c 00 00       	call   39aa <write>
  close(fd);
    1d85:	89 1c 24             	mov    %ebx,(%esp)
    1d88:	e8 25 1c 00 00       	call   39b2 <close>
  if(unlink("dd") >= 0){
    1d8d:	c7 04 24 88 46 00 00 	movl   $0x4688,(%esp)
    1d94:	e8 41 1c 00 00       	call   39da <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1dac:	e8 41 1c 00 00       	call   39f2 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1dc9:	e8 fc 1b 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  write(fd, "FF", 2);
    ...
    1de5:	50                   	push   %eax
    1de6:	e8 bf 1b 00 00       	call   39aa <write>
  close(fd);
    1deb:	89 1c 24             	mov    %ebx,(%esp)
    1dee:	e8 bf 1b 00 00       	call   39b2 <close>
  fd = open("dd/dd/../ff", 0);
    1df3:	58                   	pop    %eax
    1df4:	5a                   	pop    %edx
    1df5:	6a 00                	push   $0x0
    1df7:	68 e2 45 00 00       	push   $0x45e2
    1dfc:	e8 c9 1b 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1e1b:	50                   	push   %eax
    1e1c:	e8 81 1b 00 00       	call   39a2 <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  close(fd);
    ...
    1e3d:	53                   	push   %ebx
    1e3e:	e8 6f 1b 00 00       	call   39b2 <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    1e43:	59                   	pop    %ecx
    1e44:	5b                   	pop    %ebx
    1e45:	68 22 46 00 00       	push   $0x4622
    1e4a:	68 be 45 00 00       	push   $0x45be
    1e4f:	e8 96 1b 00 00       	call   39ea <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1e67:	e8 6e 1b 00 00       	call   39da <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1e81:	e8 44 1b 00 00       	call   39ca <open>
  ...
  if(chdir("dd") != 0){
    ...
    1e99:	e8 5c 1b 00 00       	call   39fa <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1eb1:	e8 44 1b 00 00       	call   39fa <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ec9:	e8 2c 1b 00 00       	call   39fa <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1ee1:	e8 14 1b 00 00       	call   39fa <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1efb:	e8 ca 1a 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1f1a:	50                   	push   %eax
    1f1b:	e8 82 1a 00 00       	call   39a2 <read>
  ...
  close(fd);
    ...
    1f2f:	53                   	push   %ebx
    1f30:	e8 7d 1a 00 00       	call   39b2 <close>
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1f35:	58                   	pop    %eax
    1f36:	5a                   	pop    %edx
    1f37:	6a 00                	push   $0x0
    1f39:	68 be 45 00 00       	push   $0x45be
    1f3e:	e8 87 1a 00 00       	call   39ca <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f5b:	e8 6a 1a 00 00       	call   39ca <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1f78:	e8 4d 1a 00 00       	call   39ca <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1f95:	e8 30 1a 00 00       	call   39ca <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1faf:	e8 16 1a 00 00       	call   39ca <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1fc9:	e8 fc 19 00 00       	call   39ca <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1fe6:	e8 ff 19 00 00       	call   39ea <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2003:	e8 e2 19 00 00       	call   39ea <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2020:	e8 c5 19 00 00       	call   39ea <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    2038:	e8 b5 19 00 00       	call   39f2 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    2050:	e8 9d 19 00 00       	call   39f2 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    2068:	e8 85 19 00 00       	call   39f2 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2080:	e8 55 19 00 00       	call   39da <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2098:	e8 3d 19 00 00       	call   39da <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    20b0:	e8 45 19 00 00       	call   39fa <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    20c8:	e8 2d 19 00 00       	call   39fa <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    20e0:	e8 f5 18 00 00       	call   39da <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    20f8:	e8 dd 18 00 00       	call   39da <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    2110:	e8 c5 18 00 00       	call   39da <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2128:	e8 ad 18 00 00       	call   39da <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    2140:	e8 95 18 00 00       	call   39da <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    exit();
    2175:	e8 10 18 00 00       	call   398a <exit>
    ...
    exit();
    2188:	e8 fd 17 00 00       	call   398a <exit>
    ...
    exit();
    219b:	e8 ea 17 00 00       	call   398a <exit>
    ...
    exit();
    21ae:	e8 d7 17 00 00       	call   398a <exit>
    ...
    exit();
    21c1:	e8 c4 17 00 00       	call   398a <exit>
    ...
    exit();
    21d4:	e8 b1 17 00 00       	call   398a <exit>
    ...
    exit();
    21e7:	e8 9e 17 00 00       	call   398a <exit>
    ...
    exit();
    21fa:	e8 8b 17 00 00       	call   398a <exit>
    ...
    exit();
    220d:	e8 78 17 00 00       	call   398a <exit>
    ...
    exit();
    2220:	e8 65 17 00 00       	call   398a <exit>
    ...
    exit();
    2233:	e8 52 17 00 00       	call   398a <exit>
    ...
    exit();
    2246:	e8 3f 17 00 00       	call   398a <exit>
    ...
    exit();
    2259:	e8 2c 17 00 00       	call   398a <exit>
    ...
    exit();
    226c:	e8 19 17 00 00       	call   398a <exit>
    ...
    exit();
    227f:	e8 06 17 00 00       	call   398a <exit>
    ...
    exit();
    2292:	e8 f3 16 00 00       	call   398a <exit>
    ...
    exit();
    22a5:	e8 e0 16 00 00       	call   398a <exit>
    ...
    exit();
    22b8:	e8 cd 16 00 00       	call   398a <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    22bd:	50                   	push   %eax
    22be:	50                   	push   %eax
    ...
    exit();
    22cb:	e8 ba 16 00 00       	call   398a <exit>
    ...
    exit();
    22de:	e8 a7 16 00 00       	call   398a <exit>
    ...
    exit();
    22f1:	e8 94 16 00 00       	call   398a <exit>
    ...
    exit();
    2304:	e8 81 16 00 00       	call   398a <exit>
    ...
    exit();
    2317:	e8 6e 16 00 00       	call   398a <exit>
    ...
    exit();
    232a:	e8 5b 16 00 00       	call   398a <exit>
    ...
    exit();
    233d:	e8 48 16 00 00       	call   398a <exit>
    ...
    exit();
    2350:	e8 35 16 00 00       	call   398a <exit>
    ...
    exit();
    2363:	e8 22 16 00 00       	call   398a <exit>
    ...
    exit();
    2376:	e8 0f 16 00 00       	call   398a <exit>
    ...
    exit();
    2389:	e8 fc 15 00 00       	call   398a <exit>
    ...
    exit();
    239c:	e8 e9 15 00 00       	call   398a <exit>
    ...
    exit();
    23af:	e8 d6 15 00 00       	call   398a <exit>
    ...
    exit();
    23c2:	e8 c3 15 00 00       	call   398a <exit>
    ...
    exit();
    23d5:	e8 b0 15 00 00       	call   398a <exit>
    ...
    exit();
    23e8:	e8 9d 15 00 00       	call   398a <exit>
    ...
    exit();
    23fb:	e8 8a 15 00 00       	call   398a <exit>
...
00002400 <bigwrite>:
{
  ...
  unlink("bigwrite");
    ...
    2420:	e8 b5 15 00 00       	call   39da <unlink>
    ...
    243d:	e8 88 15 00 00       	call   39ca <open>
    if(fd < 0){
    ...
    2454:	50                   	push   %eax
    2455:	e8 50 15 00 00       	call   39aa <write>
      if(cc != sz){
    ...
    246a:	56                   	push   %esi
    246b:	e8 3a 15 00 00       	call   39aa <write>
      if(cc != sz){
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    close(fd);
    2480:	56                   	push   %esi
    2481:	e8 2c 15 00 00       	call   39b2 <close>
    unlink("bigwrite");
    2486:	c7 04 24 84 48 00 00 	movl   $0x4884,(%esp)
    248d:	e8 48 15 00 00       	call   39da <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
  ...
  printf(1, "bigwrite ok\n");
    ...
    24bf:	e8 2c 16 00 00       	call   3af0 <printf>
        exit();
    24c4:	e8 c1 14 00 00       	call   398a <exit>
    ...
    24d3:	e8 18 16 00 00       	call   3af0 <printf>
      exit();
    24d8:	e8 ad 14 00 00       	call   398a <exit>
...
000024e0 <bigfile>:
{
  ...
  unlink("bigfile");
    ...
    24fc:	e8 d9 14 00 00       	call   39da <unlink>
  fd = open("bigfile", O_CREATE | O_RDWR);
    2501:	58                   	pop    %eax
    2502:	5a                   	pop    %edx
    2503:	68 02 02 00 00       	push   $0x202
    2508:	68 e0 48 00 00       	push   $0x48e0
    250d:	e8 b8 14 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  for(i = 0; i < 20; i++){
    ...
    2548:	56                   	push   %esi
    2549:	e8 5c 14 00 00       	call   39aa <write>
  ...
  close(fd);
    ...
    2567:	56                   	push   %esi
    2568:	e8 45 14 00 00       	call   39b2 <close>
  fd = open("bigfile", 0);
    256d:	5e                   	pop    %esi
    256e:	5f                   	pop    %edi
    256f:	6a 00                	push   $0x0
    2571:	68 e0 48 00 00       	push   $0x48e0
    2576:	e8 4f 14 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    25cb:	56                   	push   %esi
    25cc:	e8 d1 13 00 00       	call   39a2 <read>
    if(cc < 0){
  ...
  close(fd);
    ...
    25dd:	56                   	push   %esi
    25de:	e8 cf 13 00 00       	call   39b2 <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    25fa:	e8 db 13 00 00       	call   39da <unlink>
  printf(1, "bigfile test ok\n");
    ...
    2622:	e8 c9 14 00 00       	call   3af0 <printf>
      exit();
    2627:	e8 5e 13 00 00       	call   398a <exit>
    ...
    2636:	e8 b5 14 00 00       	call   3af0 <printf>
      exit();
    263b:	e8 4a 13 00 00       	call   398a <exit>
    ...
    264a:	e8 a1 14 00 00       	call   3af0 <printf>
      exit();
    264f:	e8 36 13 00 00       	call   398a <exit>
    ...
    265e:	e8 8d 14 00 00       	call   3af0 <printf>
      exit();
    2663:	e8 22 13 00 00       	call   398a <exit>
    ...
    exit();
    2676:	e8 0f 13 00 00       	call   398a <exit>
    ...
    exit();
    2689:	e8 fc 12 00 00       	call   398a <exit>
    ...
    exit();
    269c:	e8 e9 12 00 00       	call   398a <exit>
...
000026b0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    26c9:	e8 24 13 00 00       	call   39f2 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    26e1:	e8 0c 13 00 00       	call   39f2 <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26fe:	e8 c7 12 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2711:	50                   	push   %eax
    2712:	e8 9b 12 00 00       	call   39b2 <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2717:	58                   	pop    %eax
    2718:	5a                   	pop    %edx
    2719:	6a 00                	push   $0x0
    271b:	68 38 52 00 00       	push   $0x5238
    2720:	e8 a5 12 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    272f:	50                   	push   %eax
    2730:	e8 7d 12 00 00       	call   39b2 <close>
  if(mkdir("12345678901234/12345678901234") == 0){
    2735:	c7 04 24 ac 49 00 00 	movl   $0x49ac,(%esp)
    273c:	e8 b1 12 00 00       	call   39f2 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2750:	e8 9d 12 00 00       	call   39f2 <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    exit();
    277e:	e8 07 12 00 00       	call   398a <exit>
    ...
    exit();
    2791:	e8 f4 11 00 00       	call   398a <exit>
    ...
    exit();
    27a4:	e8 e1 11 00 00       	call   398a <exit>
    ...
    exit();
    27b7:	e8 ce 11 00 00       	call   398a <exit>
    ...
    exit();
    27ca:	e8 bb 11 00 00       	call   398a <exit>
    ...
    exit();
    27dd:	e8 a8 11 00 00       	call   398a <exit>
...
000027f0 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    2809:	e8 e4 11 00 00       	call   39f2 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2821:	e8 d4 11 00 00       	call   39fa <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2839:	e8 9c 11 00 00       	call   39da <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2851:	e8 84 11 00 00       	call   39da <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2869:	e8 8c 11 00 00       	call   39fa <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2881:	e8 54 11 00 00       	call   39da <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2895:	e8 40 11 00 00       	call   39da <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    28a9:	e8 2c 11 00 00       	call   39da <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    exit();
    28d7:	e8 ae 10 00 00       	call   398a <exit>
    ...
    exit();
    28ea:	e8 9b 10 00 00       	call   398a <exit>
    ...
    exit();
    28fd:	e8 88 10 00 00       	call   398a <exit>
    printf(1, "unlink dots/. worked!\n");
    2902:	51                   	push   %ecx
    2903:	51                   	push   %ecx
    ...
    exit();
    2910:	e8 75 10 00 00       	call   398a <exit>
    printf(1, "chdir / failed\n");
    2915:	50                   	push   %eax
    2916:	50                   	push   %eax
    ...
    exit();
    2923:	e8 62 10 00 00       	call   398a <exit>
    printf(1, "rm .. worked!\n");
    2928:	50                   	push   %eax
    2929:	50                   	push   %eax
    ...
    exit();
    2936:	e8 4f 10 00 00       	call   398a <exit>
    printf(1, "rm . worked!\n");
    293b:	50                   	push   %eax
    293c:	50                   	push   %eax
    ...
    exit();
    2949:	e8 3c 10 00 00       	call   398a <exit>
    ...
    exit();
    295c:	e8 29 10 00 00       	call   398a <exit>
...
00002970 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    298f:	e8 36 10 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    29a2:	50                   	push   %eax
    29a3:	e8 0a 10 00 00       	call   39b2 <close>
  if(chdir("dirfile") == 0){
    29a8:	c7 04 24 95 4a 00 00 	movl   $0x4a95,(%esp)
    29af:	e8 46 10 00 00       	call   39fa <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    29c9:	e8 fc 0f 00 00       	call   39ca <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    29e6:	e8 df 0f 00 00       	call   39ca <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    29fe:	e8 ef 0f 00 00       	call   39f2 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2a16:	e8 bf 0f 00 00       	call   39da <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2a33:	e8 b2 0f 00 00       	call   39ea <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2a4b:	e8 8a 0f 00 00       	call   39da <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    2a65:	e8 60 0f 00 00       	call   39ca <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2a7f:	e8 46 0f 00 00       	call   39ca <open>
  if(write(fd, "x", 1) > 0){
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2a90:	50                   	push   %eax
    2a91:	e8 14 0f 00 00       	call   39aa <write>
  ...
  close(fd);
    ...
    2aa0:	53                   	push   %ebx
    2aa1:	e8 0c 0f 00 00       	call   39b2 <close>
  printf(1, "dir vs file OK\n");
    ...
    exit();
    2aca:	e8 bb 0e 00 00       	call   398a <exit>
    ...
    exit();
    2add:	e8 a8 0e 00 00       	call   398a <exit>
    ...
    exit();
    2af0:	e8 95 0e 00 00       	call   398a <exit>
    ...
    exit();
    2b03:	e8 82 0e 00 00       	call   398a <exit>
    ...
    exit();
    2b16:	e8 6f 0e 00 00       	call   398a <exit>
    ...
    exit();
    2b29:	e8 5c 0e 00 00       	call   398a <exit>
    ...
    exit();
    2b3c:	e8 49 0e 00 00       	call   398a <exit>
    ...
    exit();
    2b4f:	e8 36 0e 00 00       	call   398a <exit>
    ...
    exit();
    2b62:	e8 23 0e 00 00       	call   398a <exit>
    ...
    2b74:	bb 33 00 00 00       	mov    $0x33,%ebx
{
  ...
  printf(1, "empty file name\n");
    ...
    2b98:	e8 55 0e 00 00       	call   39f2 <mkdir>
    ...
    2bb0:	e8 45 0e 00 00       	call   39fa <chdir>
    ...
    2c1e:	50                   	push   %eax
    2c1f:	e8 8e 0d 00 00       	call   39b2 <close>
    2c24:	83 c4 10             	add    $0x10,%esp
    unlink("xx");
    2c27:	83 ec 0c             	sub    $0xc,%esp
    2c2a:	68 70 47 00 00       	push   $0x4770
    2c2f:	e8 a6 0d 00 00       	call   39da <unlink>
  for(i = 0; i < 50 + 1; i++){
  ...
  chdir("/");
    ...
    2c48:	e8 ad 0d 00 00       	call   39fa <chdir>
  printf(1, "empty file name OK\n");
    ...
    2c6d:	e8 7e 0e 00 00       	call   3af0 <printf>
      exit();
    2c72:	e8 13 0d 00 00       	call   398a <exit>
    ...
    2c81:	e8 6a 0e 00 00       	call   3af0 <printf>
      exit();
    2c86:	e8 ff 0c 00 00       	call   398a <exit>
    ...
    2c94:	31 db                	xor    %ebx,%ebx
{
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2cbd:	e8 c0 0c 00 00       	call   3982 <fork>
    if(pid < 0)
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2cd0:	e8 bd 0c 00 00       	call   3992 <wait>
  ...
  if(wait() != -1){
    2cde:	e8 af 0c 00 00       	call   3992 <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2cfb:	c3                   	ret    
      exit();
    2cfc:	e8 89 0c 00 00       	call   398a <exit>
    ...
    2d0b:	e8 e0 0d 00 00       	call   3af0 <printf>
      exit();
    2d10:	e8 75 0c 00 00       	call   398a <exit>
    ...
    exit();
    2d23:	e8 62 0c 00 00       	call   398a <exit>
    ...
    exit();
    2d36:	e8 4f 0c 00 00       	call   398a <exit>
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  for(i = 0; i < 5000; i++){
    ...
    2d85:	6a 01                	push   $0x1
    2d87:	e8 86 0c 00 00       	call   3a12 <sbrk>
    if(b != a){
  ...
  pid = fork();
    2da8:	e8 d5 0b 00 00       	call   3982 <fork>
  ...
  c = sbrk(1);
    2dbd:	6a 01                	push   $0x1
    2dbf:	e8 4e 0c 00 00       	call   3a12 <sbrk>
  c = sbrk(1);
    2dc4:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2dcb:	e8 42 0c 00 00       	call   3a12 <sbrk>
  if(c != a + 1){
  ...
  wait();
    2de3:	e8 aa 0b 00 00       	call   3992 <wait>
  a = sbrk(0);
    2de8:	83 ec 0c             	sub    $0xc,%esp
    2deb:	6a 00                	push   $0x0
    2ded:	e8 20 0c 00 00       	call   3a12 <sbrk>
  ...
  p = sbrk(amt);
    ...
    2dfe:	e8 0f 0c 00 00       	call   3a12 <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2e11:	6a 00                	push   $0x0
    2e13:	e8 fa 0b 00 00       	call   3a12 <sbrk>
  c = sbrk(-4096);
    2e18:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2e1f:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2e21:	e8 ec 0b 00 00       	call   3a12 <sbrk>
  ...
  c = sbrk(0);
    ...
    2e35:	6a 00                	push   $0x0
    2e37:	e8 d6 0b 00 00       	call   3a12 <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2e50:	6a 00                	push   $0x0
    2e52:	e8 bb 0b 00 00       	call   3a12 <sbrk>
  c = sbrk(4096);
    2e57:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2e5e:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2e60:	e8 ad 0b 00 00       	call   3a12 <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2e75:	6a 00                	push   $0x0
    2e77:	e8 96 0b 00 00       	call   3a12 <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2ed8:	e8 2d 0b 00 00       	call   3a0a <getpid>
    2edd:	89 c6                	mov    %eax,%esi
    pid = fork();
    2edf:	e8 9e 0a 00 00       	call   3982 <fork>
    if(pid < 0){
    ...
    wait();
    2ef2:	e8 9b 0a 00 00       	call   3992 <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
  ...
  if(pipe(fds) != 0){
    ...
    2f0b:	50                   	push   %eax
    2f0c:	e8 89 0a 00 00       	call   399a <pipe>
    ...
    if((pids[i] = fork()) == 0){
    2f28:	e8 55 0a 00 00       	call   3982 <fork>
    ...
    2f48:	e8 55 0a 00 00       	call   39a2 <read>
  ...
  c = sbrk(4096);
    ...
    2f5f:	e8 ae 0a 00 00       	call   3a12 <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f7a:	50                   	push   %eax
    2f7b:	e8 3a 0a 00 00       	call   39ba <kill>
    wait();
    2f80:	e8 0d 0a 00 00       	call   3992 <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f9b:	6a 00                	push   $0x0
    2f9d:	e8 70 0a 00 00       	call   3a12 <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fb2:	ff 35 cc 5f 00 00    	push   0x5fcc
    ...
    exit();
    310c:	e8 79 08 00 00       	call   398a <exit>
    exit();
    3111:	e8 74 08 00 00       	call   398a <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    3116:	57                   	push   %edi
    3117:	57                   	push   %edi
    3118:	68 45 4c 00 00       	push   $0x4c45
    311d:	ff 35 cc 5f 00 00    	push   0x5fcc
    3123:	e8 c8 09 00 00       	call   3af0 <printf>
    exit();
    3128:	e8 5d 08 00 00       	call   398a <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 04 54 00 00       	push   $0x5404
    3134:	ff 35 cc 5f 00 00    	push   0x5fcc
    313a:	e8 b1 09 00 00       	call   3af0 <printf>
    exit();
    313f:	e8 46 08 00 00       	call   398a <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 cc 53 00 00       	push   $0x53cc
    314b:	ff 35 cc 5f 00 00    	push   0x5fcc
    3151:	e8 9a 09 00 00       	call   3af0 <printf>
    exit();
    3156:	e8 2f 08 00 00       	call   398a <exit>
    printf(stdout, "sbrk could not deallocate\n");
    315b:	53                   	push   %ebx
    315c:	53                   	push   %ebx
    315d:	68 61 4c 00 00       	push   $0x4c61
    3162:	ff 35 cc 5f 00 00    	push   0x5fcc
    3168:	e8 83 09 00 00       	call   3af0 <printf>
    exit();
    316d:	e8 18 08 00 00       	call   398a <exit>
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    31be:	6a 00                	push   $0x0
    31c0:	e8 55 08 00 00       	call   3a1a <sleep>
    sleep(0);
    31c5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    31cc:	e8 49 08 00 00       	call   3a1a <sleep>
    kill(pid);
    31d1:	89 1c 24             	mov    %ebx,(%esp)
    31d4:	e8 e1 07 00 00       	call   39ba <kill>
    wait();
    31d9:	e8 b4 07 00 00       	call   3992 <wait>
    if(link("nosuchfile", (char*)p) != -1){
    31de:	58                   	pop    %eax
    31df:	5a                   	pop    %edx
    31e0:	56                   	push   %esi
    31e1:	68 cd 4c 00 00       	push   $0x4ccd
    31e6:	e8 ff 07 00 00       	call   39ea <link>
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 cc 5f 00 00    	push   0x5fcc
    ...
    321d:	c3                   	ret    
      exit();
    321e:	e8 67 07 00 00       	call   398a <exit>
      printf(stdout, "link should not succeed\n");
    3223:	83 ec 08             	sub    $0x8,%esp
    3226:	68 d8 4c 00 00       	push   $0x4cd8
    322b:	ff 35 cc 5f 00 00    	push   0x5fcc
    3231:	e8 ba 08 00 00       	call   3af0 <printf>
      exit();
    3236:	e8 4f 07 00 00       	call   398a <exit>
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 cc 5f 00 00    	push   0x5fcc
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 cc 5f 00 00    	push   0x5fcc
    ...
    3293:	ff 35 cc 5f 00 00    	push   0x5fcc
    3299:	e8 52 08 00 00       	call   3af0 <printf>
      exit();
    329e:	e8 e7 06 00 00       	call   398a <exit>
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    32bb:	e8 1a 07 00 00       	call   39da <unlink>
  pid = fork();
    32c0:	e8 bd 06 00 00       	call   3982 <fork>
  if(pid == 0){
  ...
  wait();
    32d2:	e8 bb 06 00 00       	call   3992 <wait>
  fd = open("bigarg-ok", 0);
    32d7:	83 ec 08             	sub    $0x8,%esp
    32da:	6a 00                	push   $0x0
    32dc:	68 26 4d 00 00       	push   $0x4d26
    32e1:	e8 e4 06 00 00       	call   39ca <open>
  if(fd < 0){
  ...
  unlink("bigarg-ok");
    ...
    3301:	e8 d4 06 00 00       	call   39da <unlink>
}
    ...
    3310:	c7 04 85 20 a7 00 00 	movl   $0x5480,0xa720(,%eax,4)
    3317:	80 54 00 00 
    ...
    332a:	ff 35 cc 5f 00 00    	push   0x5fcc
    args[MAXARG-1] = 0;
    ...
    334b:	e8 72 06 00 00       	call   39c2 <exec>
    printf(stdout, "bigarg test ok\n");
    3350:	59                   	pop    %ecx
    3351:	58                   	pop    %eax
    3352:	68 3d 4d 00 00       	push   $0x4d3d
    3357:	ff 35 cc 5f 00 00    	push   0x5fcc
    ...
    336e:	e8 57 06 00 00       	call   39ca <open>
    close(fd);
    3373:	89 04 24             	mov    %eax,(%esp)
    3376:	e8 37 06 00 00       	call   39b2 <close>
    exit();
    337b:	e8 0a 06 00 00       	call   398a <exit>
    printf(stdout, "bigarg test failed!\n");
    3380:	50                   	push   %eax
    3381:	50                   	push   %eax
    3382:	68 66 4d 00 00       	push   $0x4d66
    3387:	ff 35 cc 5f 00 00    	push   0x5fcc
    338d:	e8 5e 07 00 00       	call   3af0 <printf>
    exit();
    3392:	e8 f3 05 00 00       	call   398a <exit>
    printf(stdout, "bigargtest: fork failed\n");
    3397:	52                   	push   %edx
    3398:	52                   	push   %edx
    3399:	68 4d 4d 00 00       	push   $0x4d4d
    339e:	ff 35 cc 5f 00 00    	push   0x5fcc
    33a4:	e8 47 07 00 00       	call   3af0 <printf>
    exit();
    33a9:	e8 dc 05 00 00       	call   398a <exit>
    ...
    33b5:	31 f6                	xor    %esi,%esi
{
  ...
  printf(1, "fsfull test\n");
    ...
    3458:	50                   	push   %eax
    3459:	e8 6c 05 00 00       	call   39ca <open>
    if(fd < 0){
    ...
    347f:	57                   	push   %edi
    3480:	e8 25 05 00 00       	call   39aa <write>
      if(cc < 512)
    ...
    34a2:	e8 0b 05 00 00       	call   39b2 <close>
    if(total == 0)
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    354b:	50                   	push   %eax
    354c:	e8 89 04 00 00       	call   39da <unlink>
  while(nfiles >= 0){
...
00003580 <uio>:
{
  ...
  pid = fork();
    3592:	e8 eb 03 00 00       	call   3982 <fork>
  if(pid == 0){
  ...
  wait();
    35a0:	e8 ed 03 00 00       	call   3992 <wait>
  printf(1, "uio test done\n");
    ...
    exit();
    35d8:	e8 ad 03 00 00       	call   398a <exit>
    printf (1, "fork failed\n");
    35dd:	50                   	push   %eax
    35de:	50                   	push   %eax
    ...
    exit();
    35eb:	e8 9a 03 00 00       	call   398a <exit>
...
000035f0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    35fe:	e8 c7 03 00 00       	call   39ca <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    360f:	6a 00                	push   $0x0
    3611:	e8 fc 03 00 00       	call   3a12 <sbrk>
    3616:	83 c4 0c             	add    $0xc,%esp
    3619:	83 e8 01             	sub    $0x1,%eax
    361c:	6a ff                	push   $0xffffffff
    361e:	50                   	push   %eax
    361f:	53                   	push   %ebx
    3620:	e8 7d 03 00 00       	call   39a2 <read>
  close(fd);
    3625:	89 1c 24             	mov    %ebx,(%esp)
    3628:	e8 85 03 00 00       	call   39b2 <close>
  printf(1, "arg test passed\n");
    ...
    exit();
    3651:	e8 34 03 00 00       	call   398a <exit>
    ...
    37a9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    37b5:	57                   	push   %edi
    37b6:	6a 00                	push   $0x0
    37b8:	e8 e5 01 00 00       	call   39a2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    381d:	e8 a8 01 00 00       	call   39ca <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3831:	50                   	push   %eax
    3832:	e8 ab 01 00 00       	call   39e2 <fstat>
  close(fd);
    3837:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
    383a:	89 c6                	mov    %eax,%esi
  close(fd);
    383c:	e8 71 01 00 00       	call   39b2 <close>
  return r;
...
int TestAndSet(int *oldpointer, int new){
  ...
  int old = *oldpointer;
  *oldpointer = new;
    38d6:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  int old = *oldpointer;
    38d9:	8b 10                	mov    (%eax),%edx
  *oldpointer = new;
    38db:	89 08                	mov    %ecx,(%eax)
  return old;
}
    38dd:	5d                   	pop    %ebp
...
lock_acquire(lock_t *lock){
  ...
  while(TestAndSet(&lock->flag, 1)==1)
    3906:	83 38 01             	cmpl   $0x1,(%eax)
    3909:	75 05                	jne    3910 <lock_acquire+0x10>
    390b:	eb fe                	jmp    390b <lock_acquire+0xb>
    390d:	8d 76 00             	lea    0x0(%esi),%esi
    3910:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
    3916:	5d                   	pop    %ebp
    3917:	c3                   	ret    
...
00003930 <thread_create>:
int 
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
    3930:	55                   	push   %ebp
    3931:	89 e5                	mov    %esp,%ebp
    3933:	83 ec 14             	sub    $0x14,%esp
    void *stack;
    stack = malloc(PGSIZE);
    3936:	68 00 10 00 00       	push   $0x1000
    393b:	e8 e0 03 00 00       	call   3d20 <malloc>
    return clone(start_routine, arg1, arg2, stack);
    3940:	50                   	push   %eax
    3941:	ff 75 10             	push   0x10(%ebp)
    3944:	ff 75 0c             	push   0xc(%ebp)
    3947:	ff 75 08             	push   0x8(%ebp)
    394a:	e8 db 00 00 00       	call   3a2a <clone>
}
    394f:	c9                   	leave  
    3950:	c3                   	ret    
...
thread_join(){
  ...
  int waitedForPID = join(&stack);
    3964:	8d 45 f4             	lea    -0xc(%ebp),%eax
thread_join(){
    3967:	83 ec 20             	sub    $0x20,%esp
  int waitedForPID = join(&stack);
    396a:	50                   	push   %eax
    396b:	e8 c2 00 00 00       	call   3a32 <join>
    3970:	89 c3                	mov    %eax,%ebx
  free(stack);
    3972:	58                   	pop    %eax
    3973:	ff 75 f4             	push   -0xc(%ebp)
    3976:	e8 15 03 00 00       	call   3c90 <free>
  return waitedForPID;
...
SYSCALL(fork)
    3982:	b8 01 00 00 00       	mov    $0x1,%eax
    3987:	cd 40                	int    $0x40
    3989:	c3                   	ret    

0000398a <exit>:
SYSCALL(exit)
    398a:	b8 02 00 00 00       	mov    $0x2,%eax
    398f:	cd 40                	int    $0x40
    3991:	c3                   	ret    

00003992 <wait>:
SYSCALL(wait)
    3992:	b8 03 00 00 00       	mov    $0x3,%eax
    3997:	cd 40                	int    $0x40
    3999:	c3                   	ret    

0000399a <pipe>:
SYSCALL(pipe)
    399a:	b8 04 00 00 00       	mov    $0x4,%eax
    399f:	cd 40                	int    $0x40
    39a1:	c3                   	ret    

000039a2 <read>:
SYSCALL(read)
    39a2:	b8 05 00 00 00       	mov    $0x5,%eax
    39a7:	cd 40                	int    $0x40
    39a9:	c3                   	ret    

000039aa <write>:
SYSCALL(write)
    39aa:	b8 10 00 00 00       	mov    $0x10,%eax
    39af:	cd 40                	int    $0x40
    39b1:	c3                   	ret    
...
000039ba <kill>:
SYSCALL(kill)
    39ba:	b8 06 00 00 00       	mov    $0x6,%eax
    39bf:	cd 40                	int    $0x40
    39c1:	c3                   	ret    

000039c2 <exec>:
SYSCALL(exec)
    39c2:	b8 07 00 00 00       	mov    $0x7,%eax
    39c7:	cd 40                	int    $0x40
    39c9:	c3                   	ret    

000039ca <open>:
SYSCALL(open)
    39ca:	b8 0f 00 00 00       	mov    $0xf,%eax
    39cf:	cd 40                	int    $0x40
    39d1:	c3                   	ret    

000039d2 <mknod>:
SYSCALL(mknod)
    39d2:	b8 11 00 00 00       	mov    $0x11,%eax
    39d7:	cd 40                	int    $0x40
    39d9:	c3                   	ret    

000039da <unlink>:
SYSCALL(unlink)
    39da:	b8 12 00 00 00       	mov    $0x12,%eax
    39df:	cd 40                	int    $0x40
    39e1:	c3                   	ret    

000039e2 <fstat>:
SYSCALL(fstat)
    39e2:	b8 08 00 00 00       	mov    $0x8,%eax
    39e7:	cd 40                	int    $0x40
    39e9:	c3                   	ret    

000039ea <link>:
SYSCALL(link)
    39ea:	b8 13 00 00 00       	mov    $0x13,%eax
    39ef:	cd 40                	int    $0x40
    39f1:	c3                   	ret    

000039f2 <mkdir>:
SYSCALL(mkdir)
    39f2:	b8 14 00 00 00       	mov    $0x14,%eax
    39f7:	cd 40                	int    $0x40
    39f9:	c3                   	ret    

000039fa <chdir>:
SYSCALL(chdir)
    39fa:	b8 09 00 00 00       	mov    $0x9,%eax
    39ff:	cd 40                	int    $0x40
    3a01:	c3                   	ret    

00003a02 <dup>:
SYSCALL(dup)
    3a02:	b8 0a 00 00 00       	mov    $0xa,%eax
    3a07:	cd 40                	int    $0x40
    3a09:	c3                   	ret    

00003a0a <getpid>:
SYSCALL(getpid)
    3a0a:	b8 0b 00 00 00       	mov    $0xb,%eax
    3a0f:	cd 40                	int    $0x40
    3a11:	c3                   	ret    

00003a12 <sbrk>:
SYSCALL(sbrk)
    3a12:	b8 0c 00 00 00       	mov    $0xc,%eax
    3a17:	cd 40                	int    $0x40
    3a19:	c3                   	ret    

00003a1a <sleep>:
SYSCALL(sleep)
    3a1a:	b8 0d 00 00 00       	mov    $0xd,%eax
    3a1f:	cd 40                	int    $0x40
    3a21:	c3                   	ret    

00003a22 <uptime>:
SYSCALL(uptime)
    3a22:	b8 0e 00 00 00       	mov    $0xe,%eax
    3a27:	cd 40                	int    $0x40
    3a29:	c3                   	ret    

00003a2a <clone>:
SYSCALL(clone)
    3a2a:	b8 16 00 00 00       	mov    $0x16,%eax
    3a2f:	cd 40                	int    $0x40
    3a31:	c3                   	ret    

00003a32 <join>:
SYSCALL(join)
    3a32:	b8 17 00 00 00       	mov    $0x17,%eax
    3a37:	cd 40                	int    $0x40
    3a39:	c3                   	ret    
    ...
    3a4c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    3abe:	56                   	push   %esi
    3abf:	57                   	push   %edi
    3ac0:	e8 e5 fe ff ff       	call   39aa <write>
  while(--i >= 0)
    ...
    3af9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    3b35:	57                   	push   %edi
    3b36:	56                   	push   %esi
    3b37:	e8 6e fe ff ff       	call   39aa <write>
  ...
  write(fd, &c, 1);
    ...
    3b8e:	e8 17 fe ff ff       	call   39aa <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3b9f:	57                   	push   %edi
    3ba0:	56                   	push   %esi
    3ba1:	e8 04 fe ff ff       	call   39aa <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    3c0b:	57                   	push   %edi
    3c0c:	56                   	push   %esi
    3c0d:	e8 98 fd ff ff       	call   39aa <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    3c4f:	e8 56 fd ff ff       	call   39aa <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3c91:	a1 a0 a7 00 00       	mov    0xa7a0,%eax
{
  ...
  freep = p;
    ...
    3cd1:	5b                   	pop    %ebx
  freep = p;
    3cd2:	89 15 a0 a7 00 00    	mov    %edx,0xa7a0
}
    3cd8:	5e                   	pop    %esi
    3cd9:	5f                   	pop    %edi
    3cda:	5d                   	pop    %ebp
  ...
  freep = p;
    3d0c:	89 15 a0 a7 00 00    	mov    %edx,0xa7a0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    3d2c:	8b 3d a0 a7 00 00    	mov    0xa7a0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    3d71:	8b 3d a0 a7 00 00    	mov    0xa7a0,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3d83:	e8 8a fc ff ff       	call   3a12 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    3d9f:	8b 15 a0 a7 00 00    	mov    0xa7a0,%edx
    ...
    3dcc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    3dcf:	89 15 a0 a7 00 00    	mov    %edx,0xa7a0
}
    ...
    3ddf:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    3de0:	c7 05 a0 a7 00 00 a4 	movl   $0xa7a4,0xa7a0
    3de7:	a7 00 00 
    base.s.size = 0;
    3dea:	bf a4 a7 00 00       	mov    $0xa7a4,%edi
    base.s.ptr = freep = prevp = &base;
    3def:	c7 05 a4 a7 00 00 a4 	movl   $0xa7a4,0xa7a4
    3df6:	a7 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3df9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    3dfb:	c7 05 a8 a7 00 00 00 	movl   $0x0,0xa7a8
    3e02:	00 00 00 
    if(p->s.size >= nunits){
