...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
      ...
      11:	e8 05 39 00 00       	call   391b <printf>

  if(mkdir("iputdir") < 0){
      16:	c7 04 24 ef 3b 00 00 	movl   $0x3bef,(%esp)
      1d:	e8 0c 38 00 00       	call   382e <mkdir>
  ...
  if(chdir("iputdir") < 0){
      ...
      31:	e8 00 38 00 00       	call   3836 <chdir>
  ...
  if(unlink("../iputdir") < 0){
      ...
      45:	e8 cc 37 00 00       	call   3816 <unlink>
  ...
  if(chdir("/") < 0){
      ...
      59:	e8 d8 37 00 00       	call   3836 <chdir>
  ...
  printf(stdout, "iput test ok\n");
      ...
      73:	e8 a3 38 00 00       	call   391b <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
      ...
      8b:	e8 8b 38 00 00       	call   391b <printf>
    exit();
      90:	e8 31 37 00 00       	call   37c6 <exit>
    printf(stdout, "chdir iputdir failed\n");
      95:	83 ec 08             	sub    $0x8,%esp
      98:	68 d6 3b 00 00       	push   $0x3bd6
      9d:	ff 35 18 5d 00 00    	push   0x5d18
      a3:	e8 73 38 00 00       	call   391b <printf>
    exit();
      a8:	e8 19 37 00 00       	call   37c6 <exit>
    printf(stdout, "unlink ../iputdir failed\n");
      ad:	83 ec 08             	sub    $0x8,%esp
      b0:	68 f7 3b 00 00       	push   $0x3bf7
      b5:	ff 35 18 5d 00 00    	push   0x5d18
      bb:	e8 5b 38 00 00       	call   391b <printf>
    exit();
      c0:	e8 01 37 00 00       	call   37c6 <exit>
    printf(stdout, "chdir / failed\n");
      c5:	83 ec 08             	sub    $0x8,%esp
      c8:	68 13 3c 00 00       	push   $0x3c13
      cd:	ff 35 18 5d 00 00    	push   0x5d18
      d3:	e8 43 38 00 00       	call   391b <printf>
    exit();
      d8:	e8 e9 36 00 00       	call   37c6 <exit>
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
      ...
      ee:	e8 28 38 00 00       	call   391b <printf>

  pid = fork();
      f3:	e8 c6 36 00 00       	call   37be <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     10d:	e8 1c 37 00 00       	call   382e <mkdir>
    ...
    if(chdir("iputdir") < 0){
     ...
     121:	e8 10 37 00 00       	call   3836 <chdir>
    ...
    if(unlink("../iputdir") < 0){
     ...
     135:	e8 dc 36 00 00       	call   3816 <unlink>
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     1d4:	e8 42 37 00 00       	call   391b <printf>
  if(mkdir("oidir") < 0){
     1d9:	c7 04 24 67 3c 00 00 	movl   $0x3c67,(%esp)
     1e0:	e8 49 36 00 00       	call   382e <mkdir>
  ...
  pid = fork();
     1ec:	e8 cd 35 00 00       	call   37be <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    int fd = open("oidir", O_RDWR);
     ...
     201:	e8 00 36 00 00       	call   3806 <open>
    if(fd >= 0){
     ...
     21b:	e8 fb 36 00 00       	call   391b <printf>
      exit();
     220:	e8 a1 35 00 00       	call   37c6 <exit>
    printf(stdout, "mkdir oidir failed\n");
     225:	83 ec 08             	sub    $0x8,%esp
     228:	68 6d 3c 00 00       	push   $0x3c6d
     22d:	ff 35 18 5d 00 00    	push   0x5d18
     233:	e8 e3 36 00 00       	call   391b <printf>
    exit();
     238:	e8 89 35 00 00       	call   37c6 <exit>
    printf(stdout, "fork failed\n");
     23d:	83 ec 08             	sub    $0x8,%esp
     240:	68 09 4b 00 00       	push   $0x4b09
     245:	ff 35 18 5d 00 00    	push   0x5d18
     24b:	e8 cb 36 00 00       	call   391b <printf>
    exit();
     250:	e8 71 35 00 00       	call   37c6 <exit>
    }
    exit();
     255:	e8 6c 35 00 00       	call   37c6 <exit>
  }
  sleep(1);
     25a:	83 ec 0c             	sub    $0xc,%esp
     25d:	6a 01                	push   $0x1
     25f:	e8 f2 35 00 00       	call   3856 <sleep>
  if(unlink("oidir") != 0){
     264:	c7 04 24 67 3c 00 00 	movl   $0x3c67,(%esp)
     26b:	e8 a6 35 00 00       	call   3816 <unlink>
  ...
  printf(stdout, "openiput test ok\n");
    ...
    printf(stdout, "unlink failed\n");
     ...
     2a2:	e8 74 36 00 00       	call   391b <printf>
    exit();
     2a7:	e8 1a 35 00 00       	call   37c6 <exit>
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     2bd:	e8 59 36 00 00       	call   391b <printf>
  fd = open("echo", 0);
     2c2:	83 c4 08             	add    $0x8,%esp
     2c5:	6a 00                	push   $0x0
     2c7:	68 ad 3c 00 00       	push   $0x3cad
     2cc:	e8 35 35 00 00       	call   3806 <open>
  if(fd < 0){
  ...
  close(fd);
     ...
     2db:	50                   	push   %eax
     2dc:	e8 0d 35 00 00       	call   37ee <close>
  fd = open("doesnotexist", 0);
     2e1:	83 c4 08             	add    $0x8,%esp
     2e4:	6a 00                	push   $0x0
     2e6:	68 c5 3c 00 00       	push   $0x3cc5
     2eb:	e8 16 35 00 00       	call   3806 <open>
  if(fd >= 0){
  ...
  printf(stdout, "open test ok\n");
     ...
     305:	e8 11 36 00 00       	call   391b <printf>
}
    ...
    printf(stdout, "open echo failed!\n");
     ...
     31d:	e8 f9 35 00 00       	call   391b <printf>
    exit();
     322:	e8 9f 34 00 00       	call   37c6 <exit>
    printf(stdout, "open doesnotexist succeeded!\n");
     327:	83 ec 08             	sub    $0x8,%esp
     32a:	68 d2 3c 00 00       	push   $0x3cd2
     32f:	ff 35 18 5d 00 00    	push   0x5d18
     335:	e8 e1 35 00 00       	call   391b <printf>
    exit();
     33a:	e8 87 34 00 00       	call   37c6 <exit>
...
writetest(void)
{
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     380:	e8 96 35 00 00       	call   391b <printf>
  } else {
  ...
  for(i = 0; i < 100; i++){
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     39c:	56                   	push   %esi
     39d:	e8 44 34 00 00       	call   37e6 <write>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     3b4:	56                   	push   %esi
     3b5:	e8 2c 34 00 00       	call   37e6 <write>
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     3d5:	e8 41 35 00 00       	call   391b <printf>
    exit();
     3da:	e8 e7 33 00 00       	call   37c6 <exit>
      printf(stdout, "error: write aa %d new file failed\n", i);
     3df:	83 ec 04             	sub    $0x4,%esp
     3e2:	53                   	push   %ebx
     3e3:	68 10 4c 00 00       	push   $0x4c10
     3e8:	ff 35 18 5d 00 00    	push   0x5d18
     3ee:	e8 28 35 00 00       	call   391b <printf>
      exit();
     3f3:	e8 ce 33 00 00       	call   37c6 <exit>
      printf(stdout, "error: write bb %d new file failed\n", i);
     3f8:	83 ec 04             	sub    $0x4,%esp
     3fb:	53                   	push   %ebx
     3fc:	68 34 4c 00 00       	push   $0x4c34
     401:	ff 35 18 5d 00 00    	push   0x5d18
     407:	e8 0f 35 00 00       	call   391b <printf>
      exit();
     40c:	e8 b5 33 00 00       	call   37c6 <exit>
    }
  }
  printf(stdout, "writes ok\n");
     ...
     41f:	e8 f7 34 00 00       	call   391b <printf>
  close(fd);
     424:	89 34 24             	mov    %esi,(%esp)
     427:	e8 c2 33 00 00       	call   37ee <close>
  fd = open("small", O_RDONLY);
     42c:	83 c4 08             	add    $0x8,%esp
     42f:	6a 00                	push   $0x0
     431:	68 0f 3d 00 00       	push   $0x3d0f
     436:	e8 cb 33 00 00       	call   3806 <open>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     452:	e8 c4 34 00 00       	call   391b <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
     ...
     464:	53                   	push   %ebx
     465:	e8 74 33 00 00       	call   37de <read>
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     482:	e8 94 34 00 00       	call   391b <printf>
  } else {
  ...
  close(fd);
     ...
     48a:	e8 5f 33 00 00       	call   37ee <close>

  if(unlink("small") < 0){
     48f:	c7 04 24 0f 3d 00 00 	movl   $0x3d0f,(%esp)
     496:	e8 7b 33 00 00       	call   3816 <unlink>
  ...
  printf(stdout, "small file test ok\n");
     ...
     4b0:	e8 66 34 00 00       	call   391b <printf>
}
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     4cd:	e8 49 34 00 00       	call   391b <printf>
    exit();
     4d2:	e8 ef 32 00 00       	call   37c6 <exit>
    printf(stdout, "read failed\n");
     4d7:	83 ec 08             	sub    $0x8,%esp
     4da:	68 cd 40 00 00       	push   $0x40cd
     4df:	ff 35 18 5d 00 00    	push   0x5d18
     4e5:	e8 31 34 00 00       	call   391b <printf>
    exit();
     4ea:	e8 d7 32 00 00       	call   37c6 <exit>
    printf(stdout, "unlink small failed\n");
     4ef:	83 ec 08             	sub    $0x8,%esp
     4f2:	68 b4 3d 00 00       	push   $0x3db4
     4f7:	ff 35 18 5d 00 00    	push   0x5d18
     4fd:	e8 19 34 00 00       	call   391b <printf>
    exit();
     502:	e8 bf 32 00 00       	call   37c6 <exit>
...
writetest1(void)
{
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     55a:	56                   	push   %esi
     55b:	e8 86 32 00 00       	call   37e6 <write>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     57d:	e8 99 33 00 00       	call   391b <printf>
    exit();
     582:	e8 3f 32 00 00       	call   37c6 <exit>
      printf(stdout, "error: write big file failed\n", i);
     587:	83 ec 04             	sub    $0x4,%esp
     58a:	53                   	push   %ebx
     58b:	68 07 3e 00 00       	push   $0x3e07
     590:	ff 35 18 5d 00 00    	push   0x5d18
     596:	e8 80 33 00 00       	call   391b <printf>
      exit();
     59b:	e8 26 32 00 00       	call   37c6 <exit>
    }
  }
  ...
  close(fd);
     ...
     5a3:	56                   	push   %esi
     5a4:	e8 45 32 00 00       	call   37ee <close>

  fd = open("big", O_RDONLY);
     5a9:	83 c4 08             	add    $0x8,%esp
     5ac:	6a 00                	push   $0x0
     5ae:	68 57 3e 00 00       	push   $0x3e57
     5b3:	e8 4e 32 00 00       	call   3806 <open>
  ...
  for(;;){
    i = read(fd, buf, 512);
     ...
     5d3:	56                   	push   %esi
     5d4:	e8 05 32 00 00       	call   37de <read>
    if(i == 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     60b:	e8 0b 33 00 00       	call   391b <printf>
    exit();
     610:	e8 b1 31 00 00       	call   37c6 <exit>
      if(n == MAXFILE - 1){
  ...
  close(fd);
     ...
     620:	56                   	push   %esi
     621:	e8 c8 31 00 00       	call   37ee <close>
  if(unlink("big") < 0){
     626:	c7 04 24 57 3e 00 00 	movl   $0x3e57,(%esp)
     62d:	e8 e4 31 00 00       	call   3816 <unlink>
  ...
  printf(stdout, "big files ok\n");
     ...
     647:	e8 cf 32 00 00       	call   391b <printf>
}
     ...
     665:	e8 b1 32 00 00       	call   391b <printf>
        exit();
     66a:	e8 57 31 00 00       	call   37c6 <exit>
      printf(stdout, "read failed %d\n", i);
     66f:	83 ec 04             	sub    $0x4,%esp
     672:	50                   	push   %eax
     673:	68 5b 3e 00 00       	push   $0x3e5b
     678:	ff 35 18 5d 00 00    	push   0x5d18
     67e:	e8 98 32 00 00       	call   391b <printf>
      exit();
     683:	e8 3e 31 00 00       	call   37c6 <exit>
      printf(stdout, "read content of block %d is %d\n",
     688:	50                   	push   %eax
     689:	53                   	push   %ebx
     68a:	68 58 4c 00 00       	push   $0x4c58
     68f:	ff 35 18 5d 00 00    	push   0x5d18
     695:	e8 81 32 00 00       	call   391b <printf>
      exit();
     69a:	e8 27 31 00 00       	call   37c6 <exit>
    printf(stdout, "unlink big failed\n");
     69f:	83 ec 08             	sub    $0x8,%esp
     6a2:	68 6b 3e 00 00       	push   $0x3e6b
     6a7:	ff 35 18 5d 00 00    	push   0x5d18
     6ad:	e8 69 32 00 00       	call   391b <printf>
    exit();
     6b2:	e8 0f 31 00 00       	call   37c6 <exit>
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     6c9:	e8 4d 32 00 00       	call   391b <printf>
  ...
  for(i = 0; i < 52; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     6fb:	e8 06 31 00 00       	call   3806 <open>
    close(fd);
     700:	89 04 24             	mov    %eax,(%esp)
     703:	e8 e6 30 00 00       	call   37ee <close>
  for(i = 0; i < 52; i++){
  ...
  for(i = 0; i < 52; i++){
    ...
    unlink(name);
     ...
     738:	e8 d9 30 00 00       	call   3816 <unlink>
  for(i = 0; i < 52; i++){
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     756:	e8 c0 31 00 00       	call   391b <printf>
}
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     774:	e8 a2 31 00 00       	call   391b <printf>

  if(mkdir("dir0") < 0){
     779:	c7 04 24 98 3e 00 00 	movl   $0x3e98,(%esp)
     780:	e8 a9 30 00 00       	call   382e <mkdir>
  ...
  if(chdir("dir0") < 0){
     ...
     794:	e8 9d 30 00 00       	call   3836 <chdir>
  ...
  if(chdir("..") < 0){
     ...
     7a8:	e8 89 30 00 00       	call   3836 <chdir>
  ...
  if(unlink("dir0") < 0){
     ...
     7bc:	e8 55 30 00 00       	call   3816 <unlink>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     7d6:	e8 40 31 00 00       	call   391b <printf>
}
    ...
    printf(stdout, "mkdir failed\n");
     ...
     7ee:	e8 28 31 00 00       	call   391b <printf>
    exit();
     7f3:	e8 ce 2f 00 00       	call   37c6 <exit>
    printf(stdout, "chdir dir0 failed\n");
     7f8:	83 ec 08             	sub    $0x8,%esp
     7fb:	68 9d 3e 00 00       	push   $0x3e9d
     800:	ff 35 18 5d 00 00    	push   0x5d18
     806:	e8 10 31 00 00       	call   391b <printf>
    exit();
     80b:	e8 b6 2f 00 00       	call   37c6 <exit>
    printf(stdout, "chdir .. failed\n");
     810:	83 ec 08             	sub    $0x8,%esp
     813:	68 b0 3e 00 00       	push   $0x3eb0
     818:	ff 35 18 5d 00 00    	push   0x5d18
     81e:	e8 f8 30 00 00       	call   391b <printf>
    exit();
     823:	e8 9e 2f 00 00       	call   37c6 <exit>
    printf(stdout, "unlink dir0 failed\n");
     828:	83 ec 08             	sub    $0x8,%esp
     82b:	68 c1 3e 00 00       	push   $0x3ec1
     830:	ff 35 18 5d 00 00    	push   0x5d18
     836:	e8 e0 30 00 00       	call   391b <printf>
    exit();
     83b:	e8 86 2f 00 00       	call   37c6 <exit>
...
exectest(void)
{
  ...
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     87f:	e8 97 30 00 00       	call   391b <printf>
    exit();
     884:	e8 3d 2f 00 00       	call   37c6 <exit>
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
     ...
     895:	50                   	push   %eax
     896:	e8 3b 2f 00 00       	call   37d6 <pipe>
  ...
  pid = fork();
     8a4:	e8 15 2f 00 00       	call   37be <fork>
  ...
  if(pid == 0){
    ...
    close(fds[1]);
     ...
     8bb:	e8 2e 2f 00 00       	call   37ee <close>
    total = 0;
    cc = 1;
  ...
  seq = 0;
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     8dd:	e8 fc 2e 00 00       	call   37de <read>
    ...
    printf(1, "pipe() failed\n");
     ...
     91e:	6a 01                	push   $0x1
     920:	e8 f6 2f 00 00       	call   391b <printf>
    exit();
     925:	e8 9c 2e 00 00       	call   37c6 <exit>
    close(fds[0]);
     92a:	83 ec 0c             	sub    $0xc,%esp
     92d:	ff 75 e0             	push   -0x20(%ebp)
     930:	e8 b9 2e 00 00       	call   37ee <close>
    for(n = 0; n < 5; n++){
  ...
  seq = 0;
    ...
    for(n = 0; n < 5; n++){
     ...
     961:	e8 80 2e 00 00       	call   37e6 <write>
    ...
    for(n = 0; n < 5; n++){
     ...
     984:	6a 01                	push   $0x1
     986:	e8 90 2f 00 00       	call   391b <printf>
        exit();
     98b:	e8 36 2e 00 00       	call   37c6 <exit>
    exit();
     990:	e8 31 2e 00 00       	call   37c6 <exit>
          printf(1, "pipe1 oops 2\n");
     995:	83 ec 08             	sub    $0x8,%esp
     998:	68 1e 3f 00 00       	push   $0x3f1e
     99d:	6a 01                	push   $0x1
     99f:	e8 77 2f 00 00       	call   391b <printf>
          return;
  ...
  printf(1, "pipe1 ok\n");
    ...
    close(fds[0]);
     ...
     9e0:	e8 09 2e 00 00       	call   37ee <close>
    wait();
     9e5:	e8 e4 2d 00 00       	call   37ce <wait>
  printf(1, "pipe1 ok\n");
     9ea:	83 c4 08             	add    $0x8,%esp
     9ed:	68 43 3f 00 00       	push   $0x3f43
     9f2:	6a 01                	push   $0x1
     9f4:	e8 22 2f 00 00       	call   391b <printf>
     ...
     a09:	6a 01                	push   $0x1
     a0b:	e8 0b 2f 00 00       	call   391b <printf>
      exit();
     a10:	e8 b1 2d 00 00       	call   37c6 <exit>
    printf(1, "fork() failed\n");
     a15:	83 ec 08             	sub    $0x8,%esp
     a18:	68 4d 3f 00 00       	push   $0x3f4d
     a1d:	6a 01                	push   $0x1
     a1f:	e8 f7 2e 00 00       	call   391b <printf>
    exit();
     a24:	e8 9d 2d 00 00       	call   37c6 <exit>
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     a37:	6a 01                	push   $0x1
     a39:	e8 dd 2e 00 00       	call   391b <printf>
  pid1 = fork();
     a3e:	e8 7b 2d 00 00       	call   37be <fork>
  if(pid1 == 0)
  ...
  pid2 = fork();
     a4e:	e8 6b 2d 00 00       	call   37be <fork>
  ...
  pipe(pfds);
     ...
     a61:	50                   	push   %eax
     a62:	e8 6f 2d 00 00       	call   37d6 <pipe>
  pid3 = fork();
     a67:	e8 52 2d 00 00       	call   37be <fork>
  ...
  if(pid3 == 0){
    ...
    close(pfds[1]);
     ...
     aa0:	e8 49 2d 00 00       	call   37ee <close>
    ...
    for(;;)
     ...
     ab2:	6a 01                	push   $0x1
     ab4:	e8 62 2e 00 00       	call   391b <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     aee:	6a 01                	push   $0x1
     af0:	e8 26 2e 00 00       	call   391b <printf>
    return;
  ...
  close(pfds[0]);
     ...
     b06:	e8 e3 2c 00 00       	call   37ee <close>
  printf(1, "kill... ");
     b0b:	83 c4 08             	add    $0x8,%esp
     b0e:	68 8d 3f 00 00       	push   $0x3f8d
     b13:	6a 01                	push   $0x1
     b15:	e8 01 2e 00 00       	call   391b <printf>
  kill(pid1);
     b1a:	89 1c 24             	mov    %ebx,(%esp)
     b1d:	e8 d4 2c 00 00       	call   37f6 <kill>
  kill(pid2);
     b22:	89 34 24             	mov    %esi,(%esp)
     b25:	e8 cc 2c 00 00       	call   37f6 <kill>
  kill(pid3);
     b2a:	89 3c 24             	mov    %edi,(%esp)
     b2d:	e8 c4 2c 00 00       	call   37f6 <kill>
  printf(1, "wait... ");
     b32:	83 c4 08             	add    $0x8,%esp
     b35:	68 96 3f 00 00       	push   $0x3f96
     b3a:	6a 01                	push   $0x1
     b3c:	e8 da 2d 00 00       	call   391b <printf>
  wait();
     b41:	e8 88 2c 00 00       	call   37ce <wait>
  wait();
     b46:	e8 83 2c 00 00       	call   37ce <wait>
  wait();
     b4b:	e8 7e 2c 00 00       	call   37ce <wait>
  printf(1, "preempt ok\n");
     b50:	83 c4 08             	add    $0x8,%esp
     b53:	68 9f 3f 00 00       	push   $0x3f9f
     b58:	6a 01                	push   $0x1
     b5a:	e8 bc 2d 00 00       	call   391b <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    pid = fork();
     b73:	e8 46 2c 00 00       	call   37be <fork>
    ...
    if(pid){
     b7e:	74 3b                	je     bbb <exitwait+0x57>
      if(wait() != pid){
     b80:	e8 49 2c 00 00       	call   37ce <wait>
  ...
  for(i = 0; i < 100; i++){
     ...
     b96:	6a 01                	push   $0x1
     b98:	e8 7e 2d 00 00       	call   391b <printf>
      return;
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     be2:	6a 01                	push   $0x1
     be4:	e8 32 2d 00 00       	call   391b <printf>
  ppid = getpid();
     be9:	e8 58 2c 00 00       	call   3846 <getpid>
     bee:	89 c6                	mov    %eax,%esi
  if((pid = fork()) == 0){
     bf0:	e8 c9 2b 00 00       	call   37be <fork>
    ...
    while((m2 = malloc(10001)) != 0){
     ...
     c13:	e8 29 2f 00 00       	call   3b41 <malloc>
    ...
    while(m1){
     ...
     c26:	53                   	push   %ebx
     c27:	e8 55 2e 00 00       	call   3a81 <free>
    ...
    m1 = malloc(1024*20);
     ...
     c3d:	e8 ff 2e 00 00       	call   3b41 <malloc>
    if(m1 == 0){
    ...
    free(m1);
     ...
     c4c:	50                   	push   %eax
     c4d:	e8 2f 2e 00 00       	call   3a81 <free>
    printf(1, "mem ok\n");
     c52:	83 c4 08             	add    $0x8,%esp
     c55:	68 ec 3f 00 00       	push   $0x3fec
     c5a:	6a 01                	push   $0x1
     c5c:	e8 ba 2c 00 00       	call   391b <printf>
    exit();
     c61:	e8 60 2b 00 00       	call   37c6 <exit>
      printf(1, "couldn't allocate mem?!!\n");
     c66:	83 ec 08             	sub    $0x8,%esp
     c69:	68 d2 3f 00 00       	push   $0x3fd2
     c6e:	6a 01                	push   $0x1
     c70:	e8 a6 2c 00 00       	call   391b <printf>
      kill(ppid);
     c75:	89 34 24             	mov    %esi,(%esp)
     c78:	e8 79 2b 00 00       	call   37f6 <kill>
      exit();
     c7d:	e8 44 2b 00 00       	call   37c6 <exit>
  } else {
    wait();
     c82:	e8 47 2b 00 00       	call   37ce <wait>
  }
}
...
sharedfd(void)
{
  ...
  pid = fork();
     ccb:	e8 ee 2a 00 00       	call   37be <fork>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     d02:	50                   	push   %eax
     d03:	56                   	push   %esi
     d04:	e8 dd 2a 00 00       	call   37e6 <write>
  ...
  for(i = 0; i < 1000; i++){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     d1e:	6a 01                	push   $0x1
     d20:	e8 f6 2b 00 00       	call   391b <printf>
    return;
  ...
  memset(buf, pid==0?'c':'p', sizeof(buf));
     ...
     d3c:	6a 01                	push   $0x1
     d3e:	e8 d8 2b 00 00       	call   391b <printf>
      break;
  ...
  if(pid == 0)
    ...
    wait();
     d4a:	e8 7f 2a 00 00       	call   37ce <wait>
  close(fd);
     d4f:	83 ec 0c             	sub    $0xc,%esp
     d52:	56                   	push   %esi
     d53:	e8 96 2a 00 00       	call   37ee <close>
  fd = open("sharedfd", 0);
     d58:	83 c4 08             	add    $0x8,%esp
     d5b:	6a 00                	push   $0x0
     d5d:	68 03 40 00 00       	push   $0x4003
     d62:	e8 9f 2a 00 00       	call   3806 <open>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     d82:	50                   	push   %eax
     d83:	57                   	push   %edi
     d84:	e8 55 2a 00 00       	call   37de <read>
    ...
    exit();
     d97:	e8 2a 2a 00 00       	call   37c6 <exit>
    printf(1, "fstests: cannot open sharedfd for reading\n");
     d9c:	83 ec 08             	sub    $0x8,%esp
     d9f:	68 14 4d 00 00       	push   $0x4d14
     da4:	6a 01                	push   $0x1
     da6:	e8 70 2b 00 00       	call   391b <printf>
    return;
  ...
  close(fd);
     ...
     dd4:	57                   	push   %edi
     dd5:	e8 14 2a 00 00       	call   37ee <close>
  unlink("sharedfd");
     dda:	c7 04 24 03 40 00 00 	movl   $0x4003,(%esp)
     de1:	e8 30 2a 00 00       	call   3816 <unlink>
  if(nc == 10000 && np == 10000){
    ...
    printf(1, "sharedfd ok\n");
     ...
     e07:	6a 01                	push   $0x1
     e09:	e8 0d 2b 00 00       	call   391b <printf>
    ...
    printf(1, "sharedfd oops %d %d\n", nc, np);
     ...
     e20:	6a 01                	push   $0x1
     e22:	e8 f4 2a 00 00       	call   391b <printf>
    exit();
     e27:	e8 9a 29 00 00       	call   37c6 <exit>
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
     ...
     e56:	6a 01                	push   $0x1
     e58:	e8 be 2a 00 00       	call   391b <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    if(pid < 0){
     ...
     e6f:	6a 01                	push   $0x1
     e71:	e8 a5 2a 00 00       	call   391b <printf>
      exit();
     e76:	e8 4b 29 00 00       	call   37c6 <exit>
    }
    ...
    if(pid == 0){
     ...
     e83:	6a 01                	push   $0x1
     e85:	e8 91 2a 00 00       	call   391b <printf>
        exit();
     e8a:	e8 37 29 00 00       	call   37c6 <exit>
      }
     ...
     e98:	6a 01                	push   $0x1
     e9a:	e8 7c 2a 00 00       	call   391b <printf>
          exit();
     e9f:	e8 22 29 00 00       	call   37c6 <exit>
        }
      }
      exit();
     ea4:	e8 1d 29 00 00       	call   37c6 <exit>
  for(pi = 0; pi < 4; pi++){
    ...
    unlink(fname);
     ...
     eb8:	57                   	push   %edi
     eb9:	e8 58 29 00 00       	call   3816 <unlink>
    pid = fork();
     ebe:	e8 fb 28 00 00       	call   37be <fork>
    if(pid < 0){
    ...
    if(pid == 0){
     ...
     ed6:	57                   	push   %edi
     ed7:	e8 2a 29 00 00       	call   3806 <open>
     ...
     f10:	57                   	push   %edi
     f11:	e8 d0 28 00 00       	call   37e6 <write>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
     f30:	e8 99 28 00 00       	call   37ce <wait>
  for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < 2; i++){
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f4c:	6a 01                	push   $0x1
     f4e:	e8 c8 29 00 00       	call   391b <printf>
          exit();
     f53:	e8 6e 28 00 00       	call   37c6 <exit>
        }
      }
      total += n;
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     f68:	56                   	push   %esi
     f69:	e8 70 28 00 00       	call   37de <read>
    ...
    close(fd);
     ...
     f96:	56                   	push   %esi
     f97:	e8 52 28 00 00       	call   37ee <close>
    if(total != 12*500){
    ...
    unlink(fname);
     ...
     fae:	e8 63 28 00 00       	call   3816 <unlink>
  for(i = 0; i < 2; i++){
    ...
    fd = open(fname, 0);
     ...
     fc8:	6a 00                	push   $0x0
     fca:	50                   	push   %eax
     fcb:	e8 36 28 00 00       	call   3806 <open>
    ...
    while((n = read(fd, buf, sizeof(buf))) > 0){
     ...
     fec:	6a 01                	push   $0x1
     fee:	e8 28 29 00 00       	call   391b <printf>
      exit();
     ff3:	e8 ce 27 00 00       	call   37c6 <exit>
  }
  ...
  printf(1, "fourfiles ok\n");
    ...
    1000:	6a 01                	push   $0x1
    1002:	e8 14 29 00 00       	call   391b <printf>
}
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    101f:	6a 01                	push   $0x1
    1021:	e8 f5 28 00 00       	call   391b <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    pid = fork();
    1037:	e8 82 27 00 00       	call   37be <fork>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1051:	6a 01                	push   $0x1
    1053:	e8 c3 28 00 00       	call   391b <printf>
      exit();
    1058:	e8 69 27 00 00       	call   37c6 <exit>
      name[0] = 'p' + pi;
    ...
    1071:	6a 01                	push   $0x1
    1073:	e8 a3 28 00 00       	call   391b <printf>
          exit();
    1078:	e8 49 27 00 00       	call   37c6 <exit>
      for(i = 0; i < N; i++){
    ...
    1096:	50                   	push   %eax
    1097:	e8 6a 27 00 00       	call   3806 <open>
        if(fd < 0){
    ...
    10a6:	50                   	push   %eax
    10a7:	e8 42 27 00 00       	call   37ee <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    10cd:	50                   	push   %eax
    10ce:	e8 43 27 00 00       	call   3816 <unlink>
    ...
    10e2:	6a 01                	push   $0x1
    10e4:	e8 32 28 00 00       	call   391b <printf>
            exit();
    10e9:	e8 d8 26 00 00       	call   37c6 <exit>
          }
        }
      }
      exit();
    10ee:	e8 d3 26 00 00       	call   37c6 <exit>
    }
  }
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    wait();
    10fa:	e8 cf 26 00 00       	call   37ce <wait>
  for(pi = 0; pi < 4; pi++){
  ...
  for(i = 0; i < N; i++){
    ...
    1145:	50                   	push   %eax
    1146:	e8 bb 26 00 00       	call   3806 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    116d:	6a 01                	push   $0x1
    116f:	e8 a7 27 00 00       	call   391b <printf>
        exit();
    1174:	e8 4d 26 00 00       	call   37c6 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1189:	6a 01                	push   $0x1
    118b:	e8 8b 27 00 00       	call   391b <printf>
        exit();
    1190:	e8 31 26 00 00       	call   37c6 <exit>
        close(fd);
    1195:	83 ec 0c             	sub    $0xc,%esp
    1198:	50                   	push   %eax
    1199:	e8 50 26 00 00       	call   37ee <close>
  ...
  for(i = 0; i < N; i++){
    ...
    11ce:	50                   	push   %eax
    11cf:	e8 42 26 00 00       	call   3816 <unlink>
    for(pi = 0; pi < 4; pi++){
  ...
  printf(1, "createdelete ok\n");
    ...
    11f6:	6a 01                	push   $0x1
    11f8:	e8 1e 27 00 00       	call   391b <printf>
}
...
unlinkread(void)
{
  ...
  write(fd, "hello", 5);
    ...
    1244:	50                   	push   %eax
    1245:	e8 9c 25 00 00       	call   37e6 <write>
  close(fd);
    124a:	89 1c 24             	mov    %ebx,(%esp)
    124d:	e8 9c 25 00 00       	call   37ee <close>

  fd = open("unlinkread", O_RDWR);
    1252:	83 c4 08             	add    $0x8,%esp
    1255:	6a 02                	push   $0x2
    1257:	68 b5 40 00 00       	push   $0x40b5
    125c:	e8 a5 25 00 00       	call   3806 <open>
  ...
  if(unlink("unlinkread") != 0){
    ...
    1276:	e8 9b 25 00 00       	call   3816 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1293:	e8 6e 25 00 00       	call   3806 <open>
  ...
  write(fd1, "yyy", 3);
    ...
    12a4:	50                   	push   %eax
    12a5:	e8 3c 25 00 00       	call   37e6 <write>
  close(fd1);
    12aa:	89 34 24             	mov    %esi,(%esp)
    12ad:	e8 3c 25 00 00       	call   37ee <close>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    12bf:	53                   	push   %ebx
    12c0:	e8 19 25 00 00       	call   37de <read>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    12e8:	53                   	push   %ebx
    12e9:	e8 f8 24 00 00       	call   37e6 <write>
  ...
  close(fd);
    ...
    12fd:	53                   	push   %ebx
    12fe:	e8 eb 24 00 00       	call   37ee <close>
  unlink("unlinkread");
    1303:	c7 04 24 b5 40 00 00 	movl   $0x40b5,(%esp)
    130a:	e8 07 25 00 00       	call   3816 <unlink>
  printf(1, "unlinkread ok\n");
    130f:	83 c4 08             	add    $0x8,%esp
    1312:	68 5d 41 00 00       	push   $0x415d
    1317:	6a 01                	push   $0x1
    1319:	e8 fd 25 00 00       	call   391b <printf>
}
    ...
    1330:	6a 01                	push   $0x1
    1332:	e8 e4 25 00 00       	call   391b <printf>
    exit();
    1337:	e8 8a 24 00 00       	call   37c6 <exit>
    printf(1, "open unlinkread failed\n");
    133c:	83 ec 08             	sub    $0x8,%esp
    133f:	68 e0 40 00 00       	push   $0x40e0
    1344:	6a 01                	push   $0x1
    1346:	e8 d0 25 00 00       	call   391b <printf>
    exit();
    134b:	e8 76 24 00 00       	call   37c6 <exit>
    printf(1, "unlink unlinkread failed\n");
    1350:	83 ec 08             	sub    $0x8,%esp
    1353:	68 f8 40 00 00       	push   $0x40f8
    1358:	6a 01                	push   $0x1
    135a:	e8 bc 25 00 00       	call   391b <printf>
    exit();
    135f:	e8 62 24 00 00       	call   37c6 <exit>
    printf(1, "unlinkread read failed");
    1364:	83 ec 08             	sub    $0x8,%esp
    1367:	68 16 41 00 00       	push   $0x4116
    136c:	6a 01                	push   $0x1
    136e:	e8 a8 25 00 00       	call   391b <printf>
    exit();
    1373:	e8 4e 24 00 00       	call   37c6 <exit>
    printf(1, "unlinkread wrong data\n");
    1378:	83 ec 08             	sub    $0x8,%esp
    137b:	68 2d 41 00 00       	push   $0x412d
    1380:	6a 01                	push   $0x1
    1382:	e8 94 25 00 00       	call   391b <printf>
    exit();
    1387:	e8 3a 24 00 00       	call   37c6 <exit>
    printf(1, "unlinkread write failed\n");
    138c:	83 ec 08             	sub    $0x8,%esp
    138f:	68 44 41 00 00       	push   $0x4144
    1394:	6a 01                	push   $0x1
    1396:	e8 80 25 00 00       	call   391b <printf>
    exit();
    139b:	e8 26 24 00 00       	call   37c6 <exit>
...
linktest(void)
{
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    13f4:	50                   	push   %eax
    13f5:	e8 ec 23 00 00       	call   37e6 <write>
  ...
  unlink("lf1");
    ...
    1434:	e8 dd 23 00 00       	call   3816 <unlink>

  if(open("lf1", 0) >= 0){
    1439:	83 c4 08             	add    $0x8,%esp
    143c:	6a 00                	push   $0x0
    143e:	68 76 41 00 00       	push   $0x4176
    1443:	e8 be 23 00 00       	call   3806 <open>
  ...
  fd = open("lf2", 0);
    ...
    145d:	e8 a4 23 00 00       	call   3806 <open>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    147c:	50                   	push   %eax
    147d:	e8 5c 23 00 00       	call   37de <read>
  ...
  if(link(".", "lf1") >= 0){
    ...
    14eb:	e8 36 23 00 00       	call   3826 <link>
  ...
  printf(1, "linktest ok\n");
    ...
    1503:	6a 01                	push   $0x1
    1505:	e8 11 24 00 00       	call   391b <printf>
}
    ...
    151a:	6a 01                	push   $0x1
    151c:	e8 fa 23 00 00       	call   391b <printf>
    exit();
    1521:	e8 a0 22 00 00       	call   37c6 <exit>
    printf(1, "write lf1 failed\n");
    1526:	83 ec 08             	sub    $0x8,%esp
    1529:	68 91 41 00 00       	push   $0x4191
    152e:	6a 01                	push   $0x1
    1530:	e8 e6 23 00 00       	call   391b <printf>
    exit();
    1535:	e8 8c 22 00 00       	call   37c6 <exit>
    printf(1, "link lf1 lf2 failed\n");
    153a:	83 ec 08             	sub    $0x8,%esp
    153d:	68 a3 41 00 00       	push   $0x41a3
    1542:	6a 01                	push   $0x1
    1544:	e8 d2 23 00 00       	call   391b <printf>
    exit();
    1549:	e8 78 22 00 00       	call   37c6 <exit>
    printf(1, "unlinked lf1 but it is still there!\n");
    154e:	83 ec 08             	sub    $0x8,%esp
    1551:	68 84 4d 00 00       	push   $0x4d84
    1556:	6a 01                	push   $0x1
    1558:	e8 be 23 00 00       	call   391b <printf>
    exit();
    155d:	e8 64 22 00 00       	call   37c6 <exit>
    printf(1, "open lf2 failed\n");
    1562:	83 ec 08             	sub    $0x8,%esp
    1565:	68 b8 41 00 00       	push   $0x41b8
    156a:	6a 01                	push   $0x1
    156c:	e8 aa 23 00 00       	call   391b <printf>
    exit();
    1571:	e8 50 22 00 00       	call   37c6 <exit>
    printf(1, "read lf2 failed\n");
    1576:	83 ec 08             	sub    $0x8,%esp
    1579:	68 c9 41 00 00       	push   $0x41c9
    157e:	6a 01                	push   $0x1
    1580:	e8 96 23 00 00       	call   391b <printf>
    exit();
    1585:	e8 3c 22 00 00       	call   37c6 <exit>
    printf(1, "link lf2 lf2 succeeded! oops\n");
    158a:	83 ec 08             	sub    $0x8,%esp
    158d:	68 da 41 00 00       	push   $0x41da
    1592:	6a 01                	push   $0x1
    1594:	e8 82 23 00 00       	call   391b <printf>
    exit();
    1599:	e8 28 22 00 00       	call   37c6 <exit>
    printf(1, "link non-existant succeeded! oops\n");
    159e:	83 ec 08             	sub    $0x8,%esp
    15a1:	68 ac 4d 00 00       	push   $0x4dac
    15a6:	6a 01                	push   $0x1
    15a8:	e8 6e 23 00 00       	call   391b <printf>
    exit();
    15ad:	e8 14 22 00 00       	call   37c6 <exit>
    printf(1, "link . lf1 succeeded! oops\n");
    15b2:	83 ec 08             	sub    $0x8,%esp
    15b5:	68 f8 41 00 00       	push   $0x41f8
    15ba:	6a 01                	push   $0x1
    15bc:	e8 5a 23 00 00       	call   391b <printf>
    exit();
    15c1:	e8 00 22 00 00       	call   37c6 <exit>
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    15d4:	6a 01                	push   $0x1
    15d6:	e8 40 23 00 00       	call   391b <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    161e:	50                   	push   %eax
    161f:	e8 e2 21 00 00       	call   3806 <open>
      if(fd < 0){
    ...
    1632:	50                   	push   %eax
    1633:	e8 b6 21 00 00       	call   37ee <close>
    ...
    163d:	0f 84 9c 00 00 00    	je     16df <concreate+0x119>
      ...
      wait();
    1643:	e8 86 21 00 00       	call   37ce <wait>
  for(i = 0; i < 40; i++){
    ...
    1660:	50                   	push   %eax
    1661:	e8 b0 21 00 00       	call   3816 <unlink>
    pid = fork();
    1666:	e8 53 21 00 00       	call   37be <fork>
    ...
    16a4:	e8 7d 21 00 00       	call   3826 <link>
    ...
    16ba:	e8 67 21 00 00       	call   3826 <link>
    ...
    16d3:	6a 01                	push   $0x1
    16d5:	e8 41 22 00 00       	call   391b <printf>
        exit();
    16da:	e8 e7 20 00 00       	call   37c6 <exit>
      exit();
    16df:	e8 e2 20 00 00       	call   37c6 <exit>
  }
  ...
  fd = open(".", 0);
    ...
    16fe:	e8 03 21 00 00       	call   3806 <open>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1715:	50                   	push   %eax
    1716:	53                   	push   %ebx
    1717:	e8 c2 20 00 00       	call   37de <read>
    ...
    175f:	6a 01                	push   $0x1
    1761:	e8 b5 21 00 00       	call   391b <printf>
        exit();
    1766:	e8 5b 20 00 00       	call   37c6 <exit>
        printf(1, "concreate duplicate file %s\n", de.name);
    ...
    1777:	6a 01                	push   $0x1
    1779:	e8 9d 21 00 00       	call   391b <printf>
        exit();
    177e:	e8 43 20 00 00       	call   37c6 <exit>
    }
  }
  close(fd);
    1783:	83 ec 0c             	sub    $0xc,%esp
    1786:	53                   	push   %ebx
    1787:	e8 62 20 00 00       	call   37ee <close>
  ...
  for(i = 0; i < 40; i++){
    ...
    17a6:	6a 01                	push   $0x1
    17a8:	e8 6e 21 00 00       	call   391b <printf>
    exit();
    17ad:	e8 14 20 00 00       	call   37c6 <exit>
    file[1] = '0' + i;
    pid = fork();
    if(pid < 0){
      printf(1, "fork failed\n");
    ...
    17ba:	6a 01                	push   $0x1
    17bc:	e8 5a 21 00 00       	call   391b <printf>
      exit();
    17c1:	e8 00 20 00 00       	call   37c6 <exit>
    }
    if(((i % 3) == 0 && pid == 0) ||
       ((i % 3) == 1 && pid != 0)){
      close(open(file, 0));
    ...
    17ce:	57                   	push   %edi
    17cf:	e8 32 20 00 00       	call   3806 <open>
    17d4:	89 04 24             	mov    %eax,(%esp)
    17d7:	e8 12 20 00 00       	call   37ee <close>
      close(open(file, 0));
    17dc:	83 c4 08             	add    $0x8,%esp
    17df:	6a 00                	push   $0x0
    17e1:	57                   	push   %edi
    17e2:	e8 1f 20 00 00       	call   3806 <open>
    17e7:	89 04 24             	mov    %eax,(%esp)
    17ea:	e8 ff 1f 00 00       	call   37ee <close>
      close(open(file, 0));
    17ef:	83 c4 08             	add    $0x8,%esp
    17f2:	6a 00                	push   $0x0
    17f4:	57                   	push   %edi
    17f5:	e8 0c 20 00 00       	call   3806 <open>
    17fa:	89 04 24             	mov    %eax,(%esp)
    17fd:	e8 ec 1f 00 00       	call   37ee <close>
      close(open(file, 0));
    1802:	83 c4 08             	add    $0x8,%esp
    1805:	6a 00                	push   $0x0
    1807:	57                   	push   %edi
    1808:	e8 f9 1f 00 00       	call   3806 <open>
    180d:	89 04 24             	mov    %eax,(%esp)
    1810:	e8 d9 1f 00 00       	call   37ee <close>
    ...
    181a:	74 79                	je     1895 <concreate+0x2cf>
      ...
      wait();
    181c:	e8 ad 1f 00 00       	call   37ce <wait>
  for(i = 0; i < 40; i++){
    ...
    pid = fork();
    182f:	e8 8a 1f 00 00       	call   37be <fork>
    ...
    1872:	57                   	push   %edi
    1873:	e8 9e 1f 00 00       	call   3816 <unlink>
      unlink(file);
    1878:	89 3c 24             	mov    %edi,(%esp)
    187b:	e8 96 1f 00 00       	call   3816 <unlink>
      unlink(file);
    1880:	89 3c 24             	mov    %edi,(%esp)
    1883:	e8 8e 1f 00 00       	call   3816 <unlink>
      unlink(file);
    1888:	89 3c 24             	mov    %edi,(%esp)
    188b:	e8 86 1f 00 00       	call   3816 <unlink>
    1890:	83 c4 10             	add    $0x10,%esp
    1893:	eb 83                	jmp    1818 <concreate+0x252>
      exit();
    1895:	e8 2c 1f 00 00       	call   37c6 <exit>
  }
  ...
  printf(1, "concreate ok\n");
    ...
    18a2:	6a 01                	push   $0x1
    18a4:	e8 72 20 00 00       	call   391b <printf>
}
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    18c2:	6a 01                	push   $0x1
    18c4:	e8 52 20 00 00       	call   391b <printf>

  unlink("x");
    18c9:	c7 04 24 21 45 00 00 	movl   $0x4521,(%esp)
    18d0:	e8 41 1f 00 00       	call   3816 <unlink>
  pid = fork();
    18d5:	e8 e4 1e 00 00       	call   37be <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    18f9:	6a 01                	push   $0x1
    18fb:	e8 1b 20 00 00       	call   391b <printf>
    exit();
    1900:	e8 c1 1e 00 00       	call   37c6 <exit>
  unsigned int x = (pid ? 1 : 97);
  ...
  for(i = 0; i < 100; i++){
    ...
    1919:	e8 e8 1e 00 00       	call   3806 <open>
    191e:	89 04 24             	mov    %eax,(%esp)
    1921:	e8 c8 1e 00 00       	call   37ee <close>
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	e8 af 1e 00 00       	call   3816 <unlink>
    ...
    1979:	e8 a8 1e 00 00       	call   3826 <link>
  ...
  if(pid)
    ...
    wait();
    1987:	e8 42 1e 00 00       	call   37ce <wait>
  else
    exit();
  ...
  printf(1, "linkunlink ok\n");
    ...
    1994:	6a 01                	push   $0x1
    1996:	e8 80 1f 00 00       	call   391b <printf>
}
    ...
    19a2:	c3                   	ret    
    exit();
    19a3:	e8 1e 1e 00 00       	call   37c6 <exit>
...
bigdir(void)
{
  ...
  close(fd);
    ...
    19e3:	50                   	push   %eax
    19e4:	e8 05 1e 00 00       	call   37ee <close>
  ...
  for(i = 0; i < 500; i++){
    ...
    1a34:	e8 ed 1d 00 00       	call   3826 <link>
  ...
  for(i = 0; i < 500; i++){
    ...
    1a4d:	6a 01                	push   $0x1
    1a4f:	e8 c7 1e 00 00       	call   391b <printf>
    exit();
    1a54:	e8 6d 1d 00 00       	call   37c6 <exit>
      printf(1, "bigdir link failed\n");
    1a59:	83 ec 08             	sub    $0x8,%esp
    1a5c:	68 de 42 00 00       	push   $0x42de
    1a61:	6a 01                	push   $0x1
    1a63:	e8 b3 1e 00 00       	call   391b <printf>
      exit();
    1a68:	e8 59 1d 00 00       	call   37c6 <exit>
    }
  }
  ...
  unlink("bd");
    ...
    1a75:	e8 9c 1d 00 00       	call   3816 <unlink>
  for(i = 0; i < 500; i++){
    ...
    1ac4:	50                   	push   %eax
    1ac5:	e8 4c 1d 00 00       	call   3816 <unlink>
    ...
    1ad9:	6a 01                	push   $0x1
    1adb:	e8 3b 1e 00 00       	call   391b <printf>
      exit();
    1ae0:	e8 e1 1c 00 00       	call   37c6 <exit>
    }
  }
  ...
  printf(1, "bigdir ok\n");
    ...
    1aed:	6a 01                	push   $0x1
    1aef:	e8 27 1e 00 00       	call   391b <printf>
}
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    ...
    1b08:	6a 01                	push   $0x1
    1b0a:	e8 0c 1e 00 00       	call   391b <printf>

  unlink("ff");
    1b0f:	c7 04 24 9b 43 00 00 	movl   $0x439b,(%esp)
    1b16:	e8 fb 1c 00 00       	call   3816 <unlink>
  if(mkdir("dd") != 0){
    1b1b:	c7 04 24 38 44 00 00 	movl   $0x4438,(%esp)
    1b22:	e8 07 1d 00 00       	call   382e <mkdir>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1b3f:	e8 c2 1c 00 00       	call   3806 <open>
  ...
  write(fd, "ff", 2);
    ...
    1b5b:	50                   	push   %eax
    1b5c:	e8 85 1c 00 00       	call   37e6 <write>
  close(fd);
    1b61:	89 1c 24             	mov    %ebx,(%esp)
    1b64:	e8 85 1c 00 00       	call   37ee <close>

  if(unlink("dd") >= 0){
    1b69:	c7 04 24 38 44 00 00 	movl   $0x4438,(%esp)
    1b70:	e8 a1 1c 00 00       	call   3816 <unlink>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    1b88:	e8 a1 1c 00 00       	call   382e <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    1ba5:	e8 5c 1c 00 00       	call   3806 <open>
  ...
  write(fd, "FF", 2);
    ...
    1bc1:	50                   	push   %eax
    1bc2:	e8 1f 1c 00 00       	call   37e6 <write>
  close(fd);
    1bc7:	89 1c 24             	mov    %ebx,(%esp)
    1bca:	e8 1f 1c 00 00       	call   37ee <close>

  fd = open("dd/dd/../ff", 0);
    1bcf:	83 c4 08             	add    $0x8,%esp
    1bd2:	6a 00                	push   $0x0
    1bd4:	68 92 43 00 00       	push   $0x4392
    1bd9:	e8 28 1c 00 00       	call   3806 <open>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    1bf8:	50                   	push   %eax
    1bf9:	e8 e0 1b 00 00       	call   37de <read>
  if(cc != 2 || buf[0] != 'f'){
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    1c45:	e8 cc 1b 00 00       	call   3816 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    1c5f:	e8 a2 1b 00 00       	call   3806 <open>
  ...
  if(chdir("dd") != 0){
    ...
    1c77:	e8 ba 1b 00 00       	call   3836 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    1c8f:	e8 a2 1b 00 00       	call   3836 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    1ca7:	e8 8a 1b 00 00       	call   3836 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    1cbf:	e8 72 1b 00 00       	call   3836 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    1cd9:	e8 28 1b 00 00       	call   3806 <open>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    1cf8:	50                   	push   %eax
    1cf9:	e8 e0 1a 00 00       	call   37de <read>
  ...
  close(fd);
    ...
    1d0d:	53                   	push   %ebx
    1d0e:	e8 db 1a 00 00       	call   37ee <close>

  if(open("dd/dd/ff", O_RDONLY) >= 0){
    1d13:	83 c4 08             	add    $0x8,%esp
    1d16:	6a 00                	push   $0x0
    1d18:	68 6e 43 00 00       	push   $0x436e
    1d1d:	e8 e4 1a 00 00       	call   3806 <open>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d3a:	e8 c7 1a 00 00       	call   3806 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    1d57:	e8 aa 1a 00 00       	call   3806 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    1d74:	e8 8d 1a 00 00       	call   3806 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    1d8e:	e8 73 1a 00 00       	call   3806 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    1da8:	e8 59 1a 00 00       	call   3806 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    1dc5:	e8 5c 1a 00 00       	call   3826 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    1de2:	e8 3f 1a 00 00       	call   3826 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    1dff:	e8 22 1a 00 00       	call   3826 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    1e17:	e8 12 1a 00 00       	call   382e <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    1e2f:	e8 fa 19 00 00       	call   382e <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    1e47:	e8 e2 19 00 00       	call   382e <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    1e5f:	e8 b2 19 00 00       	call   3816 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    1e77:	e8 9a 19 00 00       	call   3816 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    1e8f:	e8 a2 19 00 00       	call   3836 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    1ea7:	e8 8a 19 00 00       	call   3836 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    1ebf:	e8 52 19 00 00       	call   3816 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    1ed7:	e8 3a 19 00 00       	call   3816 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    1eef:	e8 22 19 00 00       	call   3816 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    1f07:	e8 0a 19 00 00       	call   3816 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    1f1f:	e8 f2 18 00 00       	call   3816 <unlink>
  ...
  printf(1, "subdir ok\n");
    ...
    1f37:	6a 01                	push   $0x1
    1f39:	e8 dd 19 00 00       	call   391b <printf>
}
    ...
    1f4e:	6a 01                	push   $0x1
    1f50:	e8 c6 19 00 00       	call   391b <printf>
    exit();
    1f55:	e8 6c 18 00 00       	call   37c6 <exit>
    printf(1, "create dd/ff failed\n");
    1f5a:	83 ec 08             	sub    $0x8,%esp
    1f5d:	68 37 43 00 00       	push   $0x4337
    1f62:	6a 01                	push   $0x1
    1f64:	e8 b2 19 00 00       	call   391b <printf>
    exit();
    1f69:	e8 58 18 00 00       	call   37c6 <exit>
    printf(1, "unlink dd (non-empty dir) succeeded!\n");
    1f6e:	83 ec 08             	sub    $0x8,%esp
    1f71:	68 04 4e 00 00       	push   $0x4e04
    1f76:	6a 01                	push   $0x1
    1f78:	e8 9e 19 00 00       	call   391b <printf>
    exit();
    1f7d:	e8 44 18 00 00       	call   37c6 <exit>
    printf(1, "subdir mkdir dd/dd failed\n");
    1f82:	83 ec 08             	sub    $0x8,%esp
    1f85:	68 53 43 00 00       	push   $0x4353
    1f8a:	6a 01                	push   $0x1
    1f8c:	e8 8a 19 00 00       	call   391b <printf>
    exit();
    1f91:	e8 30 18 00 00       	call   37c6 <exit>
    printf(1, "create dd/dd/ff failed\n");
    1f96:	83 ec 08             	sub    $0x8,%esp
    1f99:	68 77 43 00 00       	push   $0x4377
    1f9e:	6a 01                	push   $0x1
    1fa0:	e8 76 19 00 00       	call   391b <printf>
    exit();
    1fa5:	e8 1c 18 00 00       	call   37c6 <exit>
    printf(1, "open dd/dd/../ff failed\n");
    1faa:	83 ec 08             	sub    $0x8,%esp
    1fad:	68 9e 43 00 00       	push   $0x439e
    1fb2:	6a 01                	push   $0x1
    1fb4:	e8 62 19 00 00       	call   391b <printf>
    exit();
    1fb9:	e8 08 18 00 00       	call   37c6 <exit>
    printf(1, "dd/dd/../ff wrong content\n");
    1fbe:	83 ec 08             	sub    $0x8,%esp
    1fc1:	68 b7 43 00 00       	push   $0x43b7
    1fc6:	6a 01                	push   $0x1
    1fc8:	e8 4e 19 00 00       	call   391b <printf>
    exit();
    1fcd:	e8 f4 17 00 00       	call   37c6 <exit>
    printf(1, "link dd/dd/ff dd/dd/ffff failed\n");
    1fd2:	83 ec 08             	sub    $0x8,%esp
    1fd5:	68 2c 4e 00 00       	push   $0x4e2c
    1fda:	6a 01                	push   $0x1
    1fdc:	e8 3a 19 00 00       	call   391b <printf>
    exit();
    1fe1:	e8 e0 17 00 00       	call   37c6 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    1fe6:	83 ec 08             	sub    $0x8,%esp
    1fe9:	68 dd 43 00 00       	push   $0x43dd
    1fee:	6a 01                	push   $0x1
    1ff0:	e8 26 19 00 00       	call   391b <printf>
    exit();
    1ff5:	e8 cc 17 00 00       	call   37c6 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded\n");
    1ffa:	83 ec 08             	sub    $0x8,%esp
    1ffd:	68 50 4e 00 00       	push   $0x4e50
    2002:	6a 01                	push   $0x1
    2004:	e8 12 19 00 00       	call   391b <printf>
    exit();
    2009:	e8 b8 17 00 00       	call   37c6 <exit>
    printf(1, "chdir dd failed\n");
    200e:	83 ec 08             	sub    $0x8,%esp
    2011:	68 f5 43 00 00       	push   $0x43f5
    2016:	6a 01                	push   $0x1
    2018:	e8 fe 18 00 00       	call   391b <printf>
    exit();
    201d:	e8 a4 17 00 00       	call   37c6 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2022:	83 ec 08             	sub    $0x8,%esp
    2025:	68 12 44 00 00       	push   $0x4412
    202a:	6a 01                	push   $0x1
    202c:	e8 ea 18 00 00       	call   391b <printf>
    exit();
    2031:	e8 90 17 00 00       	call   37c6 <exit>
    printf(1, "chdir dd/../../dd failed\n");
    2036:	83 ec 08             	sub    $0x8,%esp
    2039:	68 12 44 00 00       	push   $0x4412
    203e:	6a 01                	push   $0x1
    2040:	e8 d6 18 00 00       	call   391b <printf>
    exit();
    2045:	e8 7c 17 00 00       	call   37c6 <exit>
    printf(1, "chdir ./.. failed\n");
    204a:	83 ec 08             	sub    $0x8,%esp
    204d:	68 40 44 00 00       	push   $0x4440
    2052:	6a 01                	push   $0x1
    2054:	e8 c2 18 00 00       	call   391b <printf>
    exit();
    2059:	e8 68 17 00 00       	call   37c6 <exit>
    printf(1, "open dd/dd/ffff failed\n");
    205e:	83 ec 08             	sub    $0x8,%esp
    2061:	68 53 44 00 00       	push   $0x4453
    2066:	6a 01                	push   $0x1
    2068:	e8 ae 18 00 00       	call   391b <printf>
    exit();
    206d:	e8 54 17 00 00       	call   37c6 <exit>
    printf(1, "read dd/dd/ffff wrong len\n");
    2072:	83 ec 08             	sub    $0x8,%esp
    2075:	68 6b 44 00 00       	push   $0x446b
    207a:	6a 01                	push   $0x1
    207c:	e8 9a 18 00 00       	call   391b <printf>
    exit();
    2081:	e8 40 17 00 00       	call   37c6 <exit>
    printf(1, "open (unlinked) dd/dd/ff succeeded!\n");
    2086:	83 ec 08             	sub    $0x8,%esp
    2089:	68 74 4e 00 00       	push   $0x4e74
    208e:	6a 01                	push   $0x1
    2090:	e8 86 18 00 00       	call   391b <printf>
    exit();
    2095:	e8 2c 17 00 00       	call   37c6 <exit>
    printf(1, "create dd/ff/ff succeeded!\n");
    209a:	83 ec 08             	sub    $0x8,%esp
    209d:	68 8f 44 00 00       	push   $0x448f
    20a2:	6a 01                	push   $0x1
    20a4:	e8 72 18 00 00       	call   391b <printf>
    exit();
    20a9:	e8 18 17 00 00       	call   37c6 <exit>
    printf(1, "create dd/xx/ff succeeded!\n");
    20ae:	83 ec 08             	sub    $0x8,%esp
    20b1:	68 b4 44 00 00       	push   $0x44b4
    20b6:	6a 01                	push   $0x1
    20b8:	e8 5e 18 00 00       	call   391b <printf>
    exit();
    20bd:	e8 04 17 00 00       	call   37c6 <exit>
    printf(1, "create dd succeeded!\n");
    20c2:	83 ec 08             	sub    $0x8,%esp
    20c5:	68 d0 44 00 00       	push   $0x44d0
    20ca:	6a 01                	push   $0x1
    20cc:	e8 4a 18 00 00       	call   391b <printf>
    exit();
    20d1:	e8 f0 16 00 00       	call   37c6 <exit>
    printf(1, "open dd rdwr succeeded!\n");
    20d6:	83 ec 08             	sub    $0x8,%esp
    20d9:	68 e6 44 00 00       	push   $0x44e6
    20de:	6a 01                	push   $0x1
    20e0:	e8 36 18 00 00       	call   391b <printf>
    exit();
    20e5:	e8 dc 16 00 00       	call   37c6 <exit>
    printf(1, "open dd wronly succeeded!\n");
    20ea:	83 ec 08             	sub    $0x8,%esp
    20ed:	68 ff 44 00 00       	push   $0x44ff
    20f2:	6a 01                	push   $0x1
    20f4:	e8 22 18 00 00       	call   391b <printf>
    exit();
    20f9:	e8 c8 16 00 00       	call   37c6 <exit>
    printf(1, "link dd/ff/ff dd/dd/xx succeeded!\n");
    20fe:	83 ec 08             	sub    $0x8,%esp
    2101:	68 9c 4e 00 00       	push   $0x4e9c
    2106:	6a 01                	push   $0x1
    2108:	e8 0e 18 00 00       	call   391b <printf>
    exit();
    210d:	e8 b4 16 00 00       	call   37c6 <exit>
    printf(1, "link dd/xx/ff dd/dd/xx succeeded!\n");
    2112:	83 ec 08             	sub    $0x8,%esp
    2115:	68 c0 4e 00 00       	push   $0x4ec0
    211a:	6a 01                	push   $0x1
    211c:	e8 fa 17 00 00       	call   391b <printf>
    exit();
    2121:	e8 a0 16 00 00       	call   37c6 <exit>
    printf(1, "link dd/ff dd/dd/ffff succeeded!\n");
    2126:	83 ec 08             	sub    $0x8,%esp
    2129:	68 e4 4e 00 00       	push   $0x4ee4
    212e:	6a 01                	push   $0x1
    2130:	e8 e6 17 00 00       	call   391b <printf>
    exit();
    2135:	e8 8c 16 00 00       	call   37c6 <exit>
    printf(1, "mkdir dd/ff/ff succeeded!\n");
    213a:	83 ec 08             	sub    $0x8,%esp
    213d:	68 23 45 00 00       	push   $0x4523
    2142:	6a 01                	push   $0x1
    2144:	e8 d2 17 00 00       	call   391b <printf>
    exit();
    2149:	e8 78 16 00 00       	call   37c6 <exit>
    printf(1, "mkdir dd/xx/ff succeeded!\n");
    214e:	83 ec 08             	sub    $0x8,%esp
    2151:	68 3e 45 00 00       	push   $0x453e
    2156:	6a 01                	push   $0x1
    2158:	e8 be 17 00 00       	call   391b <printf>
    exit();
    215d:	e8 64 16 00 00       	call   37c6 <exit>
    printf(1, "mkdir dd/dd/ffff succeeded!\n");
    2162:	83 ec 08             	sub    $0x8,%esp
    2165:	68 59 45 00 00       	push   $0x4559
    216a:	6a 01                	push   $0x1
    216c:	e8 aa 17 00 00       	call   391b <printf>
    exit();
    2171:	e8 50 16 00 00       	call   37c6 <exit>
    printf(1, "unlink dd/xx/ff succeeded!\n");
    2176:	83 ec 08             	sub    $0x8,%esp
    2179:	68 76 45 00 00       	push   $0x4576
    217e:	6a 01                	push   $0x1
    2180:	e8 96 17 00 00       	call   391b <printf>
    exit();
    2185:	e8 3c 16 00 00       	call   37c6 <exit>
    printf(1, "unlink dd/ff/ff succeeded!\n");
    218a:	83 ec 08             	sub    $0x8,%esp
    218d:	68 92 45 00 00       	push   $0x4592
    2192:	6a 01                	push   $0x1
    2194:	e8 82 17 00 00       	call   391b <printf>
    exit();
    2199:	e8 28 16 00 00       	call   37c6 <exit>
    printf(1, "chdir dd/ff succeeded!\n");
    219e:	83 ec 08             	sub    $0x8,%esp
    21a1:	68 ae 45 00 00       	push   $0x45ae
    21a6:	6a 01                	push   $0x1
    21a8:	e8 6e 17 00 00       	call   391b <printf>
    exit();
    21ad:	e8 14 16 00 00       	call   37c6 <exit>
    printf(1, "chdir dd/xx succeeded!\n");
    21b2:	83 ec 08             	sub    $0x8,%esp
    21b5:	68 c6 45 00 00       	push   $0x45c6
    21ba:	6a 01                	push   $0x1
    21bc:	e8 5a 17 00 00       	call   391b <printf>
    exit();
    21c1:	e8 00 16 00 00       	call   37c6 <exit>
    printf(1, "unlink dd/dd/ff failed\n");
    21c6:	83 ec 08             	sub    $0x8,%esp
    21c9:	68 dd 43 00 00       	push   $0x43dd
    21ce:	6a 01                	push   $0x1
    21d0:	e8 46 17 00 00       	call   391b <printf>
    exit();
    21d5:	e8 ec 15 00 00       	call   37c6 <exit>
    printf(1, "unlink dd/ff failed\n");
    21da:	83 ec 08             	sub    $0x8,%esp
    21dd:	68 de 45 00 00       	push   $0x45de
    21e2:	6a 01                	push   $0x1
    21e4:	e8 32 17 00 00       	call   391b <printf>
    exit();
    21e9:	e8 d8 15 00 00       	call   37c6 <exit>
    printf(1, "unlink non-empty dd succeeded!\n");
    21ee:	83 ec 08             	sub    $0x8,%esp
    21f1:	68 08 4f 00 00       	push   $0x4f08
    21f6:	6a 01                	push   $0x1
    21f8:	e8 1e 17 00 00       	call   391b <printf>
    exit();
    21fd:	e8 c4 15 00 00       	call   37c6 <exit>
    printf(1, "unlink dd/dd failed\n");
    2202:	83 ec 08             	sub    $0x8,%esp
    2205:	68 f3 45 00 00       	push   $0x45f3
    220a:	6a 01                	push   $0x1
    220c:	e8 0a 17 00 00       	call   391b <printf>
    exit();
    2211:	e8 b0 15 00 00       	call   37c6 <exit>
    printf(1, "unlink dd failed\n");
    2216:	83 ec 08             	sub    $0x8,%esp
    2219:	68 08 46 00 00       	push   $0x4608
    221e:	6a 01                	push   $0x1
    2220:	e8 f6 16 00 00       	call   391b <printf>
    exit();
    2225:	e8 9c 15 00 00       	call   37c6 <exit>
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    2238:	6a 01                	push   $0x1
    223a:	e8 dc 16 00 00       	call   391b <printf>

  unlink("bigwrite");
    223f:	c7 04 24 34 46 00 00 	movl   $0x4634,(%esp)
    2246:	e8 cb 15 00 00       	call   3816 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    225d:	6a 01                	push   $0x1
    225f:	e8 b7 16 00 00       	call   391b <printf>
      exit();
    2264:	e8 5d 15 00 00       	call   37c6 <exit>
    }
    int i;
    for(i = 0; i < 2; i++){
    ...
    2270:	6a 01                	push   $0x1
    2272:	e8 a4 16 00 00       	call   391b <printf>
        exit();
    2277:	e8 4a 15 00 00       	call   37c6 <exit>
      }
    }
    close(fd);
    227c:	83 ec 0c             	sub    $0xc,%esp
    227f:	57                   	push   %edi
    2280:	e8 69 15 00 00       	call   37ee <close>
    unlink("bigwrite");
    2285:	c7 04 24 34 46 00 00 	movl   $0x4634,(%esp)
    228c:	e8 85 15 00 00       	call   3816 <unlink>
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    22af:	e8 52 15 00 00       	call   3806 <open>
    ...
    22d0:	57                   	push   %edi
    22d1:	e8 10 15 00 00       	call   37e6 <write>
      if(cc != sz){
  ...
  printf(1, "bigwrite ok\n");
    ...
    22ea:	6a 01                	push   $0x1
    22ec:	e8 2a 16 00 00       	call   391b <printf>
}
...
bigfile(void)
{
  ...
  for(i = 0; i < 20; i++){
    ...
    2362:	56                   	push   %esi
    2363:	e8 7e 14 00 00       	call   37e6 <write>
  ...
  for(i = 0; i < 20; i++){
    ...
    237f:	6a 01                	push   $0x1
    2381:	e8 95 15 00 00       	call   391b <printf>
    exit();
    2386:	e8 3b 14 00 00       	call   37c6 <exit>
      printf(1, "write bigfile failed\n");
    238b:	83 ec 08             	sub    $0x8,%esp
    238e:	68 98 46 00 00       	push   $0x4698
    2393:	6a 01                	push   $0x1
    2395:	e8 81 15 00 00       	call   391b <printf>
      exit();
    239a:	e8 27 14 00 00       	call   37c6 <exit>
    }
  }
  close(fd);
    239f:	83 ec 0c             	sub    $0xc,%esp
    23a2:	56                   	push   %esi
    23a3:	e8 46 14 00 00       	call   37ee <close>

  fd = open("bigfile", 0);
    23a8:	83 c4 08             	add    $0x8,%esp
    23ab:	6a 00                	push   $0x0
    23ad:	68 90 46 00 00       	push   $0x4690
    23b2:	e8 4f 14 00 00       	call   3806 <open>
  ...
  for(i = 0; ; i++){
    ...
    23d7:	57                   	push   %edi
    23d8:	e8 01 14 00 00       	call   37de <read>
    if(cc < 0){
  ...
  for(i = 0; ; i++){
    ...
    241b:	6a 01                	push   $0x1
    241d:	e8 f9 14 00 00       	call   391b <printf>
    exit();
    2422:	e8 9f 13 00 00       	call   37c6 <exit>
      printf(1, "read bigfile failed\n");
    2427:	83 ec 08             	sub    $0x8,%esp
    242a:	68 c3 46 00 00       	push   $0x46c3
    242f:	6a 01                	push   $0x1
    2431:	e8 e5 14 00 00       	call   391b <printf>
      exit();
    2436:	e8 8b 13 00 00       	call   37c6 <exit>
      printf(1, "short read bigfile\n");
    243b:	83 ec 08             	sub    $0x8,%esp
    243e:	68 d8 46 00 00       	push   $0x46d8
    2443:	6a 01                	push   $0x1
    2445:	e8 d1 14 00 00       	call   391b <printf>
      exit();
    244a:	e8 77 13 00 00       	call   37c6 <exit>
      printf(1, "read bigfile wrong data\n");
    244f:	83 ec 08             	sub    $0x8,%esp
    2452:	68 ec 46 00 00       	push   $0x46ec
    2457:	6a 01                	push   $0x1
    2459:	e8 bd 14 00 00       	call   391b <printf>
      exit();
    245e:	e8 63 13 00 00       	call   37c6 <exit>
  }
  close(fd);
    2463:	83 ec 0c             	sub    $0xc,%esp
    2466:	57                   	push   %edi
    2467:	e8 82 13 00 00       	call   37ee <close>
  if(total != 20*600){
  ...
  unlink("bigfile");
    ...
    247f:	e8 92 13 00 00       	call   3816 <unlink>

  printf(1, "bigfile test ok\n");
    2484:	83 c4 08             	add    $0x8,%esp
    2487:	68 1f 47 00 00       	push   $0x471f
    248c:	6a 01                	push   $0x1
    248e:	e8 88 14 00 00       	call   391b <printf>
}
    ...
    24a6:	6a 01                	push   $0x1
    24a8:	e8 6e 14 00 00       	call   391b <printf>
    exit();
    24ad:	e8 14 13 00 00       	call   37c6 <exit>
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    24bd:	6a 01                	push   $0x1
    24bf:	e8 57 14 00 00       	call   391b <printf>

  if(mkdir("12345678901234") != 0){
    24c4:	c7 04 24 6b 47 00 00 	movl   $0x476b,(%esp)
    24cb:	e8 5e 13 00 00       	call   382e <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    24e3:	e8 46 13 00 00       	call   382e <mkdir>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2500:	e8 01 13 00 00       	call   3806 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2513:	50                   	push   %eax
    2514:	e8 d5 12 00 00       	call   37ee <close>
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    2519:	83 c4 08             	add    $0x8,%esp
    251c:	6a 00                	push   $0x0
    251e:	68 e8 4f 00 00       	push   $0x4fe8
    2523:	e8 de 12 00 00       	call   3806 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    2536:	50                   	push   %eax
    2537:	e8 b2 12 00 00       	call   37ee <close>

  if(mkdir("12345678901234/12345678901234") == 0){
    253c:	c7 04 24 5c 47 00 00 	movl   $0x475c,(%esp)
    2543:	e8 e6 12 00 00       	call   382e <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2557:	e8 d2 12 00 00       	call   382e <mkdir>
  ...
  printf(1, "fourteen ok\n");
    ...
    256b:	6a 01                	push   $0x1
    256d:	e8 a9 13 00 00       	call   391b <printf>
}
    ...
    257f:	6a 01                	push   $0x1
    2581:	e8 95 13 00 00       	call   391b <printf>
    exit();
    2586:	e8 3b 12 00 00       	call   37c6 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 failed\n");
    258b:	83 ec 08             	sub    $0x8,%esp
    258e:	68 48 4f 00 00       	push   $0x4f48
    2593:	6a 01                	push   $0x1
    2595:	e8 81 13 00 00       	call   391b <printf>
    exit();
    259a:	e8 27 12 00 00       	call   37c6 <exit>
    printf(1, "create 123456789012345/123456789012345/123456789012345 failed\n");
    259f:	83 ec 08             	sub    $0x8,%esp
    25a2:	68 a8 4f 00 00       	push   $0x4fa8
    25a7:	6a 01                	push   $0x1
    25a9:	e8 6d 13 00 00       	call   391b <printf>
    exit();
    25ae:	e8 13 12 00 00       	call   37c6 <exit>
    printf(1, "open 12345678901234/12345678901234/12345678901234 failed\n");
    25b3:	83 ec 08             	sub    $0x8,%esp
    25b6:	68 18 50 00 00       	push   $0x5018
    25bb:	6a 01                	push   $0x1
    25bd:	e8 59 13 00 00       	call   391b <printf>
    exit();
    25c2:	e8 ff 11 00 00       	call   37c6 <exit>
    printf(1, "mkdir 12345678901234/12345678901234 succeeded!\n");
    25c7:	83 ec 08             	sub    $0x8,%esp
    25ca:	68 54 50 00 00       	push   $0x5054
    25cf:	6a 01                	push   $0x1
    25d1:	e8 45 13 00 00       	call   391b <printf>
    exit();
    25d6:	e8 eb 11 00 00       	call   37c6 <exit>
    printf(1, "mkdir 12345678901234/123456789012345 succeeded!\n");
    25db:	83 ec 08             	sub    $0x8,%esp
    25de:	68 a4 50 00 00       	push   $0x50a4
    25e3:	6a 01                	push   $0x1
    25e5:	e8 31 13 00 00       	call   391b <printf>
    exit();
    25ea:	e8 d7 11 00 00       	call   37c6 <exit>
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    25fa:	6a 01                	push   $0x1
    25fc:	e8 1a 13 00 00       	call   391b <printf>
  if(mkdir("dots") != 0){
    2601:	c7 04 24 93 47 00 00 	movl   $0x4793,(%esp)
    2608:	e8 21 12 00 00       	call   382e <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    2620:	e8 11 12 00 00       	call   3836 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    2638:	e8 d9 11 00 00       	call   3816 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    2650:	e8 c1 11 00 00       	call   3816 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    2668:	e8 c9 11 00 00       	call   3836 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    2680:	e8 91 11 00 00       	call   3816 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    2698:	e8 79 11 00 00       	call   3816 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    26b0:	e8 61 11 00 00       	call   3816 <unlink>
  ...
  printf(1, "rmdot ok\n");
    ...
    26c8:	6a 01                	push   $0x1
    26ca:	e8 4c 12 00 00       	call   391b <printf>
}
    ...
    26dc:	6a 01                	push   $0x1
    26de:	e8 38 12 00 00       	call   391b <printf>
    exit();
    26e3:	e8 de 10 00 00       	call   37c6 <exit>
    printf(1, "chdir dots failed\n");
    26e8:	83 ec 08             	sub    $0x8,%esp
    26eb:	68 ab 47 00 00       	push   $0x47ab
    26f0:	6a 01                	push   $0x1
    26f2:	e8 24 12 00 00       	call   391b <printf>
    exit();
    26f7:	e8 ca 10 00 00       	call   37c6 <exit>
    printf(1, "rm . worked!\n");
    26fc:	83 ec 08             	sub    $0x8,%esp
    26ff:	68 be 47 00 00       	push   $0x47be
    2704:	6a 01                	push   $0x1
    2706:	e8 10 12 00 00       	call   391b <printf>
    exit();
    270b:	e8 b6 10 00 00       	call   37c6 <exit>
    printf(1, "rm .. worked!\n");
    2710:	83 ec 08             	sub    $0x8,%esp
    2713:	68 cc 47 00 00       	push   $0x47cc
    2718:	6a 01                	push   $0x1
    271a:	e8 fc 11 00 00       	call   391b <printf>
    exit();
    271f:	e8 a2 10 00 00       	call   37c6 <exit>
    printf(1, "chdir / failed\n");
    2724:	83 ec 08             	sub    $0x8,%esp
    2727:	68 13 3c 00 00       	push   $0x3c13
    272c:	6a 01                	push   $0x1
    272e:	e8 e8 11 00 00       	call   391b <printf>
    exit();
    2733:	e8 8e 10 00 00       	call   37c6 <exit>
    printf(1, "unlink dots/. worked!\n");
    2738:	83 ec 08             	sub    $0x8,%esp
    273b:	68 e2 47 00 00       	push   $0x47e2
    2740:	6a 01                	push   $0x1
    2742:	e8 d4 11 00 00       	call   391b <printf>
    exit();
    2747:	e8 7a 10 00 00       	call   37c6 <exit>
    printf(1, "unlink dots/.. worked!\n");
    274c:	83 ec 08             	sub    $0x8,%esp
    274f:	68 01 48 00 00       	push   $0x4801
    2754:	6a 01                	push   $0x1
    2756:	e8 c0 11 00 00       	call   391b <printf>
    exit();
    275b:	e8 66 10 00 00       	call   37c6 <exit>
    printf(1, "unlink dots failed!\n");
    2760:	83 ec 08             	sub    $0x8,%esp
    2763:	68 19 48 00 00       	push   $0x4819
    2768:	6a 01                	push   $0x1
    276a:	e8 ac 11 00 00       	call   391b <printf>
    exit();
    276f:	e8 52 10 00 00       	call   37c6 <exit>
...
dirfile(void)
{
  ...
  close(fd);
    ...
    27a7:	50                   	push   %eax
    27a8:	e8 41 10 00 00       	call   37ee <close>
  if(chdir("dirfile") == 0){
    27ad:	c7 04 24 45 48 00 00 	movl   $0x4845,(%esp)
    27b4:	e8 7d 10 00 00       	call   3836 <chdir>
  ...
  fd = open("dirfile/xx", 0);
    ...
    27ce:	e8 33 10 00 00       	call   3806 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    27eb:	e8 16 10 00 00       	call   3806 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2803:	e8 26 10 00 00       	call   382e <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    281b:	e8 f6 0f 00 00       	call   3816 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2838:	e8 e9 0f 00 00       	call   3826 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    2850:	e8 c1 0f 00 00       	call   3816 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    286a:	e8 97 0f 00 00       	call   3806 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    2884:	e8 7d 0f 00 00       	call   3806 <open>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2895:	50                   	push   %eax
    2896:	e8 4b 0f 00 00       	call   37e6 <write>
  ...
  close(fd);
    ...
    28a9:	53                   	push   %ebx
    28aa:	e8 3f 0f 00 00       	call   37ee <close>

  printf(1, "dir vs file OK\n");
    28af:	83 c4 08             	add    $0x8,%esp
    28b2:	68 15 49 00 00       	push   $0x4915
    28b7:	6a 01                	push   $0x1
    28b9:	e8 5d 10 00 00       	call   391b <printf>
}
    ...
    28ce:	6a 01                	push   $0x1
    28d0:	e8 46 10 00 00       	call   391b <printf>
    exit();
    28d5:	e8 ec 0e 00 00       	call   37c6 <exit>
    printf(1, "chdir dirfile succeeded!\n");
    28da:	83 ec 08             	sub    $0x8,%esp
    28dd:	68 64 48 00 00       	push   $0x4864
    28e2:	6a 01                	push   $0x1
    28e4:	e8 32 10 00 00       	call   391b <printf>
    exit();
    28e9:	e8 d8 0e 00 00       	call   37c6 <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    28ee:	83 ec 08             	sub    $0x8,%esp
    28f1:	68 89 48 00 00       	push   $0x4889
    28f6:	6a 01                	push   $0x1
    28f8:	e8 1e 10 00 00       	call   391b <printf>
    exit();
    28fd:	e8 c4 0e 00 00       	call   37c6 <exit>
    printf(1, "create dirfile/xx succeeded!\n");
    2902:	83 ec 08             	sub    $0x8,%esp
    2905:	68 89 48 00 00       	push   $0x4889
    290a:	6a 01                	push   $0x1
    290c:	e8 0a 10 00 00       	call   391b <printf>
    exit();
    2911:	e8 b0 0e 00 00       	call   37c6 <exit>
    printf(1, "mkdir dirfile/xx succeeded!\n");
    2916:	83 ec 08             	sub    $0x8,%esp
    2919:	68 a7 48 00 00       	push   $0x48a7
    291e:	6a 01                	push   $0x1
    2920:	e8 f6 0f 00 00       	call   391b <printf>
    exit();
    2925:	e8 9c 0e 00 00       	call   37c6 <exit>
    printf(1, "unlink dirfile/xx succeeded!\n");
    292a:	83 ec 08             	sub    $0x8,%esp
    292d:	68 c4 48 00 00       	push   $0x48c4
    2932:	6a 01                	push   $0x1
    2934:	e8 e2 0f 00 00       	call   391b <printf>
    exit();
    2939:	e8 88 0e 00 00       	call   37c6 <exit>
    printf(1, "link to dirfile/xx succeeded!\n");
    293e:	83 ec 08             	sub    $0x8,%esp
    2941:	68 d8 50 00 00       	push   $0x50d8
    2946:	6a 01                	push   $0x1
    2948:	e8 ce 0f 00 00       	call   391b <printf>
    exit();
    294d:	e8 74 0e 00 00       	call   37c6 <exit>
    printf(1, "unlink dirfile failed!\n");
    2952:	83 ec 08             	sub    $0x8,%esp
    2955:	68 e9 48 00 00       	push   $0x48e9
    295a:	6a 01                	push   $0x1
    295c:	e8 ba 0f 00 00       	call   391b <printf>
    exit();
    2961:	e8 60 0e 00 00       	call   37c6 <exit>
    printf(1, "open . for writing succeeded!\n");
    2966:	83 ec 08             	sub    $0x8,%esp
    2969:	68 f8 50 00 00       	push   $0x50f8
    296e:	6a 01                	push   $0x1
    2970:	e8 a6 0f 00 00       	call   391b <printf>
    exit();
    2975:	e8 4c 0e 00 00       	call   37c6 <exit>
    printf(1, "write . succeeded!\n");
    297a:	83 ec 08             	sub    $0x8,%esp
    297d:	68 01 49 00 00       	push   $0x4901
    2982:	6a 01                	push   $0x1
    2984:	e8 92 0f 00 00       	call   391b <printf>
    exit();
    2989:	e8 38 0e 00 00       	call   37c6 <exit>
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    299a:	6a 01                	push   $0x1
    299c:	e8 7a 0f 00 00       	call   391b <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    29b3:	6a 01                	push   $0x1
    29b5:	e8 61 0f 00 00       	call   391b <printf>
      exit();
    29ba:	e8 07 0e 00 00       	call   37c6 <exit>
    }
    if(chdir("irefd") != 0){
    ...
    29c7:	6a 01                	push   $0x1
    29c9:	e8 4d 0f 00 00       	call   391b <printf>
      exit();
    29ce:	e8 f3 0d 00 00       	call   37c6 <exit>
    ...
    29d6:	50                   	push   %eax
    29d7:	e8 12 0e 00 00       	call   37ee <close>
    ...
    29ec:	e8 25 0e 00 00       	call   3816 <unlink>
  for(i = 0; i < 50 + 1; i++){
    ...
    2a08:	e8 21 0e 00 00       	call   382e <mkdir>
    ...
    2a1c:	e8 15 0e 00 00       	call   3836 <chdir>
    ...
    2a71:	e8 90 0d 00 00       	call   3806 <open>
    if(fd >= 0)
    ...
    2a84:	50                   	push   %eax
    2a85:	e8 64 0d 00 00       	call   37ee <close>
  ...
  chdir("/");
    ...
    2a9a:	e8 97 0d 00 00       	call   3836 <chdir>
  printf(1, "empty file name OK\n");
    2a9f:	83 c4 08             	add    $0x8,%esp
    2aa2:	68 64 49 00 00       	push   $0x4964
    2aa7:	6a 01                	push   $0x1
    2aa9:	e8 6d 0e 00 00       	call   391b <printf>
}
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    2ac2:	6a 01                	push   $0x1
    2ac4:	e8 52 0e 00 00       	call   391b <printf>
  ...
  for(n=0; n<1000; n++){
    ...
    pid = fork();
    2ad9:	e8 e0 0c 00 00       	call   37be <fork>
    if(pid < 0)
  ...
  for(n=0; n<1000; n++){
    ...
    2ae7:	eb e8                	jmp    2ad1 <forktest+0x1b>
      exit();
    2ae9:	e8 d8 0c 00 00       	call   37c6 <exit>
  }
  ...
  for(; n > 0; n--){
    ...
    if(wait() < 0){
    2afa:	e8 cf 0c 00 00       	call   37ce <wait>
  ...
  for(; n > 0; n--){
    ...
    2b10:	6a 01                	push   $0x1
    2b12:	e8 04 0e 00 00       	call   391b <printf>
    exit();
    2b17:	e8 aa 0c 00 00       	call   37c6 <exit>
      printf(1, "wait stopped early\n");
    2b1c:	83 ec 08             	sub    $0x8,%esp
    2b1f:	68 83 49 00 00       	push   $0x4983
    2b24:	6a 01                	push   $0x1
    2b26:	e8 f0 0d 00 00       	call   391b <printf>
      exit();
    2b2b:	e8 96 0c 00 00       	call   37c6 <exit>
    }
  }

  if(wait() != -1){
    2b30:	e8 99 0c 00 00       	call   37ce <wait>
  ...
  printf(1, "fork test OK\n");
    ...
    2b42:	6a 01                	push   $0x1
    2b44:	e8 d2 0d 00 00       	call   391b <printf>
}
    ...
    2b59:	6a 01                	push   $0x1
    2b5b:	e8 bb 0d 00 00       	call   391b <printf>
    exit();
    2b60:	e8 61 0c 00 00       	call   37c6 <exit>
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2b79:	e8 9d 0d 00 00       	call   391b <printf>
  oldbrk = sbrk(0);
    2b7e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2b85:	e8 c4 0c 00 00       	call   384e <sbrk>
    2b8a:	89 c7                	mov    %eax,%edi

  // can one sbrk() less than a page?
  a = sbrk(0);
    2b8c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2b93:	e8 b6 0c 00 00       	call   384e <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2bad:	6a 01                	push   $0x1
    2baf:	e8 9a 0c 00 00       	call   384e <sbrk>
    if(b != a){
  ...
  for(i = 0; i < 5000; i++){
    ...
    2bd7:	e8 3f 0d 00 00       	call   391b <printf>
      exit();
    2bdc:	83 c4 20             	add    $0x20,%esp
    2bdf:	e8 e2 0b 00 00       	call   37c6 <exit>
  }
  pid = fork();
    2be4:	e8 d5 0b 00 00       	call   37be <fork>
  ...
  c = sbrk(1);
    ...
    2bf6:	6a 01                	push   $0x1
    2bf8:	e8 51 0c 00 00       	call   384e <sbrk>
  c = sbrk(1);
    2bfd:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2c04:	e8 45 0c 00 00       	call   384e <sbrk>
  if(c != a + 1){
  ...
  if(pid == 0)
    ...
    exit();
  wait();
    2c1f:	e8 aa 0b 00 00       	call   37ce <wait>
...
#define BIG (100*1024*1024)
  a = sbrk(0);
    ...
    2c27:	6a 00                	push   $0x0
    2c29:	e8 20 0c 00 00       	call   384e <sbrk>
  ...
  p = sbrk(amt);
    ...
    2c3a:	e8 0f 0c 00 00       	call   384e <sbrk>
  if (p != a) {
  ...
  a = sbrk(0);
    ...
    2c4d:	6a 00                	push   $0x0
    2c4f:	e8 fa 0b 00 00       	call   384e <sbrk>
    2c54:	89 c3                	mov    %eax,%ebx
  c = sbrk(-4096);
    2c56:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
    2c5d:	e8 ec 0b 00 00       	call   384e <sbrk>
  ...
  c = sbrk(0);
    ...
    2c71:	6a 00                	push   $0x0
    2c73:	e8 d6 0b 00 00       	call   384e <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2c8c:	6a 00                	push   $0x0
    2c8e:	e8 bb 0b 00 00       	call   384e <sbrk>
    2c93:	89 c3                	mov    %eax,%ebx
  c = sbrk(4096);
    2c95:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    2c9c:	e8 ad 0b 00 00       	call   384e <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2cb1:	6a 00                	push   $0x0
    2cb3:	e8 96 0b 00 00       	call   384e <sbrk>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    ppid = getpid();
    2d18:	e8 29 0b 00 00       	call   3846 <getpid>
    2d1d:	89 c6                	mov    %eax,%esi
    pid = fork();
    2d1f:	e8 9a 0a 00 00       	call   37be <fork>
    if(pid < 0){
    ...
    wait();
    2d32:	e8 97 0a 00 00       	call   37ce <wait>
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2d4d:	e8 c9 0b 00 00       	call   391b <printf>
    exit();
    2d52:	e8 6f 0a 00 00       	call   37c6 <exit>
    printf(stdout, "sbrk test failed post-fork\n");
    2d57:	83 ec 08             	sub    $0x8,%esp
    2d5a:	68 f5 49 00 00       	push   $0x49f5
    2d5f:	ff 35 18 5d 00 00    	push   0x5d18
    2d65:	e8 b1 0b 00 00       	call   391b <printf>
    exit();
    2d6a:	e8 57 0a 00 00       	call   37c6 <exit>
    exit();
    2d6f:	e8 52 0a 00 00       	call   37c6 <exit>
    printf(stdout, "sbrk test failed to grow big address space; enough phys mem?\n");
    2d74:	83 ec 08             	sub    $0x8,%esp
    2d77:	68 3c 51 00 00       	push   $0x513c
    2d7c:	ff 35 18 5d 00 00    	push   0x5d18
    2d82:	e8 94 0b 00 00       	call   391b <printf>
    exit();
    2d87:	e8 3a 0a 00 00       	call   37c6 <exit>
    printf(stdout, "sbrk could not deallocate\n");
    2d8c:	83 ec 08             	sub    $0x8,%esp
    2d8f:	68 11 4a 00 00       	push   $0x4a11
    2d94:	ff 35 18 5d 00 00    	push   0x5d18
    2d9a:	e8 7c 0b 00 00       	call   391b <printf>
    exit();
    2d9f:	e8 22 0a 00 00       	call   37c6 <exit>
    printf(stdout, "sbrk deallocation produced wrong address, a %x c %x\n", a, c);
    2da4:	50                   	push   %eax
    2da5:	53                   	push   %ebx
    2da6:	68 7c 51 00 00       	push   $0x517c
    2dab:	ff 35 18 5d 00 00    	push   0x5d18
    2db1:	e8 65 0b 00 00       	call   391b <printf>
    exit();
    2db6:	e8 0b 0a 00 00       	call   37c6 <exit>
    printf(stdout, "sbrk re-allocation failed, a %x c %x\n", a, c);
    2dbb:	56                   	push   %esi
    2dbc:	53                   	push   %ebx
    2dbd:	68 b4 51 00 00       	push   $0x51b4
    2dc2:	ff 35 18 5d 00 00    	push   0x5d18
    2dc8:	e8 4e 0b 00 00       	call   391b <printf>
    exit();
    2dcd:	e8 f4 09 00 00       	call   37c6 <exit>
    printf(stdout, "sbrk de-allocation didn't really deallocate\n");
    2dd2:	83 ec 08             	sub    $0x8,%esp
    2dd5:	68 dc 51 00 00       	push   $0x51dc
    2dda:	ff 35 18 5d 00 00    	push   0x5d18
    2de0:	e8 36 0b 00 00       	call   391b <printf>
    exit();
    2de5:	e8 dc 09 00 00       	call   37c6 <exit>
    printf(stdout, "sbrk downsize failed, a %x c %x\n", a, c);
    2dea:	50                   	push   %eax
    2deb:	53                   	push   %ebx
    2dec:	68 0c 52 00 00       	push   $0x520c
    2df1:	ff 35 18 5d 00 00    	push   0x5d18
    2df7:	e8 1f 0b 00 00       	call   391b <printf>
    exit();
    2dfc:	e8 c5 09 00 00       	call   37c6 <exit>
      printf(stdout, "fork failed\n");
    2e01:	83 ec 08             	sub    $0x8,%esp
    2e04:	68 09 4b 00 00       	push   $0x4b09
    2e09:	ff 35 18 5d 00 00    	push   0x5d18
    2e0f:	e8 07 0b 00 00       	call   391b <printf>
      exit();
    2e14:	e8 ad 09 00 00       	call   37c6 <exit>
      printf(stdout, "oops could read %x = %x\n", a, *a);
    ...
    2e29:	e8 ed 0a 00 00       	call   391b <printf>
      kill(ppid);
    2e2e:	89 34 24             	mov    %esi,(%esp)
    2e31:	e8 c0 09 00 00       	call   37f6 <kill>
      exit();
    2e36:	e8 8b 09 00 00       	call   37c6 <exit>
  }
  ...
  if(pipe(fds) != 0){
    ...
    2e41:	50                   	push   %eax
    2e42:	e8 8f 09 00 00       	call   37d6 <pipe>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    if((pids[i] = fork()) == 0){
    2eb2:	e8 07 09 00 00       	call   37be <fork>
    ...
    2ed0:	e8 09 09 00 00       	call   37de <read>
  ...
  c = sbrk(4096);
    ...
    2ee2:	e8 67 09 00 00       	call   384e <sbrk>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    2f02:	50                   	push   %eax
    2f03:	e8 ee 08 00 00       	call   37f6 <kill>
    wait();
    2f08:	e8 c1 08 00 00       	call   37ce <wait>
  ...
  if(sbrk(0) > oldbrk)
    ...
    2f1a:	6a 00                	push   $0x0
    2f1c:	e8 2d 09 00 00       	call   384e <sbrk>
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2f36:	e8 e0 09 00 00       	call   391b <printf>
}
    ...
    2f54:	e8 c2 09 00 00       	call   391b <printf>
    exit();
    2f59:	e8 68 08 00 00       	call   37c6 <exit>
    sbrk(-(sbrk(0) - oldbrk));
    2f5e:	83 ec 0c             	sub    $0xc,%esp
    2f61:	6a 00                	push   $0x0
    2f63:	e8 e6 08 00 00       	call   384e <sbrk>
    2f68:	29 c7                	sub    %eax,%edi
    2f6a:	89 3c 24             	mov    %edi,(%esp)
    2f6d:	e8 dc 08 00 00       	call   384e <sbrk>
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    ...
    2f8b:	e8 8b 09 00 00       	call   391b <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    if((pid = fork()) == 0){
    2fa0:	e8 19 08 00 00       	call   37be <fork>
    ...
    2fae:	6a 00                	push   $0x0
    2fb0:	e8 a1 08 00 00       	call   3856 <sleep>
    sleep(0);
    2fb5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    2fbc:	e8 95 08 00 00       	call   3856 <sleep>
    kill(pid);
    2fc1:	89 1c 24             	mov    %ebx,(%esp)
    2fc4:	e8 2d 08 00 00       	call   37f6 <kill>
    wait();
    2fc9:	e8 00 08 00 00       	call   37ce <wait>
    ...
    2fd7:	e8 4a 08 00 00       	call   3826 <link>
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    2fea:	eb ac                	jmp    2f98 <validatetest+0x20>
      exit();
    2fec:	e8 d5 07 00 00       	call   37c6 <exit>
      printf(stdout, "link should not succeed\n");
    2ff1:	83 ec 08             	sub    $0x8,%esp
    2ff4:	68 88 4a 00 00       	push   $0x4a88
    2ff9:	ff 35 18 5d 00 00    	push   0x5d18
    2fff:	e8 17 09 00 00       	call   391b <printf>
      exit();
    3004:	e8 bd 07 00 00       	call   37c6 <exit>
    }
  }
  ...
  printf(stdout, "validate ok\n");
    ...
    3017:	e8 ff 08 00 00       	call   391b <printf>
}
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    ...
    3037:	e8 df 08 00 00       	call   391b <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    3067:	e8 af 08 00 00       	call   391b <printf>
      exit();
    306c:	e8 55 07 00 00       	call   37c6 <exit>
    }
  }
  printf(stdout, "bss test ok\n");
    ...
    307f:	e8 97 08 00 00       	call   391b <printf>
}
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    3094:	e8 7d 07 00 00       	call   3816 <unlink>
  pid = fork();
    3099:	e8 20 07 00 00       	call   37be <fork>
  if(pid == 0){
  ...
  wait();
    30ab:	e8 1e 07 00 00       	call   37ce <wait>
  fd = open("bigarg-ok", 0);
    30b0:	83 ec 08             	sub    $0x8,%esp
    30b3:	6a 00                	push   $0x0
    30b5:	68 d6 4a 00 00       	push   $0x4ad6
    30ba:	e8 47 07 00 00       	call   3806 <open>
  if(fd < 0){
  ...
  close(fd);
    ...
    30cd:	50                   	push   %eax
    30ce:	e8 1b 07 00 00       	call   37ee <close>
  unlink("bigarg-ok");
    30d3:	c7 04 24 d6 4a 00 00 	movl   $0x4ad6,(%esp)
    30da:	e8 37 07 00 00       	call   3816 <unlink>
}
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    3196:	6a 01                	push   $0x1
    3198:	e8 7e 07 00 00       	call   391b <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3234:	6a 01                	push   $0x1
    3236:	e8 e0 06 00 00       	call   391b <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    323b:	83 c4 08             	add    $0x8,%esp
    323e:	68 02 02 00 00       	push   $0x202
    3243:	56                   	push   %esi
    3244:	e8 bd 05 00 00       	call   3806 <open>
    ...
    325e:	6a 01                	push   $0x1
    3260:	e8 b6 06 00 00       	call   391b <printf>
      break;
    ...
    327f:	56                   	push   %esi
    3280:	e8 61 05 00 00       	call   37e6 <write>
      if(cc < 512)
    ...
    329c:	6a 01                	push   $0x1
    329e:	e8 78 06 00 00       	call   391b <printf>
    close(fd);
    32a3:	89 34 24             	mov    %esi,(%esp)
    32a6:	e8 43 05 00 00       	call   37ee <close>
    if(total == 0)
  ...
  while(nfiles >= 0){
    ...
    3347:	50                   	push   %eax
    3348:	e8 c9 04 00 00       	call   3816 <unlink>
    nfiles--;
  ...
  printf(1, "fsfull test finished\n");
    ...
    3363:	6a 01                	push   $0x1
    3365:	e8 b1 05 00 00       	call   391b <printf>
}
...
uio()
{
  ...
  printf(1, "uio test\n");
    ...
    3380:	6a 01                	push   $0x1
    3382:	e8 94 05 00 00       	call   391b <printf>
  pid = fork();
    3387:	e8 32 04 00 00       	call   37be <fork>
  if(pid == 0){
  ...
  wait();
    3395:	e8 34 04 00 00       	call   37ce <wait>
  printf(1, "uio test done\n");
    339a:	83 ec 08             	sub    $0x8,%esp
    339d:	68 84 4b 00 00       	push   $0x4b84
    33a2:	6a 01                	push   $0x1
    33a4:	e8 72 05 00 00       	call   391b <printf>
}
    ...
    33c7:	6a 01                	push   $0x1
    33c9:	e8 4d 05 00 00       	call   391b <printf>
    exit();
    33ce:	e8 f3 03 00 00       	call   37c6 <exit>
    printf (1, "fork failed\n");
    33d3:	83 ec 08             	sub    $0x8,%esp
    33d6:	68 09 4b 00 00       	push   $0x4b09
    33db:	6a 01                	push   $0x1
    33dd:	e8 39 05 00 00       	call   391b <printf>
    exit();
    33e2:	e8 df 03 00 00       	call   37c6 <exit>
...
void argptest()
{
  ...
  fd = open("init", O_RDONLY);
    ...
    33f5:	e8 0c 04 00 00       	call   3806 <open>
  if (fd < 0) {
  ...
  printf(1, "arg test passed\n");
    ...
    3443:	6a 02                	push   $0x2
    3445:	e8 d1 04 00 00       	call   391b <printf>
    exit();
    344a:	e8 77 03 00 00       	call   37c6 <exit>
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    347a:	6a 01                	push   $0x1
    347c:	e8 9a 04 00 00       	call   391b <printf>

  if(open("usertests.ran", 0) >= 0){
    3481:	83 c4 08             	add    $0x8,%esp
    3484:	6a 00                	push   $0x0
    3486:	68 ca 4b 00 00       	push   $0x4bca
    348b:	e8 76 03 00 00       	call   3806 <open>
    ...
    349f:	6a 01                	push   $0x1
    34a1:	e8 75 04 00 00       	call   391b <printf>
    exit();
    34a6:	e8 1b 03 00 00       	call   37c6 <exit>
  }
  close(open("usertests.ran", O_CREATE));
    34ab:	83 ec 08             	sub    $0x8,%esp
    34ae:	68 00 02 00 00       	push   $0x200
    34b3:	68 ca 4b 00 00       	push   $0x4bca
    34b8:	e8 49 03 00 00       	call   3806 <open>
    34bd:	89 04 24             	mov    %eax,(%esp)
    34c0:	e8 29 03 00 00       	call   37ee <close>
  ...
  exit();
    3574:	e8 4d 02 00 00       	call   37c6 <exit>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    363c:	50                   	push   %eax
    363d:	6a 00                	push   $0x0
    363f:	e8 9a 01 00 00       	call   37de <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    367d:	e8 84 01 00 00       	call   3806 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    3691:	50                   	push   %eax
    3692:	e8 87 01 00 00       	call   381e <fstat>
    3697:	89 c6                	mov    %eax,%esi
  close(fd);
    3699:	89 1c 24             	mov    %ebx,(%esp)
    369c:	e8 4d 01 00 00       	call   37ee <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
    ...
    376a:	e8 d2 03 00 00       	call   3b41 <malloc>
    oldstack = stack;
    while((int)stack % PGSIZE !=0){
    376f:	83 c4 10             	add    $0x10,%esp
    stack = malloc(PGSIZE*2 + sizeof(uint));
    3772:	89 c2                	mov    %eax,%edx
    while((int)stack % PGSIZE !=0){
    3774:	eb 03                	jmp    3779 <thread_create+0x1a>
      stack += 1;
    3776:	83 c2 01             	add    $0x1,%edx
    while((int)stack % PGSIZE !=0){
    3779:	f7 c2 ff 0f 00 00    	test   $0xfff,%edx
    377f:	75 f5                	jne    3776 <thread_create+0x17>
    }
    *(uint*)stack = (uint)oldstack;
    3781:	89 02                	mov    %eax,(%edx)
    stack += sizeof(uint);
    3783:	83 c2 04             	add    $0x4,%edx
   /* int extra;
    ...
    3786:	52                   	push   %edx
    3787:	ff 75 10             	push   0x10(%ebp)
    378a:	ff 75 0c             	push   0xc(%ebp)
    378d:	ff 75 08             	push   0x8(%ebp)
    3790:	e8 d1 00 00 00       	call   3866 <clone>
...
00003797 <thread_join>:
int 
thread_join(){
    3797:	55                   	push   %ebp
    3798:	89 e5                	mov    %esp,%ebp
    379a:	53                   	push   %ebx
    379b:	83 ec 20             	sub    $0x20,%esp
  void *newStack;
  int waitedForPID = join(&newStack);
    379e:	8d 45 f4             	lea    -0xc(%ebp),%eax
    37a1:	50                   	push   %eax
    37a2:	e8 c7 00 00 00       	call   386e <join>
    37a7:	89 c3                	mov    %eax,%ebx
  void *stack = *(void**)(newStack-sizeof(uint));
  free(stack);
    37a9:	83 c4 04             	add    $0x4,%esp
    37ac:	8b 45 f4             	mov    -0xc(%ebp),%eax
    37af:	ff 70 fc             	push   -0x4(%eax)
    37b2:	e8 ca 02 00 00       	call   3a81 <free>
  return waitedForPID;
    37b7:	89 d8                	mov    %ebx,%eax
    37b9:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    37bc:	c9                   	leave  
    37bd:	c3                   	ret    
...
SYSCALL(fork)
    37be:	b8 01 00 00 00       	mov    $0x1,%eax
    37c3:	cd 40                	int    $0x40
    37c5:	c3                   	ret    

000037c6 <exit>:
SYSCALL(exit)
    37c6:	b8 02 00 00 00       	mov    $0x2,%eax
    37cb:	cd 40                	int    $0x40
    37cd:	c3                   	ret    

000037ce <wait>:
SYSCALL(wait)
    37ce:	b8 03 00 00 00       	mov    $0x3,%eax
    37d3:	cd 40                	int    $0x40
    37d5:	c3                   	ret    

000037d6 <pipe>:
SYSCALL(pipe)
    37d6:	b8 04 00 00 00       	mov    $0x4,%eax
    37db:	cd 40                	int    $0x40
    37dd:	c3                   	ret    

000037de <read>:
SYSCALL(read)
    37de:	b8 05 00 00 00       	mov    $0x5,%eax
    37e3:	cd 40                	int    $0x40
    37e5:	c3                   	ret    

000037e6 <write>:
SYSCALL(write)
    37e6:	b8 10 00 00 00       	mov    $0x10,%eax
    37eb:	cd 40                	int    $0x40
    37ed:	c3                   	ret    

000037ee <close>:
SYSCALL(close)
    37ee:	b8 15 00 00 00       	mov    $0x15,%eax
    37f3:	cd 40                	int    $0x40
    37f5:	c3                   	ret    

000037f6 <kill>:
SYSCALL(kill)
    37f6:	b8 06 00 00 00       	mov    $0x6,%eax
    37fb:	cd 40                	int    $0x40
    37fd:	c3                   	ret    

000037fe <exec>:
SYSCALL(exec)
    37fe:	b8 07 00 00 00       	mov    $0x7,%eax
    3803:	cd 40                	int    $0x40
    3805:	c3                   	ret    

00003806 <open>:
SYSCALL(open)
    3806:	b8 0f 00 00 00       	mov    $0xf,%eax
    380b:	cd 40                	int    $0x40
    380d:	c3                   	ret    

0000380e <mknod>:
SYSCALL(mknod)
    380e:	b8 11 00 00 00       	mov    $0x11,%eax
    3813:	cd 40                	int    $0x40
    3815:	c3                   	ret    

00003816 <unlink>:
SYSCALL(unlink)
    3816:	b8 12 00 00 00       	mov    $0x12,%eax
    381b:	cd 40                	int    $0x40
    381d:	c3                   	ret    

0000381e <fstat>:
SYSCALL(fstat)
    381e:	b8 08 00 00 00       	mov    $0x8,%eax
    3823:	cd 40                	int    $0x40
    3825:	c3                   	ret    

00003826 <link>:
SYSCALL(link)
    3826:	b8 13 00 00 00       	mov    $0x13,%eax
    382b:	cd 40                	int    $0x40
    382d:	c3                   	ret    

0000382e <mkdir>:
SYSCALL(mkdir)
    382e:	b8 14 00 00 00       	mov    $0x14,%eax
    3833:	cd 40                	int    $0x40
    3835:	c3                   	ret    

00003836 <chdir>:
SYSCALL(chdir)
    3836:	b8 09 00 00 00       	mov    $0x9,%eax
    383b:	cd 40                	int    $0x40
    383d:	c3                   	ret    

0000383e <dup>:
SYSCALL(dup)
    383e:	b8 0a 00 00 00       	mov    $0xa,%eax
    3843:	cd 40                	int    $0x40
    3845:	c3                   	ret    

00003846 <getpid>:
SYSCALL(getpid)
    3846:	b8 0b 00 00 00       	mov    $0xb,%eax
    384b:	cd 40                	int    $0x40
    384d:	c3                   	ret    

0000384e <sbrk>:
SYSCALL(sbrk)
    384e:	b8 0c 00 00 00       	mov    $0xc,%eax
    3853:	cd 40                	int    $0x40
    3855:	c3                   	ret    

00003856 <sleep>:
SYSCALL(sleep)
    3856:	b8 0d 00 00 00       	mov    $0xd,%eax
    385b:	cd 40                	int    $0x40
    385d:	c3                   	ret    

0000385e <uptime>:
SYSCALL(uptime)
    385e:	b8 0e 00 00 00       	mov    $0xe,%eax
    3863:	cd 40                	int    $0x40
    3865:	c3                   	ret    

00003866 <clone>:
SYSCALL(clone)
    3866:	b8 16 00 00 00       	mov    $0x16,%eax
    386b:	cd 40                	int    $0x40
    386d:	c3                   	ret    

0000386e <join>:
SYSCALL(join)
    386e:	b8 17 00 00 00       	mov    $0x17,%eax
    3873:	cd 40                	int    $0x40
    3875:	c3                   	ret    
...
{
    3876:	55                   	push   %ebp
    3877:	89 e5                	mov    %esp,%ebp
    3879:	83 ec 1c             	sub    $0x1c,%esp
    387c:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
    387f:	6a 01                	push   $0x1
    3881:	8d 55 f4             	lea    -0xc(%ebp),%edx
    3884:	52                   	push   %edx
    3885:	50                   	push   %eax
    3886:	e8 5b ff ff ff       	call   37e6 <write>
}
    388b:	83 c4 10             	add    $0x10,%esp
    388e:	c9                   	leave  
    388f:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    3894:	56                   	push   %esi
    3895:	53                   	push   %ebx
    3896:	83 ec 2c             	sub    $0x2c,%esp
    3899:	89 45 d0             	mov    %eax,-0x30(%ebp)
    389c:	89 d0                	mov    %edx,%eax
    389e:	89 ce                	mov    %ecx,%esi
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    38a0:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
    38a4:	0f 95 c1             	setne  %cl
    38a7:	c1 ea 1f             	shr    $0x1f,%edx
    38aa:	84 d1                	test   %dl,%cl
    38ac:	74 44                	je     38f2 <printint+0x62>
    neg = 1;
    x = -xx;
    38ae:	f7 d8                	neg    %eax
    38b0:	89 c1                	mov    %eax,%ecx
    neg = 1;
    38b2:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
    38b9:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
    38be:	89 c8                	mov    %ecx,%eax
    38c0:	ba 00 00 00 00       	mov    $0x0,%edx
    38c5:	f7 f6                	div    %esi
    38c7:	89 df                	mov    %ebx,%edi
    38c9:	83 c3 01             	add    $0x1,%ebx
    38cc:	0f b6 92 c0 53 00 00 	movzbl 0x53c0(%edx),%edx
    38d3:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
    38d7:	89 ca                	mov    %ecx,%edx
    38d9:	89 c1                	mov    %eax,%ecx
    38db:	39 d6                	cmp    %edx,%esi
    38dd:	76 df                	jbe    38be <printint+0x2e>
  if(neg)
    38df:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
    38e3:	74 31                	je     3916 <printint+0x86>
    buf[i++] = '-';
    38e5:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
    38ea:	8d 5f 02             	lea    0x2(%edi),%ebx
    38ed:	8b 75 d0             	mov    -0x30(%ebp),%esi
    38f0:	eb 17                	jmp    3909 <printint+0x79>
    x = xx;
    38f2:	89 c1                	mov    %eax,%ecx
  neg = 0;
    38f4:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
    38fb:	eb bc                	jmp    38b9 <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
    38fd:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
    3902:	89 f0                	mov    %esi,%eax
    3904:	e8 6d ff ff ff       	call   3876 <putc>
  while(--i >= 0)
    3909:	83 eb 01             	sub    $0x1,%ebx
    390c:	79 ef                	jns    38fd <printint+0x6d>
}
    ...
    3919:	eb ee                	jmp    3909 <printint+0x79>
...
{
    391b:	55                   	push   %ebp
    391c:	89 e5                	mov    %esp,%ebp
    391e:	57                   	push   %edi
    391f:	56                   	push   %esi
    3920:	53                   	push   %ebx
    3921:	83 ec 1c             	sub    $0x1c,%esp
  char *s;
  int c, i, state;
  uint *ap;
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
    3924:	8d 45 10             	lea    0x10(%ebp),%eax
    3927:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
    392a:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
    392f:	bb 00 00 00 00       	mov    $0x0,%ebx
    3934:	eb 14                	jmp    394a <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
    3936:	89 fa                	mov    %edi,%edx
    3938:	8b 45 08             	mov    0x8(%ebp),%eax
    393b:	e8 36 ff ff ff       	call   3876 <putc>
    3940:	eb 05                	jmp    3947 <printf+0x2c>
      }
    } else if(state == '%'){
    3942:	83 fe 25             	cmp    $0x25,%esi
    3945:	74 25                	je     396c <printf+0x51>
  for(i = 0; fmt[i]; i++){
    3947:	83 c3 01             	add    $0x1,%ebx
    394a:	8b 45 0c             	mov    0xc(%ebp),%eax
    394d:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
    3951:	84 c0                	test   %al,%al
    3953:	0f 84 20 01 00 00    	je     3a79 <printf+0x15e>
    c = fmt[i] & 0xff;
    3959:	0f be f8             	movsbl %al,%edi
    395c:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
    395f:	85 f6                	test   %esi,%esi
    3961:	75 df                	jne    3942 <printf+0x27>
      if(c == '%'){
    3963:	83 f8 25             	cmp    $0x25,%eax
    3966:	75 ce                	jne    3936 <printf+0x1b>
        state = '%';
    3968:	89 c6                	mov    %eax,%esi
    396a:	eb db                	jmp    3947 <printf+0x2c>
      if(c == 'd'){
    396c:	83 f8 25             	cmp    $0x25,%eax
    396f:	0f 84 cf 00 00 00    	je     3a44 <printf+0x129>
    3975:	0f 8c dd 00 00 00    	jl     3a58 <printf+0x13d>
    397b:	83 f8 78             	cmp    $0x78,%eax
    397e:	0f 8f d4 00 00 00    	jg     3a58 <printf+0x13d>
    3984:	83 f8 63             	cmp    $0x63,%eax
    3987:	0f 8c cb 00 00 00    	jl     3a58 <printf+0x13d>
    398d:	83 e8 63             	sub    $0x63,%eax
    3990:	83 f8 15             	cmp    $0x15,%eax
    3993:	0f 87 bf 00 00 00    	ja     3a58 <printf+0x13d>
    3999:	ff 24 85 68 53 00 00 	jmp    *0x5368(,%eax,4)
        printint(fd, *ap, 10, 1);
    39a0:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    39a3:	8b 17                	mov    (%edi),%edx
    39a5:	83 ec 0c             	sub    $0xc,%esp
    39a8:	6a 01                	push   $0x1
    39aa:	b9 0a 00 00 00       	mov    $0xa,%ecx
    39af:	8b 45 08             	mov    0x8(%ebp),%eax
    39b2:	e8 d9 fe ff ff       	call   3890 <printint>
        ap++;
    ...
    39c5:	eb 80                	jmp    3947 <printf+0x2c>
        printint(fd, *ap, 16, 0);
    39c7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    39ca:	8b 17                	mov    (%edi),%edx
    39cc:	83 ec 0c             	sub    $0xc,%esp
    39cf:	6a 00                	push   $0x0
    39d1:	b9 10 00 00 00       	mov    $0x10,%ecx
    39d6:	8b 45 08             	mov    0x8(%ebp),%eax
    39d9:	e8 b2 fe ff ff       	call   3890 <printint>
        ap++;
    39de:	83 c7 04             	add    $0x4,%edi
    39e1:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    39e4:	83 c4 10             	add    $0x10,%esp
      state = 0;
    39e7:	be 00 00 00 00       	mov    $0x0,%esi
    39ec:	e9 56 ff ff ff       	jmp    3947 <printf+0x2c>
        s = (char*)*ap;
    39f1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    39f4:	8b 30                	mov    (%eax),%esi
        ap++;
    39f6:	83 c0 04             	add    $0x4,%eax
    39f9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
    39fc:	85 f6                	test   %esi,%esi
    39fe:	75 15                	jne    3a15 <printf+0xfa>
          s = "(null)";
    3a00:	be 5e 53 00 00       	mov    $0x535e,%esi
    3a05:	eb 0e                	jmp    3a15 <printf+0xfa>
          putc(fd, *s);
    3a07:	0f be d2             	movsbl %dl,%edx
    3a0a:	8b 45 08             	mov    0x8(%ebp),%eax
    3a0d:	e8 64 fe ff ff       	call   3876 <putc>
          s++;
    3a12:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
    3a15:	0f b6 16             	movzbl (%esi),%edx
    3a18:	84 d2                	test   %dl,%dl
    3a1a:	75 eb                	jne    3a07 <printf+0xec>
      state = 0;
    3a1c:	be 00 00 00 00       	mov    $0x0,%esi
    3a21:	e9 21 ff ff ff       	jmp    3947 <printf+0x2c>
        putc(fd, *ap);
    3a26:	8b 7d e4             	mov    -0x1c(%ebp),%edi
    3a29:	0f be 17             	movsbl (%edi),%edx
    3a2c:	8b 45 08             	mov    0x8(%ebp),%eax
    3a2f:	e8 42 fe ff ff       	call   3876 <putc>
        ap++;
    3a34:	83 c7 04             	add    $0x4,%edi
    3a37:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
    3a3a:	be 00 00 00 00       	mov    $0x0,%esi
    3a3f:	e9 03 ff ff ff       	jmp    3947 <printf+0x2c>
        putc(fd, c);
    3a44:	89 fa                	mov    %edi,%edx
    3a46:	8b 45 08             	mov    0x8(%ebp),%eax
    3a49:	e8 28 fe ff ff       	call   3876 <putc>
      state = 0;
    3a4e:	be 00 00 00 00       	mov    $0x0,%esi
    3a53:	e9 ef fe ff ff       	jmp    3947 <printf+0x2c>
        putc(fd, '%');
    3a58:	ba 25 00 00 00       	mov    $0x25,%edx
    3a5d:	8b 45 08             	mov    0x8(%ebp),%eax
    3a60:	e8 11 fe ff ff       	call   3876 <putc>
        putc(fd, c);
    3a65:	89 fa                	mov    %edi,%edx
    3a67:	8b 45 08             	mov    0x8(%ebp),%eax
    3a6a:	e8 07 fe ff ff       	call   3876 <putc>
      state = 0;
    3a6f:	be 00 00 00 00       	mov    $0x0,%esi
    3a74:	e9 ce fe ff ff       	jmp    3947 <printf+0x2c>
    }
  }
}
...
{
    3a81:	55                   	push   %ebp
    3a82:	89 e5                	mov    %esp,%ebp
    3a84:	57                   	push   %edi
    3a85:	56                   	push   %esi
    3a86:	53                   	push   %ebx
    3a87:	8b 5d 08             	mov    0x8(%ebp),%ebx
  Header *bp, *p;

  bp = (Header*)ap - 1;
    3a8a:	8d 4b f8             	lea    -0x8(%ebx),%ecx
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    3a8d:	a1 e0 a4 00 00       	mov    0xa4e0,%eax
    3a92:	eb 02                	jmp    3a96 <free+0x15>
    3a94:	89 d0                	mov    %edx,%eax
    3a96:	39 c8                	cmp    %ecx,%eax
    3a98:	73 04                	jae    3a9e <free+0x1d>
    3a9a:	39 08                	cmp    %ecx,(%eax)
    3a9c:	77 12                	ja     3ab0 <free+0x2f>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    3a9e:	8b 10                	mov    (%eax),%edx
    3aa0:	39 c2                	cmp    %eax,%edx
    3aa2:	77 f0                	ja     3a94 <free+0x13>
    3aa4:	39 c8                	cmp    %ecx,%eax
    3aa6:	72 08                	jb     3ab0 <free+0x2f>
    3aa8:	39 ca                	cmp    %ecx,%edx
    3aaa:	77 04                	ja     3ab0 <free+0x2f>
    3aac:	89 d0                	mov    %edx,%eax
    3aae:	eb e6                	jmp    3a96 <free+0x15>
      break;
  if(bp + bp->s.size == p->s.ptr){
    3ab0:	8b 73 fc             	mov    -0x4(%ebx),%esi
    3ab3:	8d 3c f1             	lea    (%ecx,%esi,8),%edi
    3ab6:	8b 10                	mov    (%eax),%edx
    3ab8:	39 d7                	cmp    %edx,%edi
    3aba:	74 19                	je     3ad5 <free+0x54>
  ...
  if(p + p->s.size == bp){
    3abf:	8b 50 04             	mov    0x4(%eax),%edx
    3ac2:	8d 34 d0             	lea    (%eax,%edx,8),%esi
    3ac5:	39 ce                	cmp    %ecx,%esi
    3ac7:	74 1b                	je     3ae4 <free+0x63>
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
    3ac9:	89 08                	mov    %ecx,(%eax)
  freep = p;
    3acb:	a3 e0 a4 00 00       	mov    %eax,0xa4e0
}
    3ad0:	5b                   	pop    %ebx
    3ad1:	5e                   	pop    %esi
    3ad2:	5f                   	pop    %edi
    ...
    3ad4:	c3                   	ret    
    bp->s.size += p->s.ptr->s.size;
    3ad5:	03 72 04             	add    0x4(%edx),%esi
    3ad8:	89 73 fc             	mov    %esi,-0x4(%ebx)
    bp->s.ptr = p->s.ptr->s.ptr;
    3adb:	8b 10                	mov    (%eax),%edx
    3add:	8b 12                	mov    (%edx),%edx
    3adf:	89 53 f8             	mov    %edx,-0x8(%ebx)
    3ae2:	eb db                	jmp    3abf <free+0x3e>
    p->s.size += bp->s.size;
    3ae4:	03 53 fc             	add    -0x4(%ebx),%edx
    3ae7:	89 50 04             	mov    %edx,0x4(%eax)
    p->s.ptr = bp->s.ptr;
    3aea:	8b 53 f8             	mov    -0x8(%ebx),%edx
    3aed:	89 10                	mov    %edx,(%eax)
    3aef:	eb da                	jmp    3acb <free+0x4a>
...
{
    3af1:	55                   	push   %ebp
    3af2:	89 e5                	mov    %esp,%ebp
    3af4:	53                   	push   %ebx
    3af5:	83 ec 04             	sub    $0x4,%esp
    3af8:	89 c3                	mov    %eax,%ebx
  char *p;
  Header *hp;

  if(nu < 4096)
    3afa:	3d ff 0f 00 00       	cmp    $0xfff,%eax
    3aff:	77 05                	ja     3b06 <morecore+0x15>
    nu = 4096;
    3b01:	bb 00 10 00 00       	mov    $0x1000,%ebx
  p = sbrk(nu * sizeof(Header));
    3b06:	8d 04 dd 00 00 00 00 	lea    0x0(,%ebx,8),%eax
    3b0d:	83 ec 0c             	sub    $0xc,%esp
    3b10:	50                   	push   %eax
    3b11:	e8 38 fd ff ff       	call   384e <sbrk>
  if(p == (char*)-1)
    3b16:	83 c4 10             	add    $0x10,%esp
    3b19:	83 f8 ff             	cmp    $0xffffffff,%eax
    3b1c:	74 1c                	je     3b3a <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
    3b1e:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    3b21:	83 c0 08             	add    $0x8,%eax
    3b24:	83 ec 0c             	sub    $0xc,%esp
    3b27:	50                   	push   %eax
    3b28:	e8 54 ff ff ff       	call   3a81 <free>
  return freep;
    3b2d:	a1 e0 a4 00 00       	mov    0xa4e0,%eax
    ...
    3b3f:	eb f4                	jmp    3b35 <morecore+0x44>
...
malloc(uint nbytes)
{
    ...
    3b44:	53                   	push   %ebx
    3b45:	83 ec 04             	sub    $0x4,%esp
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    3b48:	8b 45 08             	mov    0x8(%ebp),%eax
    3b4b:	8d 58 07             	lea    0x7(%eax),%ebx
    3b4e:	c1 eb 03             	shr    $0x3,%ebx
    3b51:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
    3b54:	8b 0d e0 a4 00 00    	mov    0xa4e0,%ecx
    3b5a:	85 c9                	test   %ecx,%ecx
    3b5c:	74 04                	je     3b62 <malloc+0x21>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3b5e:	8b 01                	mov    (%ecx),%eax
    3b60:	eb 4a                	jmp    3bac <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
    3b62:	c7 05 e0 a4 00 00 e4 	movl   $0xa4e4,0xa4e0
    3b69:	a4 00 00 
    3b6c:	c7 05 e4 a4 00 00 e4 	movl   $0xa4e4,0xa4e4
    3b73:	a4 00 00 
    base.s.size = 0;
    3b76:	c7 05 e8 a4 00 00 00 	movl   $0x0,0xa4e8
    3b7d:	00 00 00 
    base.s.ptr = freep = prevp = &base;
    3b80:	b9 e4 a4 00 00       	mov    $0xa4e4,%ecx
    3b85:	eb d7                	jmp    3b5e <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
    3b87:	74 19                	je     3ba2 <malloc+0x61>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
    3b89:	29 da                	sub    %ebx,%edx
    3b8b:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
    3b8e:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
    3b91:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
    3b94:	89 0d e0 a4 00 00    	mov    %ecx,0xa4e0
      return (void*)(p + 1);
    3b9a:	83 c0 08             	add    $0x8,%eax
    }
    if(p == freep)
    ...
    3b9d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    3ba0:	c9                   	leave  
    3ba1:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
    3ba2:	8b 10                	mov    (%eax),%edx
    3ba4:	89 11                	mov    %edx,(%ecx)
    3ba6:	eb ec                	jmp    3b94 <malloc+0x53>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    3ba8:	89 c1                	mov    %eax,%ecx
    3baa:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
    3bac:	8b 50 04             	mov    0x4(%eax),%edx
    3baf:	39 da                	cmp    %ebx,%edx
    3bb1:	73 d4                	jae    3b87 <malloc+0x46>
    if(p == freep)
    3bb3:	39 05 e0 a4 00 00    	cmp    %eax,0xa4e0
    3bb9:	75 ed                	jne    3ba8 <malloc+0x67>
      if((p = morecore(nunits)) == 0)
    3bbb:	89 d8                	mov    %ebx,%eax
    3bbd:	e8 2f ff ff ff       	call   3af1 <morecore>
    3bc2:	85 c0                	test   %eax,%eax
    3bc4:	75 e2                	jne    3ba8 <malloc+0x67>
    3bc6:	eb d5                	jmp    3b9d <malloc+0x5c>
