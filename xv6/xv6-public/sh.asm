...
getcmd(char *buf, int nbuf)
{
  ...
  13:	6a 02                	push   $0x2
  15:	e8 37 0d 00 00       	call   d51 <printf>
  memset(buf, 0, nbuf);
...
panic(char *s)
{
  ...
  59:	6a 02                	push   $0x2
  5b:	e8 f1 0c 00 00       	call   d51 <printf>
  exit();
  60:	e8 97 0b 00 00       	call   bfc <exit>
...
fork1(void)
{
  ...
  pid = fork();
  6b:	e8 84 0b 00 00       	call   bf4 <fork>
  if(pid == -1)
...
00000084 <runcmd>:
{
  ...
  99:	ff 24 85 b8 10 00 00 	jmp    *0x10b8(,%eax,4)
    exit();
  a0:	e8 57 0b 00 00       	call   bfc <exit>
    panic("runcmd");
 ...
 11b:	6a 02                	push   $0x2
 11d:	e8 2f 0c 00 00       	call   d51 <printf>
      exit();
 122:	e8 d5 0a 00 00       	call   bfc <exit>
    if(fork1() == 0)
 127:	e8 39 ff ff ff       	call   65 <fork1>
 12c:	85 c0                	test   %eax,%eax
 12e:	74 10                	je     140 <runcmd+0xbc>
    wait();
 130:	e8 cf 0a 00 00       	call   c04 <wait>
    runcmd(lcmd->right);
 ...
 151:	50                   	push   %eax
 152:	e8 b5 0a 00 00       	call   c0c <pipe>
 ...
 176:	e8 a9 0a 00 00       	call   c24 <close>
    close(p[1]);
 17b:	83 c4 04             	add    $0x4,%esp
 17e:	ff 75 f4             	push   -0xc(%ebp)
 181:	e8 9e 0a 00 00       	call   c24 <close>
    wait();
 186:	e8 79 0a 00 00       	call   c04 <wait>
    wait();
 18b:	e8 74 0a 00 00       	call   c04 <wait>
    break;
...
execcmd(void)
{
 ...
 230:	6a 54                	push   $0x54
 232:	e8 40 0d 00 00       	call   f77 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
 ...
 257:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 25a:	6a 18                	push   $0x18
 25c:	e8 16 0d 00 00       	call   f77 <malloc>
...
pipecmd(struct cmd *left, struct cmd *right)
{
 ...
 29f:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2a2:	6a 0c                	push   $0xc
 2a4:	e8 ce 0c 00 00       	call   f77 <malloc>
...
listcmd(struct cmd *left, struct cmd *right)
{
 ...
 2d5:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 2d8:	6a 0c                	push   $0xc
 2da:	e8 98 0c 00 00       	call   f77 <malloc>
...
backcmd(struct cmd *subcmd)
{
 ...
 30b:	83 ec 10             	sub    $0x10,%esp
  ...
  cmd = malloc(sizeof(*cmd));
 30e:	6a 08                	push   $0x8
 310:	e8 62 0c 00 00       	call   f77 <malloc>
...
00000870 <parsecmd>:
{
 ...
 8c9:	6a 02                	push   $0x2
 8cb:	e8 81 04 00 00       	call   d51 <printf>
    panic("syntax");
...
000008dc <main>:
{
 ...
 8f7:	e8 40 03 00 00       	call   c3c <open>
 ...
 90b:	50                   	push   %eax
 90c:	e8 13 03 00 00       	call   c24 <close>
      break;
 ...
 91d:	74 76                	je     995 <main+0xb9>
    wait();
 91f:	e8 e0 02 00 00       	call   c04 <wait>
 ...
 970:	e8 f7 02 00 00       	call   c6c <chdir>
 ...
 989:	6a 02                	push   $0x2
 98b:	e8 c1 03 00 00       	call   d51 <printf>
 ...
 9a5:	e8 da f6 ff ff       	call   84 <runcmd>
  exit();
 9aa:	e8 4d 02 00 00       	call   bfc <exit>
...
gets(char *buf, int max)
{
 ...
 a72:	50                   	push   %eax
 a73:	6a 00                	push   $0x0
 a75:	e8 9a 01 00 00       	call   c14 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 ab3:	e8 84 01 00 00       	call   c3c <open>
  if(fd < 0)
 ...
 ac7:	50                   	push   %eax
 ac8:	e8 87 01 00 00       	call   c54 <fstat>
 acd:	89 c6                	mov    %eax,%esi
  close(fd);
 acf:	89 1c 24             	mov    %ebx,(%esp)
 ad2:	e8 4d 01 00 00       	call   c24 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 ba0:	e8 d2 03 00 00       	call   f77 <malloc>
    oldstack = stack;
 ...
 ba8:	89 c2                	mov    %eax,%edx
    while((int)stack % PGSIZE !=0){
 baa:	eb 03                	jmp    baf <thread_create+0x1a>
      stack += 1;
 bac:	83 c2 01             	add    $0x1,%edx
    while((int)stack % PGSIZE !=0){
 baf:	f7 c2 ff 0f 00 00    	test   $0xfff,%edx
 bb5:	75 f5                	jne    bac <thread_create+0x17>
    }
    *(uint*)stack = (uint)oldstack;
 bb7:	89 02                	mov    %eax,(%edx)
    stack += sizeof(uint);
 bb9:	83 c2 04             	add    $0x4,%edx
   /* int extra;
 ...
 bbc:	52                   	push   %edx
 bbd:	ff 75 10             	push   0x10(%ebp)
 bc0:	ff 75 0c             	push   0xc(%ebp)
 bc3:	ff 75 08             	push   0x8(%ebp)
 bc6:	e8 d1 00 00 00       	call   c9c <clone>
...
00000bcd <thread_join>:
int 
thread_join(){
 bcd:	55                   	push   %ebp
 bce:	89 e5                	mov    %esp,%ebp
 bd0:	53                   	push   %ebx
 bd1:	83 ec 20             	sub    $0x20,%esp
  void *newStack;
  int waitedForPID = join(&newStack);
 bd4:	8d 45 f4             	lea    -0xc(%ebp),%eax
 bd7:	50                   	push   %eax
 bd8:	e8 c7 00 00 00       	call   ca4 <join>
 bdd:	89 c3                	mov    %eax,%ebx
  void *stack = *(void**)(newStack-sizeof(uint));
  free(stack);
 bdf:	83 c4 04             	add    $0x4,%esp
 be2:	8b 45 f4             	mov    -0xc(%ebp),%eax
 be5:	ff 70 fc             	push   -0x4(%eax)
 be8:	e8 ca 02 00 00       	call   eb7 <free>
  return waitedForPID;
...
00000bfc <exit>:
SYSCALL(exit)
 bfc:	b8 02 00 00 00       	mov    $0x2,%eax
 c01:	cd 40                	int    $0x40
 c03:	c3                   	ret    

00000c04 <wait>:
SYSCALL(wait)
 c04:	b8 03 00 00 00       	mov    $0x3,%eax
 c09:	cd 40                	int    $0x40
 c0b:	c3                   	ret    

00000c0c <pipe>:
SYSCALL(pipe)
 c0c:	b8 04 00 00 00       	mov    $0x4,%eax
 c11:	cd 40                	int    $0x40
 c13:	c3                   	ret    

00000c14 <read>:
SYSCALL(read)
 c14:	b8 05 00 00 00       	mov    $0x5,%eax
 c19:	cd 40                	int    $0x40
 c1b:	c3                   	ret    

00000c1c <write>:
SYSCALL(write)
 c1c:	b8 10 00 00 00       	mov    $0x10,%eax
 c21:	cd 40                	int    $0x40
 c23:	c3                   	ret    

00000c24 <close>:
SYSCALL(close)
 c24:	b8 15 00 00 00       	mov    $0x15,%eax
 c29:	cd 40                	int    $0x40
 c2b:	c3                   	ret    

00000c2c <kill>:
SYSCALL(kill)
 c2c:	b8 06 00 00 00       	mov    $0x6,%eax
 c31:	cd 40                	int    $0x40
 c33:	c3                   	ret    

00000c34 <exec>:
SYSCALL(exec)
 c34:	b8 07 00 00 00       	mov    $0x7,%eax
 c39:	cd 40                	int    $0x40
 c3b:	c3                   	ret    

00000c3c <open>:
SYSCALL(open)
 c3c:	b8 0f 00 00 00       	mov    $0xf,%eax
 c41:	cd 40                	int    $0x40
 c43:	c3                   	ret    

00000c44 <mknod>:
SYSCALL(mknod)
 c44:	b8 11 00 00 00       	mov    $0x11,%eax
 c49:	cd 40                	int    $0x40
 c4b:	c3                   	ret    

00000c4c <unlink>:
SYSCALL(unlink)
 c4c:	b8 12 00 00 00       	mov    $0x12,%eax
 c51:	cd 40                	int    $0x40
 c53:	c3                   	ret    

00000c54 <fstat>:
SYSCALL(fstat)
 c54:	b8 08 00 00 00       	mov    $0x8,%eax
 c59:	cd 40                	int    $0x40
 c5b:	c3                   	ret    

00000c5c <link>:
SYSCALL(link)
 c5c:	b8 13 00 00 00       	mov    $0x13,%eax
 c61:	cd 40                	int    $0x40
 c63:	c3                   	ret    

00000c64 <mkdir>:
SYSCALL(mkdir)
 c64:	b8 14 00 00 00       	mov    $0x14,%eax
 c69:	cd 40                	int    $0x40
 c6b:	c3                   	ret    

00000c6c <chdir>:
SYSCALL(chdir)
 c6c:	b8 09 00 00 00       	mov    $0x9,%eax
 c71:	cd 40                	int    $0x40
 c73:	c3                   	ret    

00000c74 <dup>:
SYSCALL(dup)
 c74:	b8 0a 00 00 00       	mov    $0xa,%eax
 c79:	cd 40                	int    $0x40
 c7b:	c3                   	ret    

00000c7c <getpid>:
SYSCALL(getpid)
 c7c:	b8 0b 00 00 00       	mov    $0xb,%eax
 c81:	cd 40                	int    $0x40
 c83:	c3                   	ret    

00000c84 <sbrk>:
SYSCALL(sbrk)
 c84:	b8 0c 00 00 00       	mov    $0xc,%eax
 c89:	cd 40                	int    $0x40
 c8b:	c3                   	ret    

00000c8c <sleep>:
SYSCALL(sleep)
 c8c:	b8 0d 00 00 00       	mov    $0xd,%eax
 c91:	cd 40                	int    $0x40
 c93:	c3                   	ret    

00000c94 <uptime>:
SYSCALL(uptime)
 c94:	b8 0e 00 00 00       	mov    $0xe,%eax
 c99:	cd 40                	int    $0x40
 c9b:	c3                   	ret    

00000c9c <clone>:
SYSCALL(clone)
 c9c:	b8 16 00 00 00       	mov    $0x16,%eax
 ca1:	cd 40                	int    $0x40
 ca3:	c3                   	ret    

00000ca4 <join>:
SYSCALL(join)
 ca4:	b8 17 00 00 00       	mov    $0x17,%eax
 ca9:	cd 40                	int    $0x40
 cab:	c3                   	ret    
...
putc(int fd, char c)
{
 ...
 cb2:	88 55 f4             	mov    %dl,-0xc(%ebp)
  write(fd, &c, 1);
 cb5:	6a 01                	push   $0x1
 cb7:	8d 55 f4             	lea    -0xc(%ebp),%edx
 cba:	52                   	push   %edx
 cbb:	50                   	push   %eax
 cbc:	e8 5b ff ff ff       	call   c1c <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 cca:	56                   	push   %esi
 ccb:	53                   	push   %ebx
 ccc:	83 ec 2c             	sub    $0x2c,%esp
 ccf:	89 45 d0             	mov    %eax,-0x30(%ebp)
 cd2:	89 d0                	mov    %edx,%eax
 cd4:	89 ce                	mov    %ecx,%esi
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
 cd6:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
 cda:	0f 95 c1             	setne  %cl
 cdd:	c1 ea 1f             	shr    $0x1f,%edx
 ce0:	84 d1                	test   %dl,%cl
 ce2:	74 44                	je     d28 <printint+0x62>
    neg = 1;
    x = -xx;
 ce4:	f7 d8                	neg    %eax
 ce6:	89 c1                	mov    %eax,%ecx
    neg = 1;
 ce8:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)
  } else {
    x = xx;
  }

  i = 0;
 cef:	bb 00 00 00 00       	mov    $0x0,%ebx
  do{
    buf[i++] = digits[x % base];
 cf4:	89 c8                	mov    %ecx,%eax
 cf6:	ba 00 00 00 00       	mov    $0x0,%edx
 cfb:	f7 f6                	div    %esi
 cfd:	89 df                	mov    %ebx,%edi
 cff:	83 c3 01             	add    $0x1,%ebx
 d02:	0f b6 92 48 11 00 00 	movzbl 0x1148(%edx),%edx
 d09:	88 54 3d d8          	mov    %dl,-0x28(%ebp,%edi,1)
  }while((x /= base) != 0);
 d0d:	89 ca                	mov    %ecx,%edx
 d0f:	89 c1                	mov    %eax,%ecx
 d11:	39 d6                	cmp    %edx,%esi
 d13:	76 df                	jbe    cf4 <printint+0x2e>
  if(neg)
 d15:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
 d19:	74 31                	je     d4c <printint+0x86>
    buf[i++] = '-';
 d1b:	c6 44 1d d8 2d       	movb   $0x2d,-0x28(%ebp,%ebx,1)
 d20:	8d 5f 02             	lea    0x2(%edi),%ebx
 d23:	8b 75 d0             	mov    -0x30(%ebp),%esi
 d26:	eb 17                	jmp    d3f <printint+0x79>
    x = xx;
 d28:	89 c1                	mov    %eax,%ecx
  neg = 0;
 d2a:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
 d31:	eb bc                	jmp    cef <printint+0x29>

  while(--i >= 0)
    putc(fd, buf[i]);
 d33:	0f be 54 1d d8       	movsbl -0x28(%ebp,%ebx,1),%edx
 d38:	89 f0                	mov    %esi,%eax
 d3a:	e8 6d ff ff ff       	call   cac <putc>
  while(--i >= 0)
 d3f:	83 eb 01             	sub    $0x1,%ebx
 d42:	79 ef                	jns    d33 <printint+0x6d>
}
 d44:	83 c4 2c             	add    $0x2c,%esp
 d47:	5b                   	pop    %ebx
 d48:	5e                   	pop    %esi
 d49:	5f                   	pop    %edi
 d4a:	5d                   	pop    %ebp
 d4b:	c3                   	ret    
 d4c:	8b 75 d0             	mov    -0x30(%ebp),%esi
 d4f:	eb ee                	jmp    d3f <printint+0x79>
...
printf(int fd, const char *fmt, ...)
{
 ...
 d57:	83 ec 1c             	sub    $0x1c,%esp
  ...
  state = 0;
  ap = (uint*)(void*)&fmt + 1;
 d5a:	8d 45 10             	lea    0x10(%ebp),%eax
 d5d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  state = 0;
 d60:	be 00 00 00 00       	mov    $0x0,%esi
  for(i = 0; fmt[i]; i++){
 d65:	bb 00 00 00 00       	mov    $0x0,%ebx
 d6a:	eb 14                	jmp    d80 <printf+0x2f>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
        ...
        putc(fd, c);
 d6c:	89 fa                	mov    %edi,%edx
 d6e:	8b 45 08             	mov    0x8(%ebp),%eax
 d71:	e8 36 ff ff ff       	call   cac <putc>
 d76:	eb 05                	jmp    d7d <printf+0x2c>
      }
    } else if(state == '%'){
 d78:	83 fe 25             	cmp    $0x25,%esi
 d7b:	74 25                	je     da2 <printf+0x51>
  for(i = 0; fmt[i]; i++){
 d7d:	83 c3 01             	add    $0x1,%ebx
 d80:	8b 45 0c             	mov    0xc(%ebp),%eax
 d83:	0f b6 04 18          	movzbl (%eax,%ebx,1),%eax
 d87:	84 c0                	test   %al,%al
 d89:	0f 84 20 01 00 00    	je     eaf <printf+0x15e>
    c = fmt[i] & 0xff;
 d8f:	0f be f8             	movsbl %al,%edi
 d92:	0f b6 c0             	movzbl %al,%eax
    if(state == 0){
 d95:	85 f6                	test   %esi,%esi
 d97:	75 df                	jne    d78 <printf+0x27>
      if(c == '%'){
 d99:	83 f8 25             	cmp    $0x25,%eax
 d9c:	75 ce                	jne    d6c <printf+0x1b>
        state = '%';
 d9e:	89 c6                	mov    %eax,%esi
 da0:	eb db                	jmp    d7d <printf+0x2c>
      if(c == 'd'){
 da2:	83 f8 25             	cmp    $0x25,%eax
 da5:	0f 84 cf 00 00 00    	je     e7a <printf+0x129>
 dab:	0f 8c dd 00 00 00    	jl     e8e <printf+0x13d>
 db1:	83 f8 78             	cmp    $0x78,%eax
 db4:	0f 8f d4 00 00 00    	jg     e8e <printf+0x13d>
 dba:	83 f8 63             	cmp    $0x63,%eax
 dbd:	0f 8c cb 00 00 00    	jl     e8e <printf+0x13d>
 dc3:	83 e8 63             	sub    $0x63,%eax
 dc6:	83 f8 15             	cmp    $0x15,%eax
 dc9:	0f 87 bf 00 00 00    	ja     e8e <printf+0x13d>
 dcf:	ff 24 85 f0 10 00 00 	jmp    *0x10f0(,%eax,4)
        printint(fd, *ap, 10, 1);
 dd6:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 dd9:	8b 17                	mov    (%edi),%edx
 ddb:	83 ec 0c             	sub    $0xc,%esp
 dde:	6a 01                	push   $0x1
 de0:	b9 0a 00 00 00       	mov    $0xa,%ecx
 de5:	8b 45 08             	mov    0x8(%ebp),%eax
 de8:	e8 d9 fe ff ff       	call   cc6 <printint>
        ap++;
 ...
 dfb:	eb 80                	jmp    d7d <printf+0x2c>
        printint(fd, *ap, 16, 0);
 dfd:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 e00:	8b 17                	mov    (%edi),%edx
 e02:	83 ec 0c             	sub    $0xc,%esp
 e05:	6a 00                	push   $0x0
 e07:	b9 10 00 00 00       	mov    $0x10,%ecx
 e0c:	8b 45 08             	mov    0x8(%ebp),%eax
 e0f:	e8 b2 fe ff ff       	call   cc6 <printint>
        ap++;
 e14:	83 c7 04             	add    $0x4,%edi
 e17:	89 7d e4             	mov    %edi,-0x1c(%ebp)
 e1a:	83 c4 10             	add    $0x10,%esp
      state = 0;
 e1d:	be 00 00 00 00       	mov    $0x0,%esi
 e22:	e9 56 ff ff ff       	jmp    d7d <printf+0x2c>
        s = (char*)*ap;
 e27:	8b 45 e4             	mov    -0x1c(%ebp),%eax
 e2a:	8b 30                	mov    (%eax),%esi
        ap++;
 e2c:	83 c0 04             	add    $0x4,%eax
 e2f:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        if(s == 0)
 e32:	85 f6                	test   %esi,%esi
 e34:	75 15                	jne    e4b <printf+0xfa>
          s = "(null)";
 e36:	be e8 10 00 00       	mov    $0x10e8,%esi
 e3b:	eb 0e                	jmp    e4b <printf+0xfa>
          putc(fd, *s);
 e3d:	0f be d2             	movsbl %dl,%edx
 e40:	8b 45 08             	mov    0x8(%ebp),%eax
 e43:	e8 64 fe ff ff       	call   cac <putc>
          s++;
 e48:	83 c6 01             	add    $0x1,%esi
        while(*s != 0){
 e4b:	0f b6 16             	movzbl (%esi),%edx
 e4e:	84 d2                	test   %dl,%dl
 e50:	75 eb                	jne    e3d <printf+0xec>
      state = 0;
 e52:	be 00 00 00 00       	mov    $0x0,%esi
 e57:	e9 21 ff ff ff       	jmp    d7d <printf+0x2c>
        putc(fd, *ap);
 e5c:	8b 7d e4             	mov    -0x1c(%ebp),%edi
 e5f:	0f be 17             	movsbl (%edi),%edx
 e62:	8b 45 08             	mov    0x8(%ebp),%eax
 e65:	e8 42 fe ff ff       	call   cac <putc>
        ap++;
 e6a:	83 c7 04             	add    $0x4,%edi
 e6d:	89 7d e4             	mov    %edi,-0x1c(%ebp)
      state = 0;
 e70:	be 00 00 00 00       	mov    $0x0,%esi
 e75:	e9 03 ff ff ff       	jmp    d7d <printf+0x2c>
        putc(fd, c);
 e7a:	89 fa                	mov    %edi,%edx
 e7c:	8b 45 08             	mov    0x8(%ebp),%eax
 e7f:	e8 28 fe ff ff       	call   cac <putc>
      state = 0;
 e84:	be 00 00 00 00       	mov    $0x0,%esi
 e89:	e9 ef fe ff ff       	jmp    d7d <printf+0x2c>
        putc(fd, '%');
 e8e:	ba 25 00 00 00       	mov    $0x25,%edx
 e93:	8b 45 08             	mov    0x8(%ebp),%eax
 e96:	e8 11 fe ff ff       	call   cac <putc>
        putc(fd, c);
 e9b:	89 fa                	mov    %edi,%edx
 e9d:	8b 45 08             	mov    0x8(%ebp),%eax
 ea0:	e8 07 fe ff ff       	call   cac <putc>
      state = 0;
 ea5:	be 00 00 00 00       	mov    $0x0,%esi
 eaa:	e9 ce fe ff ff       	jmp    d7d <printf+0x2c>
    }
  }
}
...
free(void *ap)
{
 ...
 ec3:	a1 04 18 00 00       	mov    0x1804,%eax
 ec8:	eb 02                	jmp    ecc <free+0x15>
 eca:	89 d0                	mov    %edx,%eax
 ecc:	39 c8                	cmp    %ecx,%eax
 ece:	73 04                	jae    ed4 <free+0x1d>
 ed0:	39 08                	cmp    %ecx,(%eax)
 ed2:	77 12                	ja     ee6 <free+0x2f>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 ed4:	8b 10                	mov    (%eax),%edx
 ed6:	39 c2                	cmp    %eax,%edx
 ed8:	77 f0                	ja     eca <free+0x13>
 eda:	39 c8                	cmp    %ecx,%eax
 edc:	72 08                	jb     ee6 <free+0x2f>
 ede:	39 ca                	cmp    %ecx,%edx
 ee0:	77 04                	ja     ee6 <free+0x2f>
 ee2:	89 d0                	mov    %edx,%eax
 ee4:	eb e6                	jmp    ecc <free+0x15>
      break;
 ...
 eff:	89 08                	mov    %ecx,(%eax)
  freep = p;
 f01:	a3 04 18 00 00       	mov    %eax,0x1804
}
 f06:	5b                   	pop    %ebx
 f07:	5e                   	pop    %esi
 f08:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 f35:	77 05                	ja     f3c <morecore+0x15>
    nu = 4096;
 ...
 f46:	50                   	push   %eax
 f47:	e8 38 fd ff ff       	call   c84 <sbrk>
  if(p == (char*)-1)
 f4c:	83 c4 10             	add    $0x10,%esp
 f4f:	83 f8 ff             	cmp    $0xffffffff,%eax
 f52:	74 1c                	je     f70 <morecore+0x49>
    return 0;
  hp = (Header*)p;
  hp->s.size = nu;
 ...
 f5d:	50                   	push   %eax
 f5e:	e8 54 ff ff ff       	call   eb7 <free>
  return freep;
 f63:	a1 04 18 00 00       	mov    0x1804,%eax
 ...
 f75:	eb f4                	jmp    f6b <morecore+0x44>
...
malloc(uint nbytes)
{
 ...
 f81:	8d 58 07             	lea    0x7(%eax),%ebx
 f84:	c1 eb 03             	shr    $0x3,%ebx
 f87:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 f8a:	8b 0d 04 18 00 00    	mov    0x1804,%ecx
 f90:	85 c9                	test   %ecx,%ecx
 f92:	74 04                	je     f98 <malloc+0x21>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 f94:	8b 01                	mov    (%ecx),%eax
 f96:	eb 4a                	jmp    fe2 <malloc+0x6b>
    base.s.ptr = freep = prevp = &base;
 f98:	c7 05 04 18 00 00 08 	movl   $0x1808,0x1804
 f9f:	18 00 00 
 fa2:	c7 05 08 18 00 00 08 	movl   $0x1808,0x1808
 fa9:	18 00 00 
    base.s.size = 0;
 fac:	c7 05 0c 18 00 00 00 	movl   $0x0,0x180c
 fb3:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 fb6:	b9 08 18 00 00       	mov    $0x1808,%ecx
 fbb:	eb d7                	jmp    f94 <malloc+0x1d>
    if(p->s.size >= nunits){
      if(p->s.size == nunits)
 fbd:	74 19                	je     fd8 <malloc+0x61>
        prevp->s.ptr = p->s.ptr;
      else {
        p->s.size -= nunits;
 fbf:	29 da                	sub    %ebx,%edx
 fc1:	89 50 04             	mov    %edx,0x4(%eax)
        p += p->s.size;
 fc4:	8d 04 d0             	lea    (%eax,%edx,8),%eax
        p->s.size = nunits;
 fc7:	89 58 04             	mov    %ebx,0x4(%eax)
      }
      freep = prevp;
 fca:	89 0d 04 18 00 00    	mov    %ecx,0x1804
      return (void*)(p + 1);
 fd0:	83 c0 08             	add    $0x8,%eax
    }
    if(p == freep)
 ...
 fd3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
 fd6:	c9                   	leave  
 fd7:	c3                   	ret    
        prevp->s.ptr = p->s.ptr;
 fd8:	8b 10                	mov    (%eax),%edx
 fda:	89 11                	mov    %edx,(%ecx)
 fdc:	eb ec                	jmp    fca <malloc+0x53>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 fde:	89 c1                	mov    %eax,%ecx
 fe0:	8b 00                	mov    (%eax),%eax
    if(p->s.size >= nunits){
 fe2:	8b 50 04             	mov    0x4(%eax),%edx
 fe5:	39 da                	cmp    %ebx,%edx
 fe7:	73 d4                	jae    fbd <malloc+0x46>
    if(p == freep)
 fe9:	39 05 04 18 00 00    	cmp    %eax,0x1804
 fef:	75 ed                	jne    fde <malloc+0x67>
      if((p = morecore(nunits)) == 0)
 ff1:	89 d8                	mov    %ebx,%eax
 ff3:	e8 2f ff ff ff       	call   f27 <morecore>
 ff8:	85 c0                	test   %eax,%eax
 ffa:	75 e2                	jne    fde <malloc+0x67>
 ffc:	eb d5                	jmp    fd3 <malloc+0x5c>
