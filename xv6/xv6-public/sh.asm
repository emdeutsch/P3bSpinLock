...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 ea 0e 00 00       	call   f1a <open>
...
fork1(void)
{
  ...
  pid = fork();
      50:	e8 7d 0e 00 00       	call   ed2 <fork>
  if(pid == -1)
    ...
    wait();
      62:	e8 7b 0e 00 00       	call   ee2 <wait>
  printf(2, "$ ");
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
      ...
      b5:	50                   	push   %eax
      b6:	e8 47 0e 00 00       	call   f02 <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f0:	e8 55 0e 00 00       	call   f4a <chdir>
  ...
  exit();
     11a:	e8 bb 0d 00 00       	call   eda <exit>
    panic("fork");
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 50 0d 00 00       	call   eda <exit>
...
00000190 <fork1>:
{
  ...
  pid = fork();
     196:	e8 37 0d 00 00       	call   ed2 <fork>
  if(pid == -1)
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 2f 0d 00 00       	call   f12 <exec>
    ...
    break;
     ...
     1ff:	90                   	nop
    exit();
     200:	e8 d5 0c 00 00       	call   eda <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     219:	50                   	push   %eax
     21a:	e8 cb 0c 00 00       	call   eea <pipe>
    ...
    close(p[0]);
     ...
     24a:	e8 b3 0c 00 00       	call   f02 <close>
    close(p[1]);
     24f:	58                   	pop    %eax
     250:	ff 75 f4             	push   -0xc(%ebp)
     253:	e8 aa 0c 00 00       	call   f02 <close>
    wait();
     258:	e8 85 0c 00 00       	call   ee2 <wait>
    wait();
     25d:	e8 80 0c 00 00       	call   ee2 <wait>
    break;
    ...
    wait();
     270:	e8 6d 0c 00 00       	call   ee2 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     286:	e8 77 0c 00 00       	call   f02 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28b:	58                   	pop    %eax
     28c:	5a                   	pop    %edx
     28d:	ff 73 10             	push   0x10(%ebx)
     290:	ff 73 08             	push   0x8(%ebx)
     293:	e8 82 0c 00 00       	call   f1a <open>
    ...
    panic("runcmd");
     ...
     2c2:	e8 79 0d 00 00       	call   1040 <printf>
      exit();
     2c7:	e8 0e 0c 00 00       	call   eda <exit>
      panic("pipe");
     ...
     2dc:	6a 01                	push   $0x1
     2de:	e8 1f 0c 00 00       	call   f02 <close>
      dup(p[1]);
     2e3:	58                   	pop    %eax
     2e4:	ff 75 f4             	push   -0xc(%ebp)
     2e7:	e8 66 0c 00 00       	call   f52 <dup>
      close(p[0]);
     2ec:	58                   	pop    %eax
     2ed:	ff 75 f0             	push   -0x10(%ebp)
     2f0:	e8 0d 0c 00 00       	call   f02 <close>
      close(p[1]);
     2f5:	58                   	pop    %eax
     2f6:	ff 75 f4             	push   -0xc(%ebp)
     2f9:	e8 04 0c 00 00       	call   f02 <close>
      runcmd(pcmd->left);
     2fe:	5a                   	pop    %edx
     ...
     30a:	6a 00                	push   $0x0
     30c:	e8 f1 0b 00 00       	call   f02 <close>
      dup(p[0]);
     311:	5a                   	pop    %edx
     312:	ff 75 f0             	push   -0x10(%ebp)
     315:	e8 38 0c 00 00       	call   f52 <dup>
      close(p[0]);
     31a:	59                   	pop    %ecx
     31b:	ff 75 f0             	push   -0x10(%ebp)
     31e:	e8 df 0b 00 00       	call   f02 <close>
      close(p[1]);
     323:	58                   	pop    %eax
     324:	ff 75 f4             	push   -0xc(%ebp)
     327:	e8 d6 0b 00 00       	call   f02 <close>
      runcmd(pcmd->right);
     32c:	58                   	pop    %eax
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 50 1b 00 00       	push   $0x1b50
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 50 1b 00 00       	push   $0x1b50
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 48 1b 00 00       	push   $0x1b48
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 50 1b 00 00       	push   $0x1b50
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 50 1b 00 00       	push   $0x1b50
     ...
     cf9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     d05:	57                   	push   %edi
     d06:	6a 00                	push   $0x0
     d08:	e8 e5 01 00 00       	call   ef2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d6d:	e8 a8 01 00 00       	call   f1a <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d81:	50                   	push   %eax
     d82:	e8 ab 01 00 00       	call   f32 <fstat>
  close(fd);
     d87:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d8a:	89 c6                	mov    %eax,%esi
  close(fd);
     d8c:	e8 71 01 00 00       	call   f02 <close>
  return r;
...
int TestAndSet(int *oldpointer, int new){
  ...
  int old = *oldpointer;
  *oldpointer = new;
     e26:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  int old = *oldpointer;
     e29:	8b 10                	mov    (%eax),%edx
  *oldpointer = new;
     e2b:	89 08                	mov    %ecx,(%eax)
  return old;
}
     e2d:	5d                   	pop    %ebp
...
lock_acquire(lock_t *lock){
  ...
  while(TestAndSet(&lock->flag, 1)==1)
     e56:	83 38 01             	cmpl   $0x1,(%eax)
     e59:	75 05                	jne    e60 <lock_acquire+0x10>
     e5b:	eb fe                	jmp    e5b <lock_acquire+0xb>
     e5d:	8d 76 00             	lea    0x0(%esi),%esi
     e60:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    ;
}
     e66:	5d                   	pop    %ebp
     e67:	c3                   	ret    
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
    ...
    void *stack;
    stack = malloc(PGSIZE);
     e86:	68 00 10 00 00       	push   $0x1000
     e8b:	e8 e0 03 00 00       	call   1270 <malloc>
    return clone(start_routine, arg1, arg2, stack);
     e90:	50                   	push   %eax
     e91:	ff 75 10             	push   0x10(%ebp)
     e94:	ff 75 0c             	push   0xc(%ebp)
     e97:	ff 75 08             	push   0x8(%ebp)
     e9a:	e8 db 00 00 00       	call   f7a <clone>
}
     e9f:	c9                   	leave  
     ea0:	c3                   	ret    
...
thread_join(){
  ...
  int waitedForPID = join(&stack);
     eb4:	8d 45 f4             	lea    -0xc(%ebp),%eax
thread_join(){
     eb7:	83 ec 20             	sub    $0x20,%esp
  int waitedForPID = join(&stack);
     eba:	50                   	push   %eax
     ebb:	e8 c2 00 00 00       	call   f82 <join>
     ec0:	89 c3                	mov    %eax,%ebx
  free(stack);
     ec2:	58                   	pop    %eax
     ec3:	ff 75 f4             	push   -0xc(%ebp)
     ec6:	e8 15 03 00 00       	call   11e0 <free>
  return waitedForPID;
...
00000eda <exit>:
SYSCALL(exit)
     eda:	b8 02 00 00 00       	mov    $0x2,%eax
     edf:	cd 40                	int    $0x40
     ee1:	c3                   	ret    

00000ee2 <wait>:
SYSCALL(wait)
     ee2:	b8 03 00 00 00       	mov    $0x3,%eax
     ee7:	cd 40                	int    $0x40
     ee9:	c3                   	ret    

00000eea <pipe>:
SYSCALL(pipe)
     eea:	b8 04 00 00 00       	mov    $0x4,%eax
     eef:	cd 40                	int    $0x40
     ef1:	c3                   	ret    

00000ef2 <read>:
SYSCALL(read)
     ef2:	b8 05 00 00 00       	mov    $0x5,%eax
     ef7:	cd 40                	int    $0x40
     ef9:	c3                   	ret    

00000efa <write>:
SYSCALL(write)
     efa:	b8 10 00 00 00       	mov    $0x10,%eax
     eff:	cd 40                	int    $0x40
     f01:	c3                   	ret    

00000f02 <close>:
SYSCALL(close)
     f02:	b8 15 00 00 00       	mov    $0x15,%eax
     f07:	cd 40                	int    $0x40
     f09:	c3                   	ret    

00000f0a <kill>:
SYSCALL(kill)
     f0a:	b8 06 00 00 00       	mov    $0x6,%eax
     f0f:	cd 40                	int    $0x40
     f11:	c3                   	ret    

00000f12 <exec>:
SYSCALL(exec)
     f12:	b8 07 00 00 00       	mov    $0x7,%eax
     f17:	cd 40                	int    $0x40
     f19:	c3                   	ret    

00000f1a <open>:
SYSCALL(open)
     f1a:	b8 0f 00 00 00       	mov    $0xf,%eax
     f1f:	cd 40                	int    $0x40
     f21:	c3                   	ret    

00000f22 <mknod>:
SYSCALL(mknod)
     f22:	b8 11 00 00 00       	mov    $0x11,%eax
     f27:	cd 40                	int    $0x40
     f29:	c3                   	ret    

00000f2a <unlink>:
SYSCALL(unlink)
     f2a:	b8 12 00 00 00       	mov    $0x12,%eax
     f2f:	cd 40                	int    $0x40
     f31:	c3                   	ret    

00000f32 <fstat>:
SYSCALL(fstat)
     f32:	b8 08 00 00 00       	mov    $0x8,%eax
     f37:	cd 40                	int    $0x40
     f39:	c3                   	ret    

00000f3a <link>:
SYSCALL(link)
     f3a:	b8 13 00 00 00       	mov    $0x13,%eax
     f3f:	cd 40                	int    $0x40
     f41:	c3                   	ret    

00000f42 <mkdir>:
SYSCALL(mkdir)
     f42:	b8 14 00 00 00       	mov    $0x14,%eax
     f47:	cd 40                	int    $0x40
     f49:	c3                   	ret    

00000f4a <chdir>:
SYSCALL(chdir)
     f4a:	b8 09 00 00 00       	mov    $0x9,%eax
     f4f:	cd 40                	int    $0x40
     f51:	c3                   	ret    

00000f52 <dup>:
SYSCALL(dup)
     f52:	b8 0a 00 00 00       	mov    $0xa,%eax
     f57:	cd 40                	int    $0x40
     f59:	c3                   	ret    

00000f5a <getpid>:
SYSCALL(getpid)
     f5a:	b8 0b 00 00 00       	mov    $0xb,%eax
     f5f:	cd 40                	int    $0x40
     f61:	c3                   	ret    

00000f62 <sbrk>:
SYSCALL(sbrk)
     f62:	b8 0c 00 00 00       	mov    $0xc,%eax
     f67:	cd 40                	int    $0x40
     f69:	c3                   	ret    

00000f6a <sleep>:
SYSCALL(sleep)
     f6a:	b8 0d 00 00 00       	mov    $0xd,%eax
     f6f:	cd 40                	int    $0x40
     f71:	c3                   	ret    

00000f72 <uptime>:
SYSCALL(uptime)
     f72:	b8 0e 00 00 00       	mov    $0xe,%eax
     f77:	cd 40                	int    $0x40
     f79:	c3                   	ret    

00000f7a <clone>:
SYSCALL(clone)
     f7a:	b8 16 00 00 00       	mov    $0x16,%eax
     f7f:	cd 40                	int    $0x40
     f81:	c3                   	ret    

00000f82 <join>:
SYSCALL(join)
     f82:	b8 17 00 00 00       	mov    $0x17,%eax
     f87:	cd 40                	int    $0x40
     f89:	c3                   	ret    
     ...
     f9c:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
    ...
    100e:	56                   	push   %esi
    100f:	57                   	push   %edi
    1010:	e8 e5 fe ff ff       	call   efa <write>
  while(--i >= 0)
    ...
    1049:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
  ...
  write(fd, &c, 1);
    ...
    1085:	57                   	push   %edi
    1086:	56                   	push   %esi
    1087:	e8 6e fe ff ff       	call   efa <write>
  ...
  write(fd, &c, 1);
    ...
    10de:	e8 17 fe ff ff       	call   efa <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    10ef:	57                   	push   %edi
    10f0:	56                   	push   %esi
    10f1:	e8 04 fe ff ff       	call   efa <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    115b:	57                   	push   %edi
    115c:	56                   	push   %esi
    115d:	e8 98 fd ff ff       	call   efa <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    119f:	e8 56 fd ff ff       	call   efa <write>
        ap++;
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11e1:	a1 c4 1b 00 00       	mov    0x1bc4,%eax
{
  ...
  freep = p;
    ...
    1221:	5b                   	pop    %ebx
  freep = p;
    1222:	89 15 c4 1b 00 00    	mov    %edx,0x1bc4
}
    1228:	5e                   	pop    %esi
    1229:	5f                   	pop    %edi
    122a:	5d                   	pop    %ebp
  ...
  freep = p;
    125c:	89 15 c4 1b 00 00    	mov    %edx,0x1bc4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    127c:	8b 3d c4 1b 00 00    	mov    0x1bc4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    12c1:	8b 3d c4 1b 00 00    	mov    0x1bc4,%edi
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12d3:	e8 8a fc ff ff       	call   f62 <sbrk>
  if(p == (char*)-1)
  ...
  return freep;
    12ef:	8b 15 c4 1b 00 00    	mov    0x1bc4,%edx
    ...
    131c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
    131f:	89 15 c4 1b 00 00    	mov    %edx,0x1bc4
}
    ...
    132f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
    1330:	c7 05 c4 1b 00 00 c8 	movl   $0x1bc8,0x1bc4
    1337:	1b 00 00 
    base.s.size = 0;
    133a:	bf c8 1b 00 00       	mov    $0x1bc8,%edi
    base.s.ptr = freep = prevp = &base;
    133f:	c7 05 c8 1b 00 00 c8 	movl   $0x1bc8,0x1bc8
    1346:	1b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1349:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
    134b:	c7 05 cc 1b 00 00 00 	movl   $0x0,0x1bcc
    1352:	00 00 00 
    if(p->s.size >= nunits){
