...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 8e 04 00 00       	call   4ca <open>
  ...
  59:	e8 54 04 00 00       	call   4b2 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  66:	e8 1f 04 00 00       	call   48a <exit>
      printf(1, "wc: cannot open %s\n", argv[i]);
  6b:	50                   	push   %eax
  6c:	ff 33                	push   (%ebx)
  ...
  75:	e8 76 05 00 00       	call   5f0 <printf>
      exit();
  7a:	e8 0b 04 00 00       	call   48a <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 f8 03 00 00       	call   48a <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  a6:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 cd 03 00 00       	call   4a2 <read>
 ...
 16f:	e8 7c 04 00 00       	call   5f0 <printf>
    exit();
 174:	e8 11 03 00 00       	call   48a <exit>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	57                   	push   %edi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 e5 01 00 00       	call   4a2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 31d:	e8 a8 01 00 00       	call   4ca <open>
  if(fd < 0)
 ...
 331:	50                   	push   %eax
 332:	e8 ab 01 00 00       	call   4e2 <fstat>
  close(fd);
 337:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 33a:	89 c6                	mov    %eax,%esi
  close(fd);
 33c:	e8 71 01 00 00       	call   4b2 <close>
  return r;
...
lock_acquire(lock_t *lock){
 ...
 406:	83 38 01             	cmpl   $0x1,(%eax)
 409:	75 05                	jne    410 <lock_acquire+0x10>
 40b:	eb fe                	jmp    40b <lock_acquire+0xb>
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 44a:	e8 db 00 00 00       	call   52a <clone>
}
 44f:	c9                   	leave  
 450:	c3                   	ret    
...
thread_join(){
 467:	83 ec 20             	sub    $0x20,%esp
  int waitedForPID = join(&stack);
 46a:	50                   	push   %eax
 46b:	e8 c2 00 00 00       	call   532 <join>
...
free(void *ap)
{
 ...
 791:	a1 60 0f 00 00       	mov    0xf60,%eax
{
 ...
 7d1:	5b                   	pop    %ebx
  freep = p;
 7d2:	89 15 60 0f 00 00    	mov    %edx,0xf60
}
 7d8:	5e                   	pop    %esi
 7d9:	5f                   	pop    %edi
 7da:	5d                   	pop    %ebp
 ...
 809:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 80c:	89 15 60 0f 00 00    	mov    %edx,0xf60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 829:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 82c:	8b 3d 60 0f 00 00    	mov    0xf60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 86f:	73 4f                	jae    8c0 <malloc+0xa0>
    ...
    if(p == freep)
 871:	8b 3d 60 0f 00 00    	mov    0xf60,%edi
 ...
 89a:	e8 f1 fe ff ff       	call   790 <free>
  return freep;
 89f:	8b 15 60 0f 00 00    	mov    0xf60,%edx
 ...
 8cc:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 8cf:	89 15 60 0f 00 00    	mov    %edx,0xf60
}
 ...
 8df:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 8e0:	c7 05 60 0f 00 00 64 	movl   $0xf64,0xf60
 8e7:	0f 00 00 
    base.s.size = 0;
 8ea:	bf 64 0f 00 00       	mov    $0xf64,%edi
    base.s.ptr = freep = prevp = &base;
 8ef:	c7 05 64 0f 00 00 64 	movl   $0xf64,0xf64
 8f6:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8f9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 8fb:	c7 05 68 0f 00 00 00 	movl   $0x0,0xf68
 902:	00 00 00 
    if(p->s.size >= nunits){
