...
main(int argc, char *argv[])
{
  ...
  33:	6a 00                	push   $0x0
  35:	ff 33                	push   (%ebx)
  37:	e8 1e 04 00 00       	call   45a <open>
  ...
  57:	e8 e6 03 00 00       	call   442 <close>
  for(i = 1; i < argc; i++){
  ...
  exit();
  64:	e8 b1 03 00 00       	call   41a <exit>
      printf(1, "cat: cannot open %s\n", argv[i]);
  69:	50                   	push   %eax
  6a:	ff 33                	push   (%ebx)
  ...
  73:	e8 08 05 00 00       	call   580 <printf>
      exit();
  78:	e8 9d 03 00 00       	call   41a <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 8e 03 00 00       	call   41a <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 8a 03 00 00       	call   43a <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 68 03 00 00       	call   432 <read>
  ...
  f9:	e8 82 04 00 00       	call   580 <printf>
    exit();
  fe:	e8 17 03 00 00       	call   41a <exit>
 ...
 239:	31 db                	xor    %ebx,%ebx
{
 ...
 245:	57                   	push   %edi
 246:	6a 00                	push   $0x0
 248:	e8 e5 01 00 00       	call   432 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 a8 01 00 00       	call   45a <open>
  if(fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 ab 01 00 00       	call   472 <fstat>
  close(fd);
 2c7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ca:	89 c6                	mov    %eax,%esi
  close(fd);
 2cc:	e8 71 01 00 00       	call   442 <close>
  return r;
...
thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2){
 ...
 3cb:	e8 e0 03 00 00       	call   7b0 <malloc>
    return clone(start_routine, arg1, arg2, stack);
 3d0:	50                   	push   %eax
 3d1:	ff 75 10             	push   0x10(%ebp)
 3d4:	ff 75 0c             	push   0xc(%ebp)
 3d7:	ff 75 08             	push   0x8(%ebp)
 3da:	e8 db 00 00 00       	call   4ba <clone>
}
 3df:	c9                   	leave  
 3e0:	c3                   	ret    
...
thread_join(){
 3f7:	83 ec 20             	sub    $0x20,%esp
  int waitedForPID = join(&stack);
 3fa:	50                   	push   %eax
 3fb:	e8 c2 00 00 00       	call   4c2 <join>
 400:	89 c3                	mov    %eax,%ebx
  free(stack);
 402:	58                   	pop    %eax
 403:	ff 75 f4             	push   -0xc(%ebp)
 406:	e8 15 03 00 00       	call   720 <free>
  return waitedForPID;
 ...
 4dc:	89 d1                	mov    %edx,%ecx
{
 ...
 54e:	56                   	push   %esi
 54f:	57                   	push   %edi
 550:	e8 e5 fe ff ff       	call   43a <write>
  while(--i >= 0)
 ...
 589:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5c5:	57                   	push   %edi
 5c6:	56                   	push   %esi
 5c7:	e8 6e fe ff ff       	call   43a <write>
 ...
 61e:	e8 17 fe ff ff       	call   43a <write>
        putc(fd, c);
 ...
 62f:	57                   	push   %edi
 630:	56                   	push   %esi
 631:	e8 04 fe ff ff       	call   43a <write>
        putc(fd, c);
 ...
 69b:	57                   	push   %edi
 69c:	56                   	push   %esi
 69d:	e8 98 fd ff ff       	call   43a <write>
        while(*s != 0){
 ...
 6dc:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 6df:	e8 56 fd ff ff       	call   43a <write>
        ap++;
 ...
 721:	a1 00 0f 00 00       	mov    0xf00,%eax
{
 ...
 761:	5b                   	pop    %ebx
  freep = p;
 762:	89 15 00 0f 00 00    	mov    %edx,0xf00
}
 768:	5e                   	pop    %esi
 769:	5f                   	pop    %edi
 76a:	5d                   	pop    %ebp
 ...
 799:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 79c:	89 15 00 0f 00 00    	mov    %edx,0xf00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 3d 00 0f 00 00    	mov    0xf00,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ff:	73 4f                	jae    850 <malloc+0xa0>
    ...
    if(p == freep)
 801:	8b 3d 00 0f 00 00    	mov    0xf00,%edi
 ...
 813:	e8 8a fc ff ff       	call   4a2 <sbrk>
  if(p == (char*)-1)
 ...
 82a:	e8 f1 fe ff ff       	call   720 <free>
  return freep;
 82f:	8b 15 00 0f 00 00    	mov    0xf00,%edx
 ...
 85c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 85f:	89 15 00 0f 00 00    	mov    %edx,0xf00
}
 ...
 877:	0f 00 00 
    base.s.size = 0;
 87a:	bf 04 0f 00 00       	mov    $0xf04,%edi
    base.s.ptr = freep = prevp = &base;
 87f:	c7 05 04 0f 00 00 04 	movl   $0xf04,0xf04
 886:	0f 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 889:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 88b:	c7 05 08 0f 00 00 00 	movl   $0x0,0xf08
 892:	00 00 00 
    if(p->s.size >= nunits){
